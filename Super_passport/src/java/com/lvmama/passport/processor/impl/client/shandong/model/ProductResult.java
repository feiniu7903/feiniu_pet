...
public class ProductResult  implements java.io.Serializable {
    private com.lvmama.passport.processor.impl.client.shandong.model.ProductInfoBean[] list;
    ...
    public ProductResult(
           com.lvmama.passport.processor.impl.client.shandong.model.ProductInfoBean[] list,
     ...
     * @return list
     */
    public com.lvmama.passport.processor.impl.client.shandong.model.ProductInfoBean[] getList() {
        return list;
    }
     ...
     * @param list
     */
    public void setList(com.lvmama.passport.processor.impl.client.shandong.model.ProductInfoBean[] list) {
        this.list = list;
    }
