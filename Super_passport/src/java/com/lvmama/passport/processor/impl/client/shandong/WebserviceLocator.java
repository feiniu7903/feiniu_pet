...
public class WebserviceLocator extends org.apache.axis.client.Service implements com.lvmama.passport.processor.impl.client.shandong.Webservice {
	private java.lang.String webserviceHttpPort_address;
    public WebserviceLocator() {
    	webserviceHttpPort_address=WebServiceConstant.getProperties("shandong.url");
    }
    ...
    public com.lvmama.passport.processor.impl.client.shandong.WebservicePortType getwebserviceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lvmama.passport.processor.impl.client.shandong.WebserviceHttpBindingStub _stub = new com.lvmama.passport.processor.impl.client.shandong.WebserviceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lvmama.passport.processor.impl.client.shandong.WebservicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lvmama.passport.processor.impl.client.shandong.WebserviceHttpBindingStub _stub = new com.lvmama.passport.processor.impl.client.shandong.WebserviceHttpBindingStub(new java.net.URL(webserviceHttpPort_address), this);
                _stub.setPortName(getwebserviceHttpPortWSDDServiceName());
                return _stub;
            }
        }
