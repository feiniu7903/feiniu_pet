...
import com.lvmama.passport.processor.impl.client.chimelong.util.BuyTicket_zh;
import com.lvmama.passport.processor.impl.client.chimelong.util.CancelOrder_zh;
 ...
 * 
 */
public class ZhChimelongProcessorImpl implements ApplyCodeProcessor, DestroyCodeProcessor  {

	private static final Log log = LogFactory.getLog(ZhChimelongProcessorImpl.class);
	...
	public Passport apply(PassCode passCode) {
		...
		BuyTicket_zh buy = new BuyTicket_zh();
	...
	public Passport applyTicket(Passport passport,Order order,PassCode passCode){
		BuyTicket_zh buy = new BuyTicket_zh();
		String md5key = ChimelongUtils.getMd5Key_zh();
	...
	public Passport destroy(PassCode passCode) {
		...
		CancelOrder_zh cancel = new CancelOrder_zh();
