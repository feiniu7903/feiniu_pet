...
function showFrontProductInfo() {
	var id;
	<s:if test="productInfo.lvmamaProdId">
	id = ${productInfo.lvmamaProdId};
	</s:if>
	if(id != null){
	parent.window.open(
	...
	<body>
		...
		<div style="font-size: 12px;">
			...
			<div class="pormpt_" id="pormpt11">
				...
				<s:iterator value="productInfo.journeys">
					<h4>
						第
			...
			<div class="pormpt_" id="pormpt14">
				...
				<ul>
					<s:if test="contentmap['VISA']">
				无</s:if>
					<s:else>
						<s:property value="contentmap['VISA']"/>
					</s:else>
				</ul>
			</div>
			<div class="pormpt_" id="pormpt14">
				...
				<ul>
					<s:if test="contentmap['FEATURES']">
				无</s:if>
					<s:else>
						<s:property value="contentmap['FEATURES']"/>
					</s:else>
				</ul>
			</div>
			<!--pormpt_ end-->
