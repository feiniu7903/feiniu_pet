...
<body>
	...
	<div class="iframe-content">
		  <div class="p_box">
            <form action="${basePath}/phpcmsContent/query.do" method="post" id="form1">
                <table class="p_table form-inline" width="80%">
                    <tr>
                      <td class="p_label">日期:</td>
                        ...
                        <td class="p_label">表名:</td>
                        <td><select name="subTable" id="subTableId">
                                <option value="0">请选择表名</option>
                                <s:iterator value="subTables" var="var" status="st">
                ...
                <p class="tc mt20">
                    <button class="btn btn-small w5" type="submit" onclick="return checkFormSave()">查询</button>
                </p>
            </form>
        </div>
			...
			<table class="p_table ">
				...
				<s:if test="pagination.allItems!=null ">
					...
					<s:iterator value="pagination.allItems" var="var" status="st">
						<tr>
							<td><a target="_blank" href="${url}">${contentid}</a></td>
							<td>${content}</td>
						</tr>
						<tr>
							<td><a class="showLogDialog" 	param="{'parentId':${contentid},'parentType':'bbsContent'}" 	href="#log">操作日志</a></td>
							<td><input type="hidden" id="id<s:property value='#st.count'/>" value="${contentid}" /> 
				...
				<tr>
					...
					<td colspan="1">
						<div style="text-align: left;"> 
							每页显示<input id="pageSize" class="btn btn-small w1" type="text" value="${pagination.pageSize}" /> 
                            <input class="btn btn-small w5" type="button" value=" GO "
				...
				<tr>
					<td></td>
					<td><input class="btn btn-small w5" type="button" value="提交" onclick="javascript:return ajaxSumitPage2('${basePath}//phpcmsContent/update.do','${subTable}',${statusId});">
				</tr>
			</table>
		</div>
	</div>
