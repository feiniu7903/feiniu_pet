...
<body>
	...
	<div class="iframe-content">
		  <div class="p_box">
            <form action="${ basePath}/phpcmsComment/query.do" method="post" id="form1">
			...
			<table class="p_table ">
				...
				<s:if test="pagination.allItems!=null ">
					...
					<s:iterator value="pagination.allItems" var="var" status="st">
						...
						<tr>
							<td><a class="showLogDialog" 	param="{'parentId':${commentid},'parentType':'phpcmscomment'}"	href="#log">操作日志</a></td>
				...
				<tr>
					<td></td>
					<td><input class="btn btn-small w5" type="button" value="提交" onclick="javascript:return ajaxSumitPage('${basePath}//phpcmsComment/update.do',${statusId});">
				</tr>
			</table>
		</div>
	</div>
