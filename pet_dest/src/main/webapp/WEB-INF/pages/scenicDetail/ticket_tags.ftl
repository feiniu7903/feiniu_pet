<#if productSearchInfo.tagGroupMap?? && productSearchInfo.tagGroupMap.get("抵扣")?? >
	<#assign dikou_description = '' />
	<#assign dikou_css= '' />
	<#list productSearchInfo.tagGroupMap.get("抵扣") as t>
...
<#assign youhui_css= '' />
<#if productSearchInfo.tagGroupMap?? && productSearchInfo.tagGroupMap.get("优惠")?? >
	<#list productSearchInfo.tagGroupMap.get("优惠") as t>
...
<#if productSearchInfo.tagList??>
<#list productSearchInfo.tagList as t>
