...
public class EdmSubscribeTemplateDAO extends BaseIbatisDAO {
	
	/**
	 * EDM模板SQL空间
	 */
	private static final String SQL_NAME_SPACE = "EDM_SUBSCRIBE_TEMPLATE.";
	/**
	 * 插入
	 */
	...
	public List<EdmSubscribeTemplate> search(Map<String,Object> parameters){
		List<EdmSubscribeTemplate> list = (List<EdmSubscribeTemplate>) super.queryForList(SEARCH, parameters);
		return list;
	}
