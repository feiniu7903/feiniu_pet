...
public class ExcelExportUtil {
     ...
     private final String EXEC_TEMPLATE = "#!/bin/bash\n"
               ...
               +"sqlplus lvmama_report/lvmama_report @${FILE_NAME}";
     ...
     public File create() {
          try{
               ...
               BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(queryTemplateFile), com.lvmama.operate.util.Constant.EN_CODEING));
               ...
               PrintWriter queryWriter = new PrintWriter(querySqlFile,com.lvmama.operate.util.Constant.EN_CODEING); 
               queryWriter.write(queryContent);
               queryWriter.close();
               
               String execContent = StringUtils.replace(EXEC_TEMPLATE, "${FILE_NAME}", mainSqlFile);
