...
<dl class="order_nav">
    ...
    <dd class="order_nav_dd"><a href="${contextPath }/ebooking/task/todayVisitTaskList.do">今日入住订单</a></dd>
...
<ul class="order_all">
	<li class="order_all_li">
		...
		<form action="${contextPath }/ebooking/task/todayVisitTaskList.do" id="confirmTaskForm">
    	<dl>
        	<dt>查找订单：</dt>
            <dd>
   		...
   		<s:iterator value="ebkTaskPage.items" var="task">
	    	<tr>
				...
				<s:iterator value="ebkCertificate.ebkCertificateItemList" var="item" status="i">
	   		  ...
	   		  | <a href="javascript:void(0)" onclick="showLog('${otask.ebkTaskId}');">日志</a>
...
<script type="text/javascript">
	function down() {
		...
		form.attr("action","${contextPath }/ebooking/task/downTodayVisitTaskList.do");
