...
<dl class="order_nav">
    ...
    <dd class="order_nav_dd"><a href="${contextPath }/ebooking/task/allTaskList.do">全部订单</a></dd>
...
<ul class="order_all">
	<li class="order_all_li">
		...
		<form action="${contextPath }/ebooking/task/allTaskList.do" id="confirmTaskForm" target="">
    	<dl>
        	<dt>查找订单：</dt>
            <dd>
            	<ul class="search_ul_t hide_js">
                    ...
                    <li class="search_ul_b_3">
                    	入住日期：<input id="Calendar3" type="text" value="${visitTimeStart }" name="visitTimeStart">
                    	~<input id="Calendar4" type="text" value="${visitTimeEnd}" name="visitTimeEnd">
                    </li>
                    <li>
   		...
   		<s:iterator value="ebkTaskPage.items" var="task">
	    	<tr>
				...
				<s:iterator value="ebkCertificate.ebkCertificateItemList" var="item" status="i">
	   		  ...
	   		  <td><a target="_blank" href="${contextPath }/ebooking/task/orderDetail.do?ebkTaskId=${task.ebkTaskId}">查看</a> 
	   		  | <a href="javascript:void(0)" onclick="showLog('${task.ebkTaskId}');">日志</a>
	   		  	<s:if test="ebkCertificate.allFaxMemo != null">
	   		  	<img class="yaoqiu_img" date="${ebkCertificate.allFaxMemo  }" src="http://pic.lvmama.com/img/ebooking/yaoqiu.gif" width="14" height="11" alt=""/>
	   		  	</s:if>
	   		  </td>
	   		</tr>
   		</s:iterator>
...
<script type="text/javascript">
	function down() {
		...
		form.attr("action","${contextPath }/ebooking/task/downAllTaskList.do");
