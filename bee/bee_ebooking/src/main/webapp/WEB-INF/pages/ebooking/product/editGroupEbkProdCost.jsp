				...
				<ul class="xzxx_list">
					<li style="display: block;">
		                ...
		                <div class="fysm_b">
		                	...
		                	<textarea name="ebkProdProduct.ebkProdContents[0].content" messagetitle="费用包含">${ebkProdProduct.ebkProdContents[0].content }</textarea>
		                    ...
		                    <a href="javascript:openTemplate('costcontain');">查看模板</a>
		                </div>
		                <p class="fysm_t"><b>费用不包含：</b>请按照录入规范，进行描述信息。</p>
		                <div class="fysm_b">
		                	<textarea name="ebkProdProduct.ebkProdContents[1].content" messagetitle="费用不包含">${ebkProdProduct.ebkProdContents[1].content }</textarea>
		                    ...
		                    <a href="javascript:openTemplate('nocostcontain');">查看模板</a>
		                </div>
		            </li>
				</ul>
