...
<dl class="order_nav">
	<dt>订单处理</dt>
    <dd class="order_nav_dd"><a href="${contextPath }/ebooking/task/confirmTaskList.do">未处理订单</a></dd>
...
<ul class="order_all">
	<li class="order_all_li">
		...
		<form  action="${contextPath }/ebooking/task/confirmTaskList.do" id="confirmTaskForm">
    	<dl>
        	<dt>查找订单：</dt>
            <dd>
	...
	<table width="960" border="0" class="table01">
    	<tr>
      	  <th width="90">订单号</th>
   		  ...
   		  <th width="80">房型</th>
   		  <th width="80">客人姓名</th>
   		  <th width="110">入住日期</th>
   		  <th width="110">离店日期</th>
   		  <th width="70">房间数</th>
	    	...
	    	<tr>
	      	  <td>${orderId }</td>
	   		  ...
	   		  <td><s:date name="orderCreateTime" format="yyyy-MM-dd HH:mm:ss"/></td>
	   		  	<td><a target="_blank" href="${contextPath }/ebooking/task/orderDetail.do?ebkTaskId=${task.ebkTaskId}">处理订单</a>
	...
	<script type="text/javascript">
		function down() {
			...
			form.attr("action","${contextPath }/ebooking/task/downConfirmTaskList.do");
