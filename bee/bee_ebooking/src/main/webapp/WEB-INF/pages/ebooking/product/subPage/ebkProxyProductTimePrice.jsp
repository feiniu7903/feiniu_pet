...
<div class="time_table time_table_new">
	<div class="time_updown"><s:hidden name="relationProduct"/>
		<span class="btn_prev viewprodtimepricebtn viewprodRelationtimepricebtn" prodbranchid="<s:property value="ebkProdBranchId"/>"  branchname="<s:property value="branchName"/>" tt="UP" currpagedate="<s:date name="currPageDate" format="yyyy-MM-dd"/>">&lt;&lt;上个月</span><span class="btn_next viewprodtimepricebtn viewprodRelationtimepricebtn" prodbranchid="<s:property value="ebkProdBranchId"/>"  branchname="<s:property value="branchName"/>" tt="DOWN" currpagedate="<s:date name="currPageDate" format="yyyy-MM-dd"/>">下个月&gt;&gt;</span>
								...
								<div data-sellbale="true" class="plug_calendar_d_box month_1">
									<table>
										...
										<tr>
											<td align="left">
												<font>门</font><br/>
												<s:if test='"Y" eq relationProduct'><font>售</font><br/></s:if>
												<font>结</font><br/>
												<font>库</font><br/>
												<font>资</font><br/>
												<font>超</font><br/>
											...
											<s:iterator value="#cal" var="superPrice" 	status="substatus">
												<s:if test="#superPrice.specDateCh==#timePrice.specDateCh">
														...
														<s:if test='"Y" eq relationProduct'>
