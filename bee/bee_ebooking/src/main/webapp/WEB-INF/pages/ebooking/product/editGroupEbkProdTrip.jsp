...
<body id="body_cpgl">
	...
	<!--订单详情-->
	<form action="${contextPath }/ebooking/product/saveEbkProdTripPicture.do" id="confirm" method="post">
					...
					<li style="display: block;">
		            	<p class="xcts_t">
		            		...
		            		<s:if test="toShowEbkProduct!='SHOW_EBK_PRODUCT'">
		            			<input type="text" id="showDate" onblur="changeDate()" name="tripSaveDayNum" value="${tripPicDayNum }">
							</s:if>
							<s:else>
								${tripPicDayNum }
							</s:else>
		            	...
		            	<table class="xcts_list"  border="0"  id="showDate_tab">
		            		<s:if test="ebkProdProduct.ebkProdJourneys != null && ebkProdProduct.ebkProdJourneys.size > 0">
	                        	<s:iterator value="ebkProdProduct.ebkProdJourneys" var="ebkProdJourney" status="index">
			                        		...
			                        		<table>
				                        		<tr>
							                        ...
							                        <td>
							                        	...
							                        	<span tip-content="格式规范：【出发地】—【目的地】" class="text_ts tip-icon tip-icon-info"></span>
							                        </td>
							                    </tr>
							                    <tr>
							                        ...
							                        <td>
							                        	<div class="fysm_b">
								                        	...
								                        	<a href="javascript:openTemplate('tripcontent');">查看模板</a>
							                        	</div>
							                        </td>
							                    </tr>
							                    <tr>
							                        ...
							                        <td>
							                        	...
							                        	<label><input type="checkbox" name="ebkProdProduct.ebkProdJourneys[${index.index }].traffics" value='AIRPLANE'
							                        	...
							                        	>飞机</label>
							                        	<label><input type="checkbox"  name="ebkProdProduct.ebkProdJourneys[${index.index }].traffics" value='BUS'
								                        	<s:iterator value="#ebkProdJourney.traffics" var="tra" >
									                        	<s:if test="#tra=='BUS'">
									                        		 checked 
									                        	</s:if>	
							                        	...
							                        	>巴士</label>
							                            <label><input type="checkbox"  name="ebkProdProduct.ebkProdJourneys[${index.index }].traffics" value='SHIP'
								                        	<s:iterator value="#ebkProdJourney.traffics" var="tra" >
									                        	<s:if test="#tra=='SHIP'">
									                        		 checked 
									                        	</s:if>	
							                            ...
							                            >轮船</label>
							                            <label><input type="checkbox"  name="ebkProdProduct.ebkProdJourneys[${index.index }].traffics" value='TRAIN'
								                        	<s:iterator value="#ebkProdJourney.traffics" var="tra" >
									                        	<s:if test="#tra=='TRAIN'">
									                        		 checked 
									                        	</s:if>	
							                    ...
							                    <tr>
							                        ...
							                        <td>
							                        	<input type="text"  name="ebkProdProduct.ebkProdJourneys[${index.index }].dinner" value="${ebkProdJourney.dinner }" class="width_320"  maxLength='100' ><span tip-content="用餐模板(敬请自理或含)：<br>早餐：含、中餐：敬请自理、晚餐：敬请自理" class="text_ts tip-icon tip-icon-info"></span>
							                        </td>
							                    </tr>
							                    <tr>
							                        <td width="50" align="right">住宿：</td>
							                        <td>
							                        	<input type="text" name="ebkProdProduct.ebkProdJourneys[${index.index }].hotel" value="${ebkProdJourney.hotel }" class="width_320"  maxLength='1000' ><span tip-content='住宿参考模板（入住目的地及参考酒店名称，如有多个参考酒店用“或”分隔开：）<br>例如：溧阳米兰风尚酒店或御水温泉大酒店' class="text_ts tip-icon tip-icon-info"></span>
							                        </td>
							                    </tr>
							                    <tr>
			                        		...
			                        		<table>
							                    ...
							                    <tr>
							                        ...
							                        <td>
							                        	...
							                        	<label><input type="checkbox" name="ebkProdProduct.ebkProdJourneys[0].traffics" value='AIRPLANE'>飞机</label>
							                        	<label><input type="checkbox"  name="ebkProdProduct.ebkProdJourneys[0].traffics" value='BUS' checked>巴士</label>
							                            <label><input type="checkbox"  name="ebkProdProduct.ebkProdJourneys[0].traffics" value='SHIP'>轮船</label>
							                            <label><input type="checkbox"  name="ebkProdProduct.ebkProdJourneys[0].traffics" value='TRAIN'>火车</label>
							                        </td>
							                    </tr>
							                    <tr>
							                        <td width="50" align="right">用餐：</td>
							                        <td>
							                        	<input type="text"  name="ebkProdProduct.ebkProdJourneys[0].dinner"  class="width_320"  maxLength='100' value="早餐：敬请自理、中餐：敬请自理、晚餐：敬请自理"><span tip-content="用餐模板(敬请自理或含)：<br>早餐：含、中餐：敬请自理、晚餐：敬请自理" class="text_ts tip-icon tip-icon-info"></span>
							                        </td>
							                    </tr>
							                    <tr>
							                        <td width="50" align="right">住宿：</td>
							                        <td>
							                        	<input type="text" name="ebkProdProduct.ebkProdJourneys[0].hotel" class="width_320"  maxLength='1000' ><span tip-content='住宿参考模板（入住目的地及参考酒店名称，如有多个参考酒店用“或”分隔开：）<br>例如：溧阳米兰风尚酒店或御水温泉大酒店' class="text_ts tip-icon tip-icon-info"></span>
							                        </td>
							                    </tr>
							                    <tr>
							                        <td width="50" align="right"></td>
...
<script type="text/javascript">
	function changeDate(){
		...
		for(var i=0;i<$("#showDate").val();i++){
			if($("#tr_"+i).html()==null){
				...
				var tr1 = $("<tr><td width='50' rowspan='7' class='xcts_list_first'>第  "+showDay+" 天<input type='hidden' name='ebkProdProduct.ebkProdJourneys["+i+"].dayNumber' value='"+showDay+"'><input type='hidden' name='ebkProdProduct.ebkProdJourneys["+i+"].journeyId' ></td><td width='50' align='right'>标题：</td><td><input type='text' name='ebkProdProduct.ebkProdJourneys["+i+"].title'  maxLength='100'><span tip-content='格式规范：【出发地】—【目的地】' class='text_ts tip-icon tip-icon-info'></span></td></tr>");
					
				var tr2 = $("<tr><td width='50' align='right'>描述：</td><td><div class='fysm_b'><textarea style='width: 500px;' rows='10'  name='ebkProdProduct.ebkProdJourneys["+i+"].content'  maxLength='2000' ></textarea><a href=\"javascript:openTemplate('tripcontent');\">查看模板</a></div></td></tr>");
					
				var tr3 = $("<tr><td width='50' align='right'>交通：</td><td><label><input type='checkbox' name='ebkProdProduct.ebkProdJourneys["+i+"].traffics' value='AIRPLANE'>飞机</label><label><input  type='checkbox' name='ebkProdProduct.ebkProdJourneys["+i+"].traffics'  value='BUS' checked>巴士</label><label><input  type='checkbox'  name='ebkProdProduct.ebkProdJourneys["+i+"].traffics' value='SHIP'>轮船</label><label><input  type='checkbox'  name='ebkProdProduct.ebkProdJourneys["+i+"].traffics' value='TRAIN'>火车</label></td></tr>");
				
				var tr4 = $("<tr><td width='50' align='right'>用餐：</td><td><input type='text'  name='ebkProdProduct.ebkProdJourneys["+i+"].dinner'  class='width_320'  maxLength='100' value='早餐：敬请自理、中餐：敬请自理、晚餐：敬请自理' ><span tip-content='用餐模板(敬请自理或含)：<br>早餐：含、中餐：敬请自理、晚餐：敬请自理' class='text_ts tip-icon tip-icon-info'></span></td></tr>");
				
				var tr5 = $("<tr><td width='50' align='right'>住宿：</td><td><input type='text' name='ebkProdProduct.ebkProdJourneys["+i+"].hotel' class='width_320'  maxLength='1000' ><span tip-content='住宿参考模板（入住目的地及参考酒店名称，如有多个参考酒店用“或”分隔开：）<br>例如：溧阳米兰风尚酒店或御水温泉大酒店' class='text_ts tip-icon tip-icon-info'></span></td></tr>");
	...
	$('.submitEdit').live('click', function() {
		...
		$.ajax({ 
			type:"POST", 
			url:'${contextPath }/ebooking/product/saveEbkProdTrip.do', 
