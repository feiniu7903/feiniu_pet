    	...
    	<table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="mt10"> 备注：</p>
					<p>1.如搭乘火车请提前60分钟抵达火车站；</p>
					<p>2.如搭乘飞机请提前120分钟抵达飞机场；（近期机场安检严格，过安检时间增长，请提早抵达机场，以免误机，飞机起飞前45分钟停止办理乘机手续）；</p>
					<p>3.请携带有效证件（身份证、护照等，小孩带户口簿）；</p>
					<p>4.自行办理乘车或乘机手续，如因客人自身原因造成误车或误机，一切后果自负； </p>
                </td>
            </tr>
        </table>
