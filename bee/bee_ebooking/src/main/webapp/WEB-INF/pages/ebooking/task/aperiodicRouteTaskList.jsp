...
<dl class="order_nav">
    ...
    <dd class="order_nav_dd"><a href="${contextPath }/ebooking/task/aperiodicRouteTaskList.do">密码券订单</a></dd>
</dl>
<!--内容开始-->
<ul class="order_all">
	<li class="order_all_li">
		<div class="order_list">
		<form action="${contextPath }/ebooking/task/aperiodicRouteTaskList.do" id="confirmTaskForm" target="">
    	<dl>
        	<dt>查找订单：</dt>
            <dd>
            	<ul class="search_ul_t hide_js">
            		<li>
                    	<label>密码券号：<input type="text" value="${passwordCertificate }" id="passwordCertificate" name="passwordCertificate" maxlength="8"></label>
                    </li>
            		<li>
   		...
   		<s:iterator value="ebkTaskPage.items" var="task">
	    	<tr>
	      	  ...
	      	  <s:if test="ebkCertificate.confirmChannel=='FAX'">
	   		  ...
	   		  <td>
	   		  	<a target="_blank" href="${contextPath }/ebooking/task/activateOrderShow.do?ebkTaskId=${task.ebkTaskId}&type=ROUTE">激活</a> 
...
<script type="text/javascript">
	function down() {
		...
		form.attr("action","${contextPath }/ebooking/task/downAperiodicRouteTaskList.do");
