...
<li class="order_all_li" style="display:block;">
		...
		<form action="/ebooking/product/query/queryRejected.do" id="queryProductForm" method="POST">
            ...
            <dd>
            	<ul class="search_ul_t">
                    ...
                    <li class="search_ul_b_3">
                    	<label>审核时间：<s:textfield name="auditTimeStart" readonly="readonly" id="Calendar21"/>~<s:textfield name="auditTimeEnd" readonly="readonly" id="Calendar22"/></label>
                    </li>
                    <li>
            ...
            <table width="960" border="0" class="table01">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><s:if test="null!=examineDate"><s:date name="examineDate" format="yyyy/MM/dd HH:mm:ss"/></s:if><s:else>--</s:else></td>
                        <td ebkprodproductid="<s:property value="ebkProdProductId"/>" ebkprodproductname="<s:property value="metaName"/>">  <a href="${basePath }ebooking/product/editEbkProductInit.do?ebkProdProductId=<s:property value="ebkProdProductId"/>&toShowEbkProduct=SHOW_EBK_PRODUCT" target="_blank">查看</a>　<a href="javascript:void(0)" class="queryrejectedmessage">查看原因</a>
                        <a href="javascript:void(0);" class="auditrecover">重新编辑</a>
                        </td>
                    </tr>
                    </s:iterator>
                </tbody>
