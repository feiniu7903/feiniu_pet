					...
					<li style="display: block;">
						<table class="jibenxinxi">
							<tr>
								...
								<td width="220"><span tip-content="目的地景点1，景点2，如：**酒店双飞/双卧N日游"
							...
							<tr>
								...
								<td>
									...
									<span tip-content="全程跟团、含某天自由活动的产品，归为长途跟团游<br>机加酒为主，归为长途自由行，含一天跟团游，也归为长途自由行" 
									class="text_ts tip-icon tip-icon-info"></span>
								</td>
