...
<li class="order_all_li" style="display:block;">
		...
		<form action="/ebooking/product/query/queryUnCommit.do" id="queryProductForm" method="POST">
        ...
        <div class="xinzeng"><a class="btn_xz" href="${contextPath }/ebooking/product/editEbkProductInit.do?ebkProductViewType=<s:property value='ebkProductViewType'/>"  target="_blank">新增产品</a></div>
