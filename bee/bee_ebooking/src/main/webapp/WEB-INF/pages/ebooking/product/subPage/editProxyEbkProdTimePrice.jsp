    ...
    <table class="xzkc_2">
        ...
        <s:iterator value="ebkProdBranchList" var="branch" status="count">
            ...
            <s:if test="1!=newPriceStock">
	            ...
	            <td><input type="radio" name="paramModel.priceStockSimples[<s:property value="#count.index"/>].resourceConfirm" value="true" rowid="<s:property value="prodBranchId"/>"  trindexnumber="<s:property value="#count.index"/>" checked/>是<input type="radio" name="paramModel.priceStockSimples[<s:property value="#count.index"/>].resourceConfirm" value="false" rowid="<s:property value="prodBranchId"/>"  trindexnumber="<s:property value="#count.index"/>" />否</td>
