			                        		...
			                        		<table>
				                        		<tr>
							                        ...
							                        <td>
							                        	...
							                        	<span tip-content="起始地-目的地，或者目的地一地；<br>示例如下：三亚-兴隆   或者   三亚一地" class="text_ts tip-icon tip-icon-info"></span>
							                        </td>
							                    </tr>
							                    <tr>
							                        ...
							                        <td>
							                        	<div class="fysm_b">
								                        	...
								                        	<a href="javascript:openTemplate('longTripcontent');">查看模板</a>
							                        	</div>
							                        </td>
							                    </tr>
							                    <tr>
							                    ...
							                    <tr>
							                        ...
							                        <td>
							                        	<input type="text"  name="ebkProdProduct.ebkProdJourneys[${index.index }].dinner" value="${ebkProdJourney.dinner }" class="width_320"  maxLength='100' ><span tip-content="早餐：敬请自理、中餐：敬请自理、晚餐：敬请自理" class="text_ts tip-icon tip-icon-info"></span>
							                        </td>
							                    </tr>
							                    <tr>
							                        <td width="50" align="right">住宿：</td>
							                        <td>
							                        	<input type="text" name="ebkProdProduct.ebkProdJourneys[${index.index }].hotel" value="${ebkProdJourney.hotel }" class="width_320"  maxLength='1000' ><span tip-content='住宿：地名；或者无住宿' class="text_ts tip-icon tip-icon-info"></span>
							                        </td>
							                    </tr>
							                    <tr>
			                        		...
			                        		<table>
							                    ...
							                    <tr>
							                        ...
							                        <td>
							                        	...
							                        	<label><input type="checkbox"  name="ebkProdProduct.ebkProdJourneys[0].traffics" value='BUS'>巴士</label>
							                    ...
							                    <tr>
							                        <td width="50" align="right">用餐：</td>
							                        <td>
							                        	<input type="text"  name="ebkProdProduct.ebkProdJourneys[0].dinner"  class="width_320"  maxLength='100' value="早餐：敬请自理、中餐：敬请自理、晚餐：敬请自理"><span tip-content="早餐：敬请自理、中餐：敬请自理、晚餐：敬请自理" class="text_ts tip-icon tip-icon-info"></span>
							                        </td>
							                    </tr>
							                    <tr>
							                        <td width="50" align="right">住宿：</td>
							                        <td>
							                        	<input type="text" name="ebkProdProduct.ebkProdJourneys[0].hotel" class="width_320"  maxLength='1000' ><span tip-content='住宿：地名；或者无住宿' class="text_ts tip-icon tip-icon-info"></span>
							                        </td>
							                    </tr>
							                    <tr>
							                        <td width="50" align="right"></td>
	...
	function changeDate(){
		...
		for(var i=0;i<$("#showDate").val();i++){
			if($("#tr_"+i).html()==null){
				...
				var tr1 = $("<tr><td width='50' rowspan='7' class='xcts_list_first'>第  "+showDay+" 天<input type='hidden' name='ebkProdProduct.ebkProdJourneys["+i+"].dayNumber' value='"+showDay+"'><input type='hidden' name='ebkProdProduct.ebkProdJourneys["+i+"].journeyId' ></td><td width='50' align='right'>标题：</td><td><input type='text' name='ebkProdProduct.ebkProdJourneys["+i+"].title'  maxLength='100'><span tip-content='起始地-目的地，或者目的地一地；<br>示例如下：三亚-兴隆   或者   三亚一地' class='text_ts tip-icon tip-icon-info'></span></td></tr>");
					
				var tr2 = $("<tr><td width='50' align='right'>描述：</td><td><div class='fysm_b'><textarea style='width: 500px;' rows='10'  name='ebkProdProduct.ebkProdJourneys["+i+"].content'  maxLength='2000' ></textarea><a href=\"javascript:openTemplate('longTripcontent');\">查看模板</a></div></td></tr>");
					
				var tr3 = $("<tr><td width='50' align='right'>交通：</td><td><label><input type='checkbox' name='ebkProdProduct.ebkProdJourneys["+i+"].traffics' value='AIRPLANE'>飞机</label><label><input  type='checkbox' name='ebkProdProduct.ebkProdJourneys["+i+"].traffics'  value='BUS'>巴士</label><label><input  type='checkbox'  name='ebkProdProduct.ebkProdJourneys["+i+"].traffics' value='SHIP'>轮船</label><label><input  type='checkbox'  name='ebkProdProduct.ebkProdJourneys["+i+"].traffics' value='TRAIN'>火车</label></td></tr>");
				
				var tr4 = $("<tr><td width='50' align='right'>用餐：</td><td><input type='text'  name='ebkProdProduct.ebkProdJourneys["+i+"].dinner'  class='width_320'  maxLength='100' value='早餐：敬请自理、中餐：敬请自理、晚餐：敬请自理' ><span tip-content='早餐：敬请自理、中餐：敬请自理、晚餐：敬请自理' class='text_ts tip-icon tip-icon-info'></span></td></tr>");
				
				var tr5 = $("<tr><td width='50' align='right'>住宿：</td><td><input type='text' name='ebkProdProduct.ebkProdJourneys["+i+"].hotel' class='width_320'  maxLength='1000' ><span tip-content='住宿：地名；或者无住宿' class='text_ts tip-icon tip-icon-info'></span></td></tr>");
