...
<body id="body_cpgl" class="ebooking_price">
	...
	<div class="xzxx_box">
		<ul class="xzxx_box_tab">
			...
			<li id="EBK_AUDIT_TAB_RELATION" onclick="window.location.href='${basePath}product/relation/query.do?ebkProdProductId=<s:property value="ebkProdProductId"/>&toShowEbkProduct=<s:property value="toShowEbkProduct"/>'">关联销售产品</li>
		</ul>
		<div class="xzxx_box_list" style="display:block;">
			...
			<div id="queryebkprodbranchdiv">
				<s:include value="./subPage/queryProxyEbkProdBranch.jsp"></s:include>
			</div>
