...
<script type="text/javascript" charset="utf-8"  src="${basePath}/js/recon/My97DatePicker/WdatePicker.js"></script>
...
<script type="text/javascript" src="${basePath}/js/base/jquery.PrintArea.js"></script>
<script type="text/javascript" src="${basePath}/js/base/date.js"></script>
...
<link rel="stylesheet" type="text/css"  href="${basePath}css/panel-content.css"></link>
  ...
  <script type="text/javascript"  src="${basePath}/js/lvmamacard/lvmamacard.js"></script>
