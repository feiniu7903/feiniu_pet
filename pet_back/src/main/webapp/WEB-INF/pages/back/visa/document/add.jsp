...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table class="table">
			<tr>
				<td class="label" width="20%"><span class="red">*</span>国家:</td>
				<td>
					<input type="text" id="visaApplicationDocument_country" name="visaApplicationDocument.country"/>
				</td>
			</tr>
			<tr>
				<td class="label"><span class="red">*</span>签证类型:</td>
				<td>
			...
			<tr>
				<td class="label"><span class="red">*</span>送签城市:</td>
				<td>
			...
			<tr>
				<td class="label"><span class="red">*</span>所属人群:</td>
				<td>
	...
	<script type="text/javascript">
		 $(function(){
			...
			$("#btnSubmit").click(function(){
				...
				$.ajax({
        	 		url: "<%=basePath%>/visa/document/save.do",
					type:"post",
        	 		data: {
							"visaApplicationDocument.documentId":$("#visaApplicationDocument_documentId").val(),
