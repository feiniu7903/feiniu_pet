...
<body>
	...
	<div style="display: block;" class="cg_tab_list">
		<form name="fom" id="fom" method="POST"
			action="/pet_back/queryBaiduMapList.do">
									...
									<table width="98%" border="0" align="center" cellpadding="0"
										...
										<tr>
											<td width="280"><img src="<%=basePath %>/img/icon/system.gif"
												width="20" height="18" />此处只维护“国内景点/酒店”经纬度</td>
		...
		<table cellspacing="0" cellpadding="0" border="0" class="tupian_table">
			<tbody>
				...
				<tr>
					...
					<td width="20%">
					<a href="/pet_back/modifyCoordinate.do?placeId=<s:property value="placeId"/>">更改-</a>&nbsp;&nbsp;
	                    <s:if test='isValid=="N"'>
