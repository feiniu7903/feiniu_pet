...
<form action="" method="post" id="airportFrom">
     <input  name="placeAirport.placeAirportId"  type="hidden" value="${placeAirport.placeAirportId}"/> 
	<table class="p_table no_bd form-inline" width="100%">
			<tr> 
		      <td class="p_label" width="120px;">城市名称:</td>
		      <td> 
			      <input type="text" name="search" id="search" value="${search}"/>
				  <input type="hidden" name="placeAirport.placeId" id="placeId" value="${placeAirport.placeId}"/></td>
...
function airportAddSumit(){
	if(!$("#airportFrom").valid()){
 	...
 	var url="${basePath}/place/airportUpdate.do";
