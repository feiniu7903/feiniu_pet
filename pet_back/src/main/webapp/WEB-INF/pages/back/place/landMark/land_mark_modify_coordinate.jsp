...
<title>驴妈妈_地标管理后台</title>
<meta name="keywords" content="" />
<meta name="description" content="" />

<link rel="stylesheet" href="${basePath}/css/place/backstage_table.css">
<link rel="stylesheet" href="${basePath}/css/place/map.css"  type="text/css" />
   ...
   <table width="98%" border="0"  align="center" cellpadding="0" cellspacing="0">
	...
	<table width="100%"  border="10"  cellpadding="4" cellspacing="1" bgcolor="#464646">
	  <tr height="30" bgcolor="#FFFFFF">
	    ...
	    <td><s:property value="placeLandMark.landMarkName"/>&nbsp;</td>
	  </tr>
	   <tr  height="25" bgcolor="#FFFFFF">
	    <td>地标地址：</td>
	    <td><s:property value="placeLandMark.landMarkAddress"/>&nbsp;</td>
	  </tr>
	  <tr  height="25" bgcolor="#FFFFFF">
	    <td>本地经纬度地址：</td>
	    <td><s:property value="placeLandMark.coordinateAddress"/>&nbsp;</td>
	  </tr>
	  <tr  height="25" bgcolor="#FFFFFF">
	    <td>本地经度：</td>
	    <td><s:property value="placeLandMark.longitude"/>&nbsp;</td>
	  </tr>
	  <tr  height="25"  bgcolor="#FFFFFF">
	    <td>本地纬度：</td>
	    <td><input type="hidden" id="localLatitude" value="<s:property value="placeLandMark.latitude"/>"/><s:property value="placeLandMark.latitude"/>&nbsp;</td>
	  </tr>
	  
	  <tr  height="25" bgcolor="#FFFFFF">
	    <td>根据景区名称或地址查询1（优先）：</td>
	    <td><label>
	      <input type="hidden" id="placeLandMarkId" name="placeLandMarkId" value="<s:property value='placeLandMark.placeLandMarkId'/>"/>
	      <input type="hidden" id="landMarkAddress" name="landMarkAddress" value="<s:property value='placeLandMark.landMarkAddress'/>"/>
	      <input type="text" style="background-color: #ffeeee" id="placeName" name="placeName" value='<s:property value="placeLandMark.landMarkName"/>' size="60" />
	  ...
	  <tr  height="25" bgcolor="#FFFFFF">
	    <td>根据景区名称或地址查询2：</td>
	    <td><label>
	      <input type="text" id="otherInput" name="textfield2" style="background-color: #eeeeee" size="60" value="<s:property value='placeLandMark.landMarkAddress'/>"/>
	      ...
	      <tr>
	        ...
	        <td valign="top" bgcolor="#00FFFF">
	          <table width="100%" border="1" cellpadding="4" cellspacing="1" bgcolor="#464646" style="display:none" id="coordinateInfoTable">
		          ...
		          <tr  bgcolor="#FFFFFF">
		            <td height="40"><s:property value='landMarkAddress'/></td>       
		          </tr>
		          <tr  bgcolor="#FFFFFF">
		          ...
		          <tr  bgcolor="#FFFFFF">
		            <td  height="100%" align="center">
		              ...
		              <s:if test='placeLandMark.isValid=="N"'>
	...
	<div class="LoginAndReg">
		...
		<table width="100%" border="1">
		  ...
		  <tr>
		    <td height="40"><s:property value="placeLandMark.landMarkAddress"/></td>
		  </tr>
		  <tr>
		    <td>经纬度反查地址：</td>
		  </tr>
...
var localLongitude="<s:property value="placeLandMark.longitude"/>";
var localLatitude="<s:property value="placeLandMark.latitude"/>";
var placeName="<s:property value="placeLandMark.coordinateName"/>";
var placeCAddress="<s:property value="placeLandMark.coordinateAddress"/>";
...
function markerInfoWindow(title,placeCAddress,point){
	...
	return marker;
		...
		function updateCoordinate(isValid) {
			...
			var placeLandMarkId = $("#placeLandMarkId").val();	
			var jsonData = {placeLandMarkId:placeLandMarkId,isValid:isValid};	
			if (isValid=="Y") {
				var coordinateAddress = $("#coordinateAddress2").html();
				var longitude = $("#longitude").val();
				var latitude = $("#latitude").val();	
				jsonData = {placeLandMarkId:placeLandMarkId,latitude:latitude,longitude:longitude,coordinateAddress:coordinateAddress,isValid:isValid};
			}		
