...
<script type="text/javascript" src="<%=basePath %>/js/mobile/mobile_recommend.js?version=20131023"></script>
...
<script type="text/javascript">
	...
	function getRecommendInfoSource(id,type,pageChannel){
		 // 出发地 
		 var url = basePath+"/mobile/mobileRecommendBlock!getMobileRecommendInfoSource.do?mobileRecommendBlock.id="+id+"&pageChannel="+pageChannel;
	...
	//复制 
	function copyRecommendInfo(recommendInfoId){
		alert('未开放!');
	}
				...
				<table border="0" cellspacing="0" cellpadding="0" class="search_table" width="100%">
					<tr>
						<td >
				        	...
				        	<input type="button" value="绑&#12288;定" class="btn_padd p_btn" onclick="getRecommendInfoSource('<s:property value="sonBlock.id"/>','1','freeTour')"/>&#12288;&#12288;
                ...
                <tbody>
                   <s:iterator value="pagination.items" var="info">
                    <tr>
                        ...
                        <td><img src="http://pic.lvmama.com<s:property value="#info.recommendImageUrl"/>" width="75" height="25"/></td>
                        <td><s:property value="#info.recommendTitle"/></td>
                        <td><s:property value="#info.longitude"/></td>
                        <td><s:property value="#info.latitude"/></td>
                        <td>
                    ...
                    <tr class="p_detail">
                        ...
                        <div class="detail_box">
                        	<form class="form_hor" onsubmit="updateRecommendInfo('ri<s:property value="#info.id"/>','<s:property value="#info.id"/>','freeTour');return false;" id="ri<s:property value="#info.id"/>">
                            <input type="hidden" id="id" value="<s:property value="#info.id"/>"/>
                            <ul class="ul_detail vip_info clearfix">
                            
	                             <li>
				                   <label><span class="label_text">&nbsp;&nbsp;经&nbsp;&nbsp;度：</span>
				                     <input type="text" id="longitude" value="<s:property value="#info.longitude"/>" />
				                   </label>
				                </li>
				                <li>
				                   </label>
				                 <label><span class="label_text">&nbsp;&nbsp;纬&nbsp;&nbsp;度：</span>
				                     <input type="text" id="latitude" value="<s:property value="#info.latitude"/>" /></label>
				                </li>
				                
				                  <li>
				                      <label><span class="label_text">价格：</span>
				                     <input type="text" id="price" value="<s:property value="#info.price"/>"/></label>
				                 </li>
				                  <li>
				                     <label><span class="label_text">排序值：</span>
				                     <input type="text" id="seq" value="<s:property value="#info.seqNum"/>"/></label>（请输入数字，从大到小依次排序）
				                 </li>
				                <li>
		                            <label>
