	...
	<div class="quick-list">
		...
		<div class="menu-item">
			<div class="menu-itembox">
				...
				<h4>
					<@s.iterator
					value="(map.get('recommendInfoMainList')).get('${channelPage}_MENU_MAIN_2')"
					status="st"> <@s.if test="#st.first"><a target="_blank"
						href="${url?if_exists}">${title?if_exists}</a></@s.if>
					</@s.iterator>
				</h4>
			...
			<div class="quick-menu-drop">
				...
				<div class="drop-list">
					<p>
						...
						status="st"> <a target="_blank" href="${url?if_exists}"><img
							data-imgsrc="${imgUrl?if_exists}" width="300" height="200"
							alt="${title?if_exists}" /></a> <a class="limit" target="_blank"
							href="${url?if_exists}"><@s.if test="remark!=null &&
							remark.length()>65"> <@s.property value="remark.substring(0,65)"
		...
		<div class="menu-item">
			<div class="menu-itembox">
				...
				<h4>
					<@s.iterator
					value="(map.get('recommendInfoMainList')).get('${channelPage}_MENU_MAIN_3')"
					status="st"> <@s.if test="#st.first"><a target="_blank"
						href="${url?if_exists}">${title?if_exists}</a></@s.if>
					</@s.iterator>
				</h4>
		...
		<div class="menu-item">
			<div class="menu-itembox">
				...
				<h4>
					<@s.iterator
					value="(map.get('recommendInfoMainList')).get('${channelPage}_MENU_MAIN_4')"
					status="st"> <@s.if test="#st.first"><a target="_blank"
						href="${url?if_exists}">${title?if_exists}</a></@s.if>
					</@s.iterator>
				</h4>
		  ...
		  <div class="menu-item menu-last">
                <div class="menu-itembox">
                    <span class="icon-rarr"></span>
                    <h4><@s.iterator value="(map.get('recommendInfoMainList')).get('${channelPage}_MENU_MAIN_5')" status="st">
                    ...
                    <div class="drop-list">
                        <p>
                            <@s.iterator value="(map.get('recommendInfoMainList')).get('${channelPage}_MENU_RIGHT_5')" status="st">
	                             <a target="_blank" href="${url?if_exists}"><img data-imgsrc="${imgUrl?if_exists}" width="300" height="200"  alt="${title?if_exists}" /></a>
