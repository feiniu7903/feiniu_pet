...
<@s.set var="pageMark" value="'destroute'" />
<!--头文件-->
<#include "/common/header.ftl"> 


<!-- 搜索框区域\\ -->
<#include "/WEB-INF/pages/www/channel/destroute/destroute_searchWindow.ftl">

<!-- wrap\\ 1 -->
<div class="wrap" style="margin-bottom:15px;">

<!-- 左上 quick-menu -->
<#include "/WEB-INF/pages/www/channel/destroute/destroute_quickMenu.ftl">

<!--科捷广告焦点图-->
<#include "/WEB-INF/pages/www/channel/destroute/destroute_keJiePicture.ftl">
...
<div class="wrap">
   <!--主内容左侧-->
   <#include "/WEB-INF/pages/www/channel/destroute/destroute_page_left.ftl">
    <!--主内容右侧-->
    <#include "/WEB-INF/pages/www/channel/destroute/destroute_page_right.ftl">
</div> <!-- //.wrap 2 -->

<!--科捷广告-->
<div class="padbox wrap" data-type="ad" data-adsrc="http://lvmamim.allyes.com/main/s?db=lvmamim&border=0&local=yes&kv=key|${fromPlaceCode}&user=lvmama_2013|destroute_2013|destroute_2013_banner01#1000px#80px">
</div> <!-- //.广告 -->
...
<#include "/common/footer.ftl">
 ...
 <div class="hh_cooperate">
	<!-- footer start-->
	<#include "/WEB-INF/pages/staticHtml/friend_link/destroute_footer.ftl">
	<!-- footer end-->	
 </div>
...
<script type="text/javascript">
    <!-- tab按钮获取推荐景点信息-->
	$(function(){
	    var url="http://www.lvmama.com/homePage/ajaxGetRecommendScenicForDestroute.do";
 ...
 <script>
      cmCreatePageviewTag("国内游频道首页", "A0001", null, null);
 </script>
</body>
</html>
