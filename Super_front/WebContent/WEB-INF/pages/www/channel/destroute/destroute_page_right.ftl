<div class="col-w">
    <div class="cbox cbox1">
        ...
        <div class="content">
            <ul class="cpro-list">
                <@s.iterator value="(map.get('recommendInfoMainList')).get('${channelPage}_NEWACTIVITY')" status="st">
                <li>
    ...
    <div class="cbox cbox2">
        ...
        <div class="content">
            <ul class="cpro-buy">
                ...
                <@s.iterator value="(map.get('recommendInfoMainList')).get('${channelPage}_PROUDPREFERENCE')" status="st">
                <li><a rel="nofollow" target="_blank" class="text-cover" href="${url?if_exists}">
                    ...
                    <div class="textbox">
                         <p class="text">
                           ...
                           <p><a class="btnbuy" rel="nofollow" target="_blank" href="${url?if_exists}">抢购</a>
    ...
    <div class="cbox cbox3">
        <div class="ctitle">
            ...
            <ul class="tabnav JS_tabnav">
              <@s.iterator value="(map.get('recommendInfoMainList')).get('${channelPage}_RECOMMENDDESTINATION')" status="st">
                <li <@s.if test="#st.index==0">class="selected"</@s.if>>
                <a  target="_blank" paramId="tab${st.count}" 
                paramDataCode="${bakWord1?if_exists}"  paramDataSearchName="${title?if_exists}">${title?if_exists}<i class="css_arrow"></i></a></li>
                </@s.iterator>
            </ul>
            <a class="link-more" href="http://www.lvmama.com/search/around/79-272.html">更多目的地 &raquo;</a>
        </div>
    ...
    <div class="pro-textlist">
        <div class="cbox cbox4">
            ...
            <div class="content">
                <ul class="textlist">
                     <@s.iterator value="(map.get('recommendInfoMainList')).get('${channelPage}_RECOMMENDFREEDOM')" status="st">
                        <li><dfn>&yen;<i>${memberPrice?if_exists}</i>起</dfn><a target="_blank" href="${url?if_exists}">${title?if_exists}</a></li>
                     </@s.iterator>
                </ul>
            </div>
        </div>
        ...
        <div class="cbox cbox4">
            ...
            <div class="content">
                <ul class="textlist">
                     <@s.iterator value="(map.get('recommendInfoMainList')).get('${channelPage}_RECOMMENDROUND')" status="st">
                        <li><dfn>&yen;<i>${memberPrice?if_exists}</i>起</dfn><a target="_blank" href="${url?if_exists}">${title?if_exists}</a></li>
                     </@s.iterator>
                </ul>
            </div>
