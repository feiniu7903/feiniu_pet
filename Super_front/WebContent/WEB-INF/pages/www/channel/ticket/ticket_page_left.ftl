 <div class="aside">
        ...
        <!-- 广告位左侧-->
        <div class="side-box sidead" data-type="ad" data-adsrc="http://lvmamim.allyes.com/main/s?db=lvmamim&border=0&local=yes&kv=key|${fromPlaceCode}&user=lvmama_2013|ticket_2013|ticket_2013_bottum01#200px#80px"> 
		</div>
