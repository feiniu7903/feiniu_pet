 <div class="aside">
	    ...
	    <!-- 广告位左侧-->
        <div class="side-box sidead" data-type="ad" data-adsrc="http://lvmamim.allyes.com/main/s?db=lvmamim&border=0&local=yes&kv=key|${fromPlaceCode}&user=lvmama_2013|around_2013|around_2013_bottum01#200px#80px"> 
		</div>
		
		
		<!-- 频道猜您喜欢-->
       <div class="side-box border cside4"> 
            <div class="head"> 
            <h4><!--<@s.if test="flagForAB=='true'">智子云</@s.if><@s.else>百分点</@s.else>-->猜您喜欢</h4> 
            </div> 
            <div class="content"> 
                <ul class="recommend" id="baifendian_guesslike"> 
