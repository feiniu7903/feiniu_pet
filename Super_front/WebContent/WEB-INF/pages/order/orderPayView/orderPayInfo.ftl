              ...
              <ul class="user-add-pic">
                  <li>
                      ...
                      <div style="display:block;" class="ico-payway">
                      	  <label><input type="radio" name="banks" clickEvent="beforeSubmitGateway(this,'icbc')"><i class="bank icbc" title="中国工商银行"></i></label>
						  ...
						  <label><input type="radio" name="banks" clickEvent="alipayWithBank(this,'ningboBank', 'CEBBANK')"><i class="bank ceb" title="中国光大银行"></i></label>
                          <label><input type="radio" name="banks" clickEvent="alipayWithBank(this,'ningboBank', 'SPDB')"><i class="bank spdb" title="浦发银行"></i></label>
                          <label><input type="radio" name="banks" clickEvent="alipayWithBank(this,'ningboBank', 'GDB')"><i class="bank cgb" title="广发银行"></i></label>
                          <label><input type="radio" name="banks" clickEvent="alipayWithBank(this,'ningboBank', 'CITIC')"><i class="bank ecitic" title="中信银行"></i></label>
                          ...
                          <label><input type="radio" name="banks" clickEvent="alipayWithBank(this,'ningboBank', 'HZCBB2C')"><i class="bank hzbank" title="杭州银行"></i></label>
                          ...
                          <label><input type="radio" name="banks" clickEvent="alipayWithBank(this,'ningboBank', 'SPABANK')"><i class="bank pingan" title="平安银行"></i></label>
                          <label><input type="radio" name="banks" clickEvent="alipayWithBank(this,'ningboBank', 'FDB')"><i class="bank fudian" title="富滇银行"></i></label>
                          <label><input type="radio" name="banks" clickEvent="alipayWithBank(this,'ningboBank', 'NBBANK')"><i class="bank nbcb" title="宁波银行"></i></label>                          
                          <label><input type="radio" name="banks" clickEvent="alipayWithBank(this,'ningboBank', 'POSTGC')"><i class="bank psbc" title="中国邮政储蓄银行"></i></label>
						  <label><input type="radio" name="banks" clickEvent="alipayWithBank(this,'ningboBank', 'WZCBB2C-DEBIT')"><i class="bank wzcb" title="温州银行"></i></label>
                  ...
                  <li>
                      ...
                      <div class="ico-payway">
                        ...
                        <p>
                          <label><input type="radio" name="banks" clickEvent="beforeSubmitGateway(this,'tenpayDirectpay')"><i class="bank tenpay-quick" title="财付通快捷"></i></label><span class="bankExplain">财付通快捷(首次开通快捷支付满10元立减5元!)</span>
                        </p>
                      	<p>
                        ...
                        <p>
                          ...
                          <label><input type="radio" name="banks" clickEvent="beforeSubmitGateway(this,'alipayDirectpay')"><i class="bank alipay-quick" title="支付宝快捷"></i></label><span class="bankExplain">支付宝快捷支付——安全 方便 快捷！</span>
                        </p>
						...
						<p>
                          <label><input type="radio" name="banks" clickEvent="beforeSubmitGateway(this,'chinaMobile')"><i class="bank cmpay" title="中国移动手机支付"></i></label><span class="bankExplain">中国移动手机支付 </span>
                        </p>
