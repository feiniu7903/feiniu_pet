<div class="xdl-hor">
	...
	<dl class="xdl JS_check">
		...
		<dd class="check-radio-box">
			...
			<#if mainProdBranch.description?if_exists?? && mainProdBranch.description != ''>
				<div class="tiptext tip-info check-content">
					<span class="tip-close">&times;</span>
					<div class="pre-wrap">${mainProdBranch.description?if_exists}</div>  
				</div>
			</#if>
		</dd>
		<#list relatedProductList as product>
			...
			<#if product.description?if_exists>
				<div class="tiptext tip-info check-content">
				    <span class="tip-close">&times;</span>
				    <div class="pre-wrap">${product.description?if_exists}</div>  
				</div>
			</#if>
		    </dd>
		</#list>
