...
<script type="text/javascript">
	 ...
	 function resend() {
	   	$.getJSON("http://login.lvmama.com/nsso/ajax/sendAuthenticationCode.do?mobileOrEMail="+$("#email").val()+"&validateType=EMAIL_BIND&userId="+${user.id}+"&jsoncallback=?",function(json){
