...
<#import "/WEB-INF/pages/comment/generalComment/showProdLatitudeCssTemplate.ftl" as commentMacroTemplate>
                ...
                <div class="u_comment c_w_comment">
                 <#if lastestUserProductCmtList!=null && lastestUserProductCmtList.size()!=0 >   
                  <@s.iterator value="lastestUserProductCmtList" id="cmtCommentVO">  
                    <dl>
                        ...
                        <dd>
                            ...
                            <span class="re_jifen"><@s.if test='cashRefundYuan > 0'>奖金<em>${cashRefundYuan?number?string("0.00")}元</em></@s.if><@s.else></@s.else>积分<em>${point}分</em></span>
				...
				<@s.if test="productPageConfig.items != null && productPageConfig.items.size() > 0">
 			 		<@s.iterator id="cmtCommentVO" value="productPageConfig.items" status="index">
                    <dl>
                        <dt><img src="http://pic.lvmama.com${cmtCommentVO.userImg}" width="76" height="76" /><span><@s.property value="@com.lvmama.comm.utils.StringUtil@replaceOrCutUserName(16,userNameExp)" /></span></dt>
                        <dd>
                            <@s.if test='isBest=="Y"'><strong class="jing">精</strong></@s.if><strong class="yan">验</strong>
                            <span class="com_StarValueCon"><b>总体评价：</b><s class="star_bg cur_def"><i class="ct_Star${sumaryLatitude.score}"></i></s></span>
                            <span class="re_jifen"><@s.if test='cashRefundYuan > 0'>奖金<em>${cashRefundYuan?number?string("0.00")}元</em></@s.if><@s.else></@s.else>积分<em>${point}分</em></span>
                      ...
                      <!--next page begin>>-->
                   <#if productPageFlag=='Y'>
                   <div class="paging">
                    <div id="pages_" class="pages">
                      <div id="lv_page">
                        <div class="Pages">
                         <@s.property escape="false" value="@com.lvmama.comm.utils.Pagination@pagination(productPageConfig.pageSize,productPageConfig.totalPageNum,productPageConfig.url,productPageConfig.currentPage)"/>
                        </div>
                      </div>
                    </div>
                   </div><!--paging end-->
...
<script src="http://pic.lvmama.com/js/iframe_auto/adaptive-frame.js?r=8650" data-frameid="iframeId" data-proxy="http://www.lvmama.com/js/comment/proxy.html" ></script>
