...
<#include "/WEB-INF/pages/comment/dest/list_tdk.ftl" />
...
//setKeyword('<@s.property value="keyword" />');
 ...
 <div class="container clearfix">
 	<div class="c_list_lt">
		 <!-- 攻略子页面 - 大旗帜 -->
		 <@s.property escape="false" value="@com.lvmama.comm.utils.KeJieAdsProxy@keJieAdsProxy('ve112d371adc3c670001','js',null)"/>
		<!-- 攻略子页面 - 大旗帜/End -->
		
		<!-- 点评子页面 - 大旗帜 -->
		<@s.property escape="false" value="@com.lvmama.comm.utils.KeJieAdsProxy@keJieAdsProxy('ye112d1cfaccb21e0001','js',null)"/>
		<!-- 点评子页面 - 大旗帜/End -->
        ...
        <div class="c_w_com c_shadow">
        	...
        	<div class="c_w_nav">
	            <ul class="JS_nav">
	            	...
	            	<li <@s.if test="currentTab == 'place' || currentTab == 'scenery'">class="c_w_navcur"</@s.if> info_type="38">景点</li>
	            	<li id="a3" <@s.if test="currentTab == 'weekendtravel'">class="c_w_navcur"</@s.if> info_type="39">推荐</li>
	            	<li <@s.if test="currentTab == 'dish'">class="c_w_navcur"</@s.if> info_type="40">美食</li>
	            	<li <@s.if test="currentTab == 'hotel'">class="c_w_navcur"</@s.if> info_type="41">住宿</li>
	            	<li <@s.if test="currentTab == 'traffic'">class="c_w_navcur"</@s.if> info_type="42">交通</li>
	            	<li <@s.if test="currentTab == 'entertainment'">class="c_w_navcur"</@s.if> info_type="43">娱乐</li>
	            	<li <@s.if test="currentTab == 'shop'">class="c_w_navcur"</@s.if> info_type="44">购物</li>
	            </ul>
...
<a href="http://www.lvmama.com/travel/${place.pinYinUrl}/scenery" >${place.name}景点</a>
...
<a href="http://www.lvmama.com/dest/${place.pinYinUrl}/ticket_tab" >${place.name}门票</a>
<a href="http://www.lvmama.com/dest/${place.pinYinUrl}/freeness_tab" >${place.name}自由行</a>
<a href="http://www.lvmama.com/dest/${place.pinYinUrl}/surrounding_tab" >${place.name}跟团游</a>
<a href="http://www.lvmama.com/dest/${place.pinYinUrl}/hotel_tab" >${place.name}特色酒店</a>
<a href="http://www.lvmama.com/dest/${place.pinYinUrl}/dest2dest_tab_frm${dest2dest_tab_frm!}" >各地到${place.name}</a>
</div>
