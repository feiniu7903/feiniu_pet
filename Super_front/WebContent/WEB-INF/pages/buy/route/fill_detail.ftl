<div class="s2-info-area">
    ...
    <ul>
    	...
    	<#if mainProduct.physical=='true'>
          ...
          <span class="t-title">
          	<a href="http://www.lvmama.com/product/${mainProduct.productId?if_exists}"><@s.property escape="false" value="@com.lvmama.comm.utils.StringUtil@subStringStr(mainProduct.productName,15)" />(<@s.property value="mainProduct.shortName" />)</a>
          </span>
          ...
          <em>&yen;${mainProduct.cashRefundFloat?if_exists}</em>
        ...
        <@s.iterator value="relatedProductList" var="product">
             <#if !product.additional && product.productType!='HOTEL'>
