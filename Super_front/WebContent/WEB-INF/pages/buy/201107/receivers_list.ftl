...
<#list usrReceiversList as obj> 
  	<table width="680" border="0" class="add_table_font" cellspacing="0" cellpadding="0" id="tb_${obj.receiverId}">
  	<tr>
    	...
    	<div class="old_addes" style="padding:5px;">
       		<table width="550" border="0" cellspacing="0" cellpadding="0" class="add_table_font">
  				<tr>
