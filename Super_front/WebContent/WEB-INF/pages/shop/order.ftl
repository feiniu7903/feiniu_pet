<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
		...
		<script type="text/javascript">
			...
			//限制文本框只能输入>=1的数字		
			    ...
			    $('.button04').click(function(){
			    	...
			    	if (!(/^([^u4E00-u9FA5]|[a-zA-Z0-9_\-]){2,16}$/.test(userName))) {
						alert("请填写有效的姓名");
						return;
					}
			    	var address=$("#address").val();
					if (!(/^([^u4E00-u9FA5]|[a-zA-Z0-9_\-]){2,16}$/.test(address))) {
						alert("请填写正确地址");
						return;
					}
			    	var zip=$("#zip").val();
		        	...
		        	<table border="0" cellspacing="0" cellpadding="0" class="orderproList">
								...
								<tr>
									...
									<td class="col3 btn-nums">
									    ...
									    <input type="text"  class="inp-text" id="inp-text" name="inp-text"  value="1">
									</td>
			          ...
			          <div class="Information">
			              ...
			              <a href="javascript:void(0)" class="InformationClick" onclick="$('.XinxiTanchu').show()">填写收件人信息</a>
			          </div>
		              ...
		              <a href="javascript:void(0)" class="button03">确认下单</a>             
		        </div>
		    </div>
		</div>
		...
		<div class="XinxiTanchu" style="display:none">
		     <h4>带<span>&nbsp;</span>为必填项<strong class="close"></strong></h4>
		      <ul>
		          ...
		          <li><label>手机：</label><input id="mobile" type="text" /></li>
		          <li><label>地址：</label>
	...
	<script src="http://pic.lvmama.com/js/new_v/top/top_common.js?r=8347" type="text/javascript" charset="utf-8"></script>
</html>
