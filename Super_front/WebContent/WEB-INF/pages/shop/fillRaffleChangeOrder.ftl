<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	<body>
		...
		<div class="main clearfix">
			...
			<form id="myForm" method="POST" action="/shop/createOrder.do">
				...
				<input type="hidden" name="raffleCode" id="raffleCode" value="${raffleCode?if_exists}"/>
				<@s.token></@s.token>
			</form>
			
		    <div class="mainRight">
				<div class="ord-top02_new">确认订单</div>
		        <div class="ordText clearfix">
		        	<h3>请确认您的订单信息</h3>
		        	<input type="hidden" id="shopUserPoint" value="<@s.property value="shopUser.point"/>"/>
		        	<input type="hidden" id="changePoint" value="0"/>
		        	...
		        	<table border="0" cellspacing="0" cellpadding="0" class="orderproList">
								...
								<tr>
									...
									<td class="col4"><strong id="productChangePoint">0</strong></td>
								</tr>	
					  </table>
		              ...
		              <p class="amount">总需:<strong id="totalChangePoint">0</strong>积分</p>
		              <p class="next_points_p"><a href="javascript:void(0)" class="next_raffle_order button_bg" id="submit-a">确认下单</a></p>             
		        </div>
		    </div>
		</div>
	...
	<script type="text/javascript" src="http://pic.lvmama.com/min/index.php?g=common" charset="utf-8"></script>
