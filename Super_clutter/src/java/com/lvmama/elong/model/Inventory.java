...
public class Inventory {
	...
	public String toString() {
		return "Inventory [hotelID=" + hotelID + ", roomTypeId=" + roomTypeId
				+ ", hotelCode=" + hotelCode + ", date=" + date + ", status="
				+ status + ", amount=" + amount + ", overBooking="
				+ overBooking + ", startDate=" + startDate + ", endDate="
