    ...
    extends BaseRatePlan
{
	...
	public String toString() {
		return "ListRatePlan [status=" + status + ", customerType="
				+ customerType + ", currentAlloment=" + currentAlloment
				+ ", instantConfirmation=" + instantConfirmation
				+ ", isLastMinuteSale=" + isLastMinuteSale + ", startTime="
				+ startTime + ", endTime=" + endTime + ", totalRate="
				+ totalRate + ", averageRate=" + averageRate
				+ ", currencyCode=" + currencyCode + ", coupon=" + coupon
				+ ", nightlyRates=" + nightlyRates + ", bookingRuleIds="
				+ bookingRuleIds + ", guaranteeRuleIds=" + guaranteeRuleIds
				+ ", prepayRuleIds=" + prepayRuleIds + ", drrRuleIds="
				+ drrRuleIds + ", valueAddIds=" + valueAddIds + ", giftIds="
				+ giftIds + "]";
	}
