    ...
    extends BaseRatePlan
{
	...
	public String toString() {
		return "RatePlan [hotelCode=" + hotelCode + ", roomTypeIds="
				+ roomTypeIds + ", customerType=" + customerType
				+ ", productTypes=" + productTypes + ", isLimitTimeSale="
				+ isLimitTimeSale + ", startTime=" + startTime + ", endTime="
				+ endTime + ", minAdvHours=" + minAdvHours + ", maxAdvHours="
				+ maxAdvHours + ", guaranteeRules=" + guaranteeRules
				+ ", prepayRules=" + prepayRules + ", valueAdds=" + valueAdds
				+ ", drrRules=" + drrRules + ", coupon=" + coupon + ", gifts="
				+ gifts + "]";
	}
