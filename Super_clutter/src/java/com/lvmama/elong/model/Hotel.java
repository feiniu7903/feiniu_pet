...
public class Hotel {
	...
	public String toString() {
		return "Hotel [hotelId=" + hotelId + ", lowRate=" + lowRate
				+ ", currencyCode=" + currencyCode + ", facilities="
				+ facilities + ", distance=" + distance + ", bookingRules="
				+ bookingRules + ", guaranteeRules=" + guaranteeRules
				+ ", prepayRules=" + prepayRules + ", valueAdds=" + valueAdds
				+ ", drrRules=" + drrRules + ", rooms=" + rooms + ", detail="
				+ detail + ", images=" + images + ", gifts=" + gifts + "]";
	}
