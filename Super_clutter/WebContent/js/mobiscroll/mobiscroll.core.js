    ...
    function Scroller(elem, settings) {
        ...
        */
        that.change = function (manual) {
			...
			for(var i=0;i<jsonData.datas.length;i++){
				//console.info(jsonData.datas[i].date + ":" + v);
				if(jsonData.datas[i].date == v){
				 	lvCurrentPrice= "&yen;"+ jsonData.datas[i].sellPriceYuan;
					lvCurrentTicket = "有票";
				}
            ...
            if (s.display == 'inline') {
                ...
                $('.dwv', dw).html(formatHeader(v)+"&nbsp;&nbsp;<span style='color:red;'>"+lvCurrentTicket+"</span>&nbsp;&nbsp;<span id='lv-current-price'>"+ lvCurrentPrice +"</span>");
            }
        ...
        */
        that.show = function (prevAnim) {
            ...
            var html = '<div class="dw-trans ' + s.theme + ' dw-' + s.display + ' dw' + prefix + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp" draggable="false">' + '<div class="dwo"></div><div class="dw dwbg ' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + (s.headerText ? '<div class="dwv"></div>' : ''));
            ...
            for (i = 0; i < s.wheels.length; i++) {
                ...
                for (label in s.wheels[i]) {
                    ...
                    html += '<td><div class="dwwl dwrc dwwl' + l + '" draggable="false">' + (s.mode != 'scroller' ? '<div class="dwwb dwwbp" style="height:' + hi + 'px;line-height:' + hi + 'px;"><span>+</span></div><div class="dwwb dwwbm" style="height:' + hi + 'px;line-height:' + hi + 'px;"><span>&ndash;</span></div>' : '') + '<div class="dwl">' + label + '</div><div class="dww" draggable="false" style="height:' + (s.rows * hi) + 'px;min-width:' + s.width + 'px;"><div class="dw-ul" draggable="false">';
                    // Create wheel values
                    html += generateWheelItems(l);
                    html += '</div><div class="dwwo" draggable="false"></div></div><div class="dwwol" draggable="false"></div></div></td>';
                    l++;
                }
            ...
            if (s.display != 'inline') {
                ...
                that.tap($('.dwb-s span', dw), function () {
					if($("#lv-current-price").html()==""){
						lvToast(false,"当天没票，请重新选择其他日期！");	
						return false;
					}
