 ...
 * @since Super二期
 */
public final class PassPortDetailSQLBuilderImpl extends AbstractSQLBuilder {
	/**
	 * LOG.
	 */
	private static final Log LOG = LogFactory
			.getLog(PassPortDetailSQLBuilderImpl.class);
	/**
	 * <pre>
	...
	private static String sb = new StringBuilder()
			...
			.append(" TO_NUMBER(SUP_PERFORM_TARGET.TARGET_ID) AS TARGET_ID ,")
			.append(" ORD_ORDER.ORDER_STATUS,")
			.append(" ORD_ORDER.PAYMENT_TARGET").toString();
	/**
	 * 要查询的字段.
	 */
