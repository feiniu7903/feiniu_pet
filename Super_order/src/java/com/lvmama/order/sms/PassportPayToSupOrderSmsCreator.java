 ...
 *
 */
public class PassportPayToSupOrderSmsCreator extends AbstractOrderSmsCreator implements SingleSmsCreator{
	 ...
	 * @param mobile
	 */
	public PassportPayToSupOrderSmsCreator(Long orderId, String mobile){
	...
	ProdChannelSms getSmsTemplate() {
		...
		return prodChannelSmsDAO.selectByTemplateIdAndChannelCode(order.getChannel(), Constant.SMS_TEMPLATE.PASSPORT_PAY_TO_SUP_ORDER.name());
	}
