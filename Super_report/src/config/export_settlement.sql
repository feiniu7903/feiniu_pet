...
to_char(decode(
(select op.create_time from lvmama_super.ord_perform op
...
), null, ORD_ORDER_ITEM_META.Visit_Time, (select op.create_time from lvmama_super.ord_perform op
where ( op.object_id=ORD_ORDER_ITEM_META.Order_Item_Meta_Id and op.object_type='ORD_ORDER_ITEM_META' )
or ( op.object_id=ORD_ORDER_ITEM_META.Order_Id and op.object_type='ORD_ORDER' )
...
to_char((ORD_ORDER_ITEM_META.ACTUAL_SETTLEMENT_PRICE * ORD_ORDER_ITEM_META.PRODUCT_QUANTITY * ORD_ORDER_ITEM_PROD.QUANTITY) / 100) || '"' 
 FROM lvmama_super.ORD_SUB_SETTLEMENT,
 lvmama_super.ORD_SUB_SETTLEMENT_ITEM,
 lvmama_super.ORD_ORDER_ITEM_META,
 lvmama_super.ORD_ORDER_ITEM_PROD,
 lvmama_super.ORD_PERSON