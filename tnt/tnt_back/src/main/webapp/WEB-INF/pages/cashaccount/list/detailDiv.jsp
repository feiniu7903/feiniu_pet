	...
	<div class="iframe_content mt20" style="height:500px">
        <div class="ui_title f14">
	        <ul class="ui_tab">
                ...
                <li tag="freezeClass"><a href="#">冻结记录</a></li>
	        </ul>
        </div>
        ...
        <div class="p_box freezeClass" style="display: none"></div>
    </div>
</body>
...
$(function(){
	...
	var url = "/tnt_back/cashaccount/financel/queryCashPay.do?cashAccountId=${cashAccountId}";
	query(url,"payClass");
	query("/tnt_back/cashaccount/financel/queryCashRecharge.do?cashAccountId=${cashAccountId}","rechargeClass");
	query("/tnt_back/cashaccount/financel/queryCashRefundment.do?cashAccountId=${cashAccountId}","refundmentClass");
	query("/tnt_back/cashaccount/financel/queryCashMoneyDraw.do?cashAccountId=${cashAccountId}","moneyDrawClass");
	query("/tnt_back/cashaccount/financel/queryCashCommission.do?cashAccountId=${cashAccountId}","commissionClass");
	query("/tnt_back/cashaccount/financel/queryFreeze.do?cashAccountId=${cashAccountId}","freezeClass");
});
