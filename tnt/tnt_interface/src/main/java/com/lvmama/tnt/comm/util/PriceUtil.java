...
public class PriceUtil {
	...
	public static int convertToYuanInt(final Long price) {
		if (price == null) {
			return 0;
		}
		BigDecimal p = new BigDecimal(convertToYuan(price));
		return p.divide(BigDecimal.ONE, 0, BigDecimal.ROUND_CEILING).intValue();
	}
