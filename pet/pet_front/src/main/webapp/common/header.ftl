...
<div class="lv-topbar">
    <div class="tapbar-inner wrap">
        <ul class="top-link">
            ...
            <li class="dropdown"><a class="lvlink" href="http://login.lvmama.com/nsso/onlineApplyMemberCard/index.do" rel="nofollow">会员卡 <i class="icon-barr"></i></a>
                <div class="top-sub">
            ...
            <li><a class="lvlink" href="http://e.weibo.com/lvmamas" rel="nofollow"><i class="icon-weibo"></i>+微博</a></li>
...
<div class="lv-header wrap">
    <div class="header-inner">
        <span id="hotline" class="lv-hotline"><@s.if test="showDifferntHotLine != null && showDifferntHotLine != ''">4006-040-${showDifferntHotLine?if_exists}</@s.if><@s.else>1010-6060</@s.else></span>
        <a class="lv-logo" href="http://www.lvmama.com/">旅游网</a>
...
<div id="pnav" class="pnav clearfix">
    <div class="wrap">
        <ul class="pnav-main">
            ...
            <li id="hotel"><a href="http://www.lvmama.com/search/hotel.html">度假酒店</a><i class="icon-new"></i></li>
            ...
            <li id="train"><a href="http://www.lvmama.com/train" rel="nofollow">火车票</a><i class="icon-new"></i></li>
