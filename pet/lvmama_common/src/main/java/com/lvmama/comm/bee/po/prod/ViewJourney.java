...
public class ViewJourney implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -5474851185974267570L;
	 ...
	 * 行程小贴士列表
	 */
	private List<ViewJourneyTips> journeyTipsList;
	/**
	 * 行程图片列表
	 */
	...
	public List<ViewJourneyTips> getJourneyTipsList() {
		return journeyTipsList;
	}

	public void setJourneyTipsList(List<ViewJourneyTips> journeyTipsList) {
