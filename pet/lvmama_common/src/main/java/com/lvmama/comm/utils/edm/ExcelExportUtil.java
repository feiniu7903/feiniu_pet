...
public class ExcelExportUtil {
     ...
     public File create() {
          try{
               ...
               BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(queryTemplateFile), "UTF-8"));
               ...
               PrintWriter queryWriter = new PrintWriter(querySqlFile,"UTF-8"); 
