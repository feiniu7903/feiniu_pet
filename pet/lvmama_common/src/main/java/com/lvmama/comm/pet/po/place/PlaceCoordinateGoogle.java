 ...
 * 
 */
public class PlaceCoordinateGoogle implements Serializable {

	private static final long serialVersionUID = 8784480694005875368L;

	private Long placeCoordinateGoogleId;
	...
	public Long getPlaceCoordinateGoogleId() {
		return placeCoordinateGoogleId;
	}

	public void setPlaceCoordinateGoogleId(Long placeCoordinateGoogleId) {
		this.placeCoordinateGoogleId = placeCoordinateGoogleId;
	}
