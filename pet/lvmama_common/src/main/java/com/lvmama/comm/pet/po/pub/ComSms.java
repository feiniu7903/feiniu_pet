...
public class ComSms implements Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = 1102842931550914209L;
	...
	public boolean isValid() {
		return mobile!=null && (mobile.length()==11 || mobile.length()==12);
	}
