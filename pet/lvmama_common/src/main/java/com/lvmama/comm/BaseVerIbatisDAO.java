 ...
 * Ibatis型读dao基类
 */
public class BaseVerIbatisDAO extends SqlMapClientTemplate {

	private static final Log LOG = LogFactory.getLog(BaseVerIbatisDAO.class);

	private int maxRows = 1001;
	private int maxRowsForReport = 100000;
	 ...
	 */
	@Resource
	public final void setDataSourcever(DataSource dataSource) {
