...
public final class ImageScaleUtil {
    ...
    double PI = (double) 3.1415926535897932;
    double[] contrib;
    double[] normContrib;
    double[] tmpContrib;
    ...
    /*public static void main(String args[]) throws Exception{
    	...
    	File fIn = new File("d:/Test/P1000879.JPG");
    	BufferedImage srcBufferImage = ImageIO.read(fIn);
    	BufferedImage ret = is.imageZoomOut(srcBufferImage, 150, 100);
    	File fOut = new File("d:/Test/o.jpg");
    	ImageIO.write(ret, "JPG", fOut);
    }*/
}
