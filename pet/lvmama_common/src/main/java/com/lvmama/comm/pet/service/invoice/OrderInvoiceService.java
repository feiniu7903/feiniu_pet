...
public interface OrderInvoiceService {
	 ...
	 * @return 新增发票是否成功
	 */
	boolean insertInvoiceList(List<Invoice> invoiceList, Long orderId, String operatorId);
	 ...
	 * @return 新增发票是否成功
	 */
	boolean insert(Invoice invoice, Long orderId, String operatorId);
	 ...
	 */
	OrdInvoice insert(Invoice invoice,List<Long> orderIds,String operatorId);
