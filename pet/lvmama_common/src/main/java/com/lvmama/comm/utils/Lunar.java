...
public class Lunar {
    ...
    private String chineseNumber[] = {"正", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "腊"};
    private String chineseNumber1[] = {"一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二"};
    private SimpleDateFormat chineseDateFormat = new SimpleDateFormat("yyyy年MM月dd日");
    private long[] lunarInfo = new long[]
...
//====== 传回农历 y年m月的总天数
    final public int monthDays(int y, int m) {
...
//offset为0时，并且刚才计算的月份是闰月，要校正
    ...
    // today.setTime(new java.util.Date());//加载当前日期
     ...
     for (int i = 0; i < 100; i++) {
		...
		today.add(Calendar.YEAR, i);
		Lunar l = new Lunar(today);
