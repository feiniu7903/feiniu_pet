...
<body>
        <div class="content contentJF">
    	<div class="contentJFTop"><h3 class="tit">我的积分</h3></div>
        <div class="textTop">
        	<ul>
            	<li class="on"><a href="javascript:void(0)">我的积分</a></li>
            	<li><a href="../shop/orderList.do">兑换记录</a></li>
        ...
        <div class="jifenText01">
        	<div class="jifenText01Top"><span>积分记录</span></div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr class="tit">
                    <td width="120">日期</td>
                    <td width="120">事由</td>
                    <td width="120">获得积分</td>
                  </tr>
				  <@s.iterator id="upld" value="userPointLogWithDescriptionList" status="index">
                  <tr>
                    <td><@s.property value="zhCreatedDate" /></td>
