...
<input type="hidden" name="channel" value="PAGEREG"/>
								<ul style="" class="register_form register_sj_form">
									<li><label class="csmm_form_col w90"><i class="red">*</i> 您的手机号</label><input type="text" class="zhfs_form_input" id="sso_mobile" name="mobile"></li>
									<li><label class="csmm_form_col w90"><i class="red">*</i> 您的用户名</label><input type="text" class="zhfs_form_input" id="sso_username" name="userName"></li>
									<li><label class="csmm_form_col w90"><i class="red">*</i> 设置密码</label><input type="password" class="zhfs_form_input" id="sso_password" name="password"></li>
									<li><label class="csmm_form_col w90"><i class="red">*</i> 确认密码</label><input type="password" class="zhfs_form_input" id="sso_againPassword" name="againPassword"></li>
									<li><label class="csmm_form_col w90"> Email地址</label><input type="text" class="zhfs_form_input" id="sso_email" name="email"></li>
									...
									<li><label class="csmm_form_col w90"> 所在地</label><select id="captialId" class="province"><option value="">--请选择--</option></select><select id="cityId" class="city" name="cityId"><option>--请选择--</option></select></li>
									<li class="mb10"><label class="csmm_form_col w90"></label><a href="javascript:void(0)" class="register_submit" id="submitBtn"></a></li>
									<li><label class="csmm_form_col w90"> </label><input type="checkbox" class="register_tk" checked id="terms"><a class="link_blue" href="javascript:void(0)" id="lvmama_tk">《驴妈妈旅游网会员服务条款》</a>
		...
		$.ajax({
			...
			success: function(response) {
				if (response.success == false) {
					error_tip("#sso_mobile","该手机号已被注册，请更换其它手机号，或<a href='http://login.lvmama.com/nsso/login' class='link_blue'>用此手机号登录</a>",undefined,"reg_mtop");
					return false;
				} else {
					call();
				}
...
<script>
      cmCreatePageviewTag("手机注册", "F0001", null, null);
</script>
</body>
