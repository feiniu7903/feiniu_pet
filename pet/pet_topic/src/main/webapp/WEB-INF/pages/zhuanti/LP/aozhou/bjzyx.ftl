...
<head>
<meta charset="utf-8" />
<title>北京到澳大利亚新西兰自由行线路_北京到澳大利亚自由行多少钱,费用-驴妈妈旅游网</title>
<meta name="keywords" content="澳大利亚，新西兰，北京，自由行" />
...
<div class="main_all">
	<div class="banner">
     ...
     <div class="miaosha">
	<@s.iterator value="map.get('${station}_ms_bj')" status="st">
    	<dl class="ms_dl">
...
<!--跟团游-->
    <div class="nav_list" style="display:block;">
    	<dl class="nav_cfd">
            ...
            <dd class="nav_cfd_dd"><a target="_self" href="http://www.lvmama.com/zt/lvyou/aozhou/bjgty/">北京</a></dd>
            <dd><a target="_self" href="http://www.lvmama.com/zt/lvyou/aozhou/gzgty/">广州/深圳/香港</a></dd>
        </dl>
        <div class="cfd_list" style="height:auto;">
 			<@s.iterator value="map.get('${station}_gt_bj')" status="st">
        	<dl class="cp_title">
            		<dt>${title?if_exists}</dt>
                	<dd>${bakWord1?if_exists}</dd>
            </dl>
           	 <ul class="cp_list cp_list_js3">
            	<@s.iterator value="map.get('${station}_gt_bj_${st.index + 1}')" status="sts">
				<li>
...
<!--自由行-->
    <div class="nav_list">
    	<dl class="nav_cfd">
            ...
            <dd class="nav_cfd_dd"><a target="_self" href="http://www.lvmama.com/zt/lvyou/aozhou/bjzyx/">北京</a></dd>
            <dd><a target="_self" href="http://www.lvmama.com/zt/lvyou/aozhou/gzzyx/">广州/深圳/香港</a></dd>
        </dl>
        <div class="cfd_list">
 			<@s.iterator value="map.get('${station}_zy_bj')" status="st">
        	<dl class="cp_title">
            		<dt>${title?if_exists}</dt>
                	<dd>${bakWord1?if_exists}</dd>
            </dl>
           	 <ul class="cp_list cp_list_js3">
            	<@s.iterator value="map.get('${station}_zy_bj_${st.index + 1}')" status="sts">
				<li>
					<h5><a href="${url?if_exists}"><span class="gray">【${bakWord2?if_exists}】</span>${title?if_exists}</a></h5>
                    <span class="jiage">¥<b>${memberPrice?if_exists?replace(".0","")}</b><i>起</i></span>
                    <div class="hide_box" style="display:block;">
