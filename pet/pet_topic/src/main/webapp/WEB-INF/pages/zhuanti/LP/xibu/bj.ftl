...
<head>
    ...
    <title>北京到西部旅游_北京出发西部旅游线路-驴妈妈旅游网</title>
    <meta name="Keywords" content="北京到西部,西部旅游,旅游线路">
    <meta name="Description" content="驴妈妈旅游网推出北京到西部旅游穿越活动,为你推荐北京出发西部旅游线路,为你介绍西部旅游景点,穿越大西部,触摸梦想的高度,带给你一个不一样的旅程!">
   ...
   DD_belatedPNG.fix('.city_prod_tujian li .icon_post img,.city_prod_list');
</script>
    <![endif]-->
</head>
...
<body>
    ...
    <div class="wapper_head">
        ...
        <div class="head_bg">
            ...
            <dl class="cfd_nav">
                <dt>出发地</dt>
                <dd>
                    <a class="nav_dd1" target="_self" href="http://www.lvmama.com/zt/lvyou/xibu">上海</a>
                </dd>
                <dd class="nav_click">
                    <a class="nav_dd2" target="_self" href="#">北京</a>
                </dd>
                <dd>
                    <a class="nav_dd3" target="_self" href="http://www.lvmama.com/zt/lvyou/daxibu">广州</a>
                </dd>
            </dl>
        </div>
        <!--header_ e--> </div>
    ...
    <div class="xz_wpper">
        <div class="through_lab p_rel">
            ...
            <div class="thr_prod fl">
                <ul class="thr_list">
                    <@s.iterator value="map.get('${station}_bjchuanyue')" status="st">
                        <li>
                            <span class="prod_info">
                                <a href="${url?if_exists}" target="_blank"  title="${title?if_exists}">
                                    ${title?if_exists}
                                    <#if bakWord1?exists && bakWord1!="">
                                        <span class="${bakWord1}"></span>
                                    </#if>
                                </a>
                            </span>
                            <@s.if test="null != remark && '' != remark">
        ...
        <div class="city_prod_contant clearfix">
            ...
            <div>
                <div class="prod_nums">
                    <div class="city_prod_main fl">
                        <ul class="city_prod_tujian mt5">
                            <@s.iterator value="map.get('${station}_bjyunnanzt')">
                                <li>
                        ...
                        <@s.iterator value="map.get('${station}_bjyunnan')" status="st">
                            <h3 class="tits mt10">${title?if_exists} </h3>
                            <ul class="thr_list ciyt_list mt5">
                                <@s.iterator value="map.get('${station}_bjyunnan_${st.index + 1}')" >
                                    <li>
                    ...
                    <div class="pic_show_aside fl">
                        <div class="pic_show_list">
                            ...
                            <a href="http://www.lvmama.com/info/chinagonglue/2011-1107-34549.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/yunnan1.jpg"></a>
                            <p>
                                1.印象丽江不可不知的丽江十个关键词
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/guide/2011/0215-127215.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/yunnan2.jpg"></a>
                            <p>
                                2.穷游丽江吃住行游购娱全方位省钱
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/guide/2010/1101-56083-1.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/yunnan3.jpg"></a>
                            <p>
                                3.丽江艳遇攻略 ～只可意会不可言传
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/guide/2012/0522-163033.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/yunnan4.jpg"></a>
                            <p>
                                4.丽江周边那些沾染上丽江气息的地方
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/info/chinagonglue/2011-1108-34559.html " target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/yunnan5.jpg"></a>
                            <p>
                                5.避世的天堂流浪在丽江的古城
                                <br/>
                            ...
                            <li>
                                <div class="pic fl">
                                    <a href="http://www.lvmama.com/guide/place/yunnan_lijiang/" target="_blank">
                                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/yunnan_115x162.jpg"></a>
                                </div>
                                <div class="lianjie">
                ...
                <div class="prod_nums">
                    <div class="city_prod_main fl">
                        <ul class="city_prod_tujian mt5">
                            <@s.iterator value="map.get('${station}_bjsichuanzt')">
                                <li>
                                    <div class="pic_list fl">
                                        <a href="${url?if_exists}" target="_blank" ><img alt="" src="${imgUrl?if_exists}"></a>
                                        <span class="icon_post"><img alt="" src="http://pic.lvmama.com/img/zt/dxb/tt_icon.png"></span>                               
                        ...
                        <@s.iterator value="map.get('${station}_bjsichuan')" status="st">
                            <h3 class="tits mt10">${title?if_exists} </h3>
                            <ul class="thr_list ciyt_list mt5">
                                <@s.iterator value="map.get('${station}_bjsichuan_${st.index + 1}')" >
                                    <li>
                                        <span class="prod_info"><a href="${url?if_exists}" target="_blank"  title="${title?if_exists}">${title?if_exists}<#if bakWord1?exists && bakWord1!=""><span class="${bakWord1}"></span></#if></a></span>
                                        <p class="prod_text"> <@s.if test="null != remark && '' != remark">★ ${remark?if_exists}</@s.if></p>
                                        <span class="prod_price prod_price_city01"><em>¥</em>${memberPrice?if_exists?replace(".0","")}<em>起</em></span>
                    ...
                    <div class="pic_show_aside fl">
                        <div class="pic_show_list">
                            ...
                            <a href="http://www.lvmama.com/guide/2012/0409-162169.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/sichuan1.jpg"></a>
                            <p>
                                1.味道成都，只为美食走街串巷
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/info/chinalife/2011-0602-6139.html " target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/sichuan2.jpg"></a>
                            <p>
                                2.爱修行爱幽静 青城山旅游攻略
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/info/chinagonglue/2012-0508-78953.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/sichuan3.jpg"></a>
                            <p>
                                3.麻辣鲜香诱惑难挡 十大火锅店
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/guide/2009/1230-132651.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/sichuan4.jpg"></a>
                            <p>
                                4.成都：在锦里，做一尾闲逛的鱼
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/info/chinagonglue/2012-0509-79253.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/sichuan5.jpg"></a>
                            <p>
                                5.最全成都美食地图 带你吃遍成都
                                <br/>
                            ...
                            <li>
                                <div class="pic fl">
                                    <a href="http://www.lvmama.com/guide/place/sichuan_chengdu/" target="_blank">
                                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/sixchuan_115x162.jpg"></a>
                                </div>
                                <div class="lianjie">
                ...
                <div class="prod_nums">
                    <div class="city_prod_main fl">
                        <ul class="city_prod_tujian mt5">
                            <@s.iterator value="map.get('${station}_bjxizangzt')">
                                <li>
                                    <div class="pic_list fl">
                                        <a href="${url?if_exists}" target="_blank" ><img alt="" src="${imgUrl?if_exists}"></a>
                                        <span class="icon_post"><img alt="" src="http://pic.lvmama.com/img/zt/dxb/tt_icon.png"></span>                               
                        ...
                        <@s.iterator value="map.get('${station}_bjxizang')" status="st">
                            <h3 class="tits mt10">${title?if_exists} </h3>
                            <ul class="thr_list ciyt_list mt5">
                                <@s.iterator value="map.get('${station}_bjxizang_${st.index + 1}')" >
                                    <li>
                                        <span class="prod_info"><a href="${url?if_exists}" target="_blank"  title="${title?if_exists}">${title?if_exists}<#if bakWord1?exists && bakWord1!=""><span class="${bakWord1}"></span></#if></a></span>
                                        <p class="prod_text"> <@s.if test="null != remark && '' != remark">★ ${remark?if_exists}</@s.if></p>
                                        <span class="prod_price prod_price_city01"><em>¥</em>${memberPrice?if_exists?replace(".0","")}<em>起</em></span>
                    ...
                    <div class="pic_show_aside fl">
                        <div class="pic_show_list">
                            ...
                            <a href="http://www.lvmama.com/guide/2012/0423-162508.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/xizang1.jpg"></a>
                            <p>
                                1.为什么，我们一定要去西藏？
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/guide/2012/0420-162285.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/xizang2.jpg"></a>
                            <p>
                                2.初次进藏需要注意什么—行前准备篇
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/guide/2012/0418-162281.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/xizang3.jpg"></a>
                            <p>
                            ...
                            <a href="http://www.lvmama.com/guide/2012/0420-162507.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/xizang4.jpg"></a>
                            <p>
                                4.藏地之美 你我见证
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/guide/2012/0518-162672.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/xizang5.jpg"></a>
                            <p>
                                5.3300元从西藏穷游到尼伯尔
                                <br/>
                            ...
                            <li>
                                <div class="pic fl">
                                    <a href="http://www.lvmama.com/guide/place/xizang_lasa/" target="_blank">
                                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/xizang_115x162.jpg"></a>
                                </div>
                                <div class="lianjie">
                ...
                <div class="prod_nums"  style="display:block">
                    <div class="city_prod_main fl">
                        <ul class="city_prod_tujian mt5">
                            <@s.iterator value="map.get('${station}_bjxinjiangzt')">
                                <li>
                                    <div class="pic_list fl">
                                        <a href="${url?if_exists}" target="_blank" ><img alt="" src="${imgUrl?if_exists}"></a>
                                        <span class="icon_post"><img alt="" src="http://pic.lvmama.com/img/zt/dxb/tt_icon.png"></span>                               
                        ...
                        <@s.iterator value="map.get('${station}_bjxinjiang')" status="st">
                            <h3 class="tits mt10">${title?if_exists} </h3>
                            <ul class="thr_list ciyt_list mt5">
                                <@s.iterator value="map.get('${station}_bjxinjiang_${st.index + 1}')" >
                                    <li>
                                        <span class="prod_info"><a href="${url?if_exists}" target="_blank"  title="${title?if_exists}">${title?if_exists}<#if bakWord1?exists && bakWord1!=""><span class="${bakWord1}"></span></#if></a></span>
                                        <p class="prod_text"> <@s.if test="null != remark && '' != remark">★ ${remark?if_exists}</@s.if></p>
                                        <span class="prod_price prod_price_city01"><em>¥</em>${memberPrice?if_exists?replace(".0","")}<em>起</em></span>
                    ...
                    <div class="pic_show_aside fl">
                        <div class="pic_show_list">
                            ...
                            <a href="http://www.lvmama.com/guide/2012/0518-162962.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/xijiang1.jpg"></a>
                            <p>
                                1.新疆禾木草原：上帝的后花园
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/info/outdoor/2012-0523-83810.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/xinjiang2.jpg"></a>
                            <p>
                                2.掀起你的盖头来 行摄新疆
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/info/hangkong/2012-0524-86937.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/xinjiang3.jpg"></a>
                            <p>
                                3.穿越狰狞奇幻的新疆魔鬼城之简介
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/info/star/2011-0728-16885.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/xinjiang4.jpg"></a>
                            <p>
                                4.新还珠格格香妃情 访喀什香妃墓
                                <br/>
                            ...
                            <a href="http://www.lvmama.com/info/hangkong/2012-0524-86957.html" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/xinjiang5.jpg"></a>
                            <p>
                                5.看世间罕见的羊肉串是怎样炼成的
                                <br/>
                        ...
                        <ul class="gl_list">
                            ...
                            <div class="pic_list fl">
                                <a href="http://www.lvmama.com/guide/place/xizang_lasa/" target="_blank">
                                    <img src="http://pic.lvmama.com/img/zt/bjdxb/gl.jpg"></a>
                            </div>
                            <div class="lianjie">
                                <a href="http://www.lvmama.com/guide/place/xizang_lasa/" target="_blank">拉萨官方攻略</a>
                            </div>
            ...
            <div class="prod_nums">
                <div class="city_prod_main fl">
                    <ul class="city_prod_tujian mt5">
                            <@s.iterator value="map.get('${station}_bjneimengzt')">
                                <li>
                                    <div class="pic_list fl">
                                        <a href="${url?if_exists}" target="_blank" ><img alt="" src="${imgUrl?if_exists}"></a>
                                        <span class="icon_post"><img alt="" src="http://pic.lvmama.com/img/zt/dxb/tt_icon.png"></span>                               
                        ...
                        <@s.iterator value="map.get('${station}_bjneimeng')" status="st">
                            <h3 class="tits mt10">${title?if_exists} </h3>
                            <ul class="thr_list ciyt_list mt5">
                                <@s.iterator value="map.get('${station}_bjneimeng_${st.index + 1}')" >
                                    <li>
                                        <span class="prod_info"><a href="${url?if_exists}" target="_blank"  title="${title?if_exists}">${title?if_exists}<#if bakWord1?exists && bakWord1!=""><span class="${bakWord1}"></span></#if></a></span>
                                        <p class="prod_text"> <@s.if test="null != remark && '' != remark">★ ${remark?if_exists}</@s.if></p>
                                        <span class="prod_price prod_price_city01"><em>¥</em>${memberPrice?if_exists?replace(".0","")}<em>起</em></span>
                ...
                <div class="pic_show_aside fl">
                    <div class="pic_show_list">
                        ...
                        <a href="http://www.lvmama.com/guide/2012/0507-162644.html" target="_blank">
                            <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/neimeng1.jpg"></a>
                        <p>
                            1.呼伦贝尔大草原行摄攻略
                            <br/>
                        ...
                        <a href="http://www.lvmama.com/info/zijia/2011-0831-20175.html" target="_blank">
                            <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/neimeng2.jpg"></a>
                        <p>
                            2.北京自驾内蒙古 在草原上尽情撒野
                            <br/>
                        ...
                        <a href="http://www.lvmama.com/info/photo/pics/2012-0321-58212.html " target="_blank">
                            <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/neimeng3.jpg"></a>
                        <p>
                        ...
                        <a href="http://www.lvmama.com/info/chinagonglue/2012-0416-67858.html" target="_blank">
                            <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/neimeng4.jpg"></a>
                        <p>
                            4.一起出发 游荡在辽阔的呼伦贝尔
                            <br/>
                        ...
                        <a href="http://www.lvmama.com/info/chinagonglue/2011-0824-19326-2.html" target="_blank">
                            <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/neimeng5.jpg"></a>
                        <p>
                            5.纵情呼伦贝尔 飞奔在内蒙古草原之上
                            <br/>
                    ...
                    <ul class="gl_list">
                        ...
                        <div class="pic fl">
                            <a href="#">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/gl.jpg"></a>
                        </div>
                        <div class="lianjie">
                            <a href="#">三亚官方攻略</a>
                        </div>
        ...
        <div class="prod_nums">
            <div class="city_prod_main fl">
                <ul class="city_prod_tujian mt5">
                            <@s.iterator value="map.get('${station}_bjsiluzt')">
                                <li>
                                    <div class="pic_list fl">
                                        <a href="${url?if_exists}" target="_blank" ><img alt="" src="${imgUrl?if_exists}"></a>
                                        <span class="icon_post"><img alt="" src="http://pic.lvmama.com/img/zt/dxb/tt_icon.png"></span>                               
                        ...
                        <@s.iterator value="map.get('${station}_bjsilu')" status="st">
                            <h3 class="tits mt10">${title?if_exists} </h3>
                            <ul class="thr_list ciyt_list mt5">
                                <@s.iterator value="map.get('${station}_bjsilu_${st.index + 1}')" >
                                    <li>
                                        <span class="prod_info"><a href="${url?if_exists}" target="_blank"  title="${title?if_exists}">${title?if_exists}<#if bakWord1?exists && bakWord1!=""><span class="${bakWord1}"></span></#if></a></span>
                                        <p class="prod_text"> <@s.if test="null != remark && '' != remark">★ ${remark?if_exists}</@s.if></p>
                                        <span class="prod_price prod_price_city01"><em>¥</em>${memberPrice?if_exists?replace(".0","")}<em>起</em></span>
            ...
            <div class="pic_show_aside fl">
                <div class="pic_show_list">
                    ...
                    <a href="http://www.lvmama.com/guide/2011/0609-128620.html" target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/silu1.jpg"></a>
                    <p>
                        1.千元游敦煌，你不得不信 如假包换
                        <br/>
                    ...
                    <a href="http://www.lvmama.com/info/chinagonglue/2011-0613-6723.html" target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/silu2.jpg"></a>
                    <p>
                        2.西北敦煌之旅 大漠孤烟处的文化奇葩
                        <br/>
                    ...
                    <a href="http://www.lvmama.com/guide/2009/1230-133217.html" target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/silu3.jpg"></a>
                    <p>
                    ...
                    <a href="http://www.lvmama.com/guide/2011/0609-128618.html" target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/silu4.jpg"></a>
                    <p>
                        4.两关悲戚，春风不度的地貌残骸
                        <br/>
                    ...
                    <a href="http://www.lvmama.com/guide/2010/1217-106469.html" target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/silu5.jpg"></a>
                    <p>
                        5.青海湖 夏季的调色板
                        <br/>
                    ...
                    <li>
                        <div class="pic fl">
                            <a href="http://www.lvmama.com/guide/place/gansu_dunhuangshi/" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/silu_115x162.jpg"></a>
                        </div>
                        <div class="lianjie">
        ...
        <div class="prod_nums">
            <div class="city_prod_main fl">
                <ul class="city_prod_tujian mt5">
                            <@s.iterator value="map.get('${station}_bjshanxizt')">
                                <li>
                                    <div class="pic_list fl">
                                        <a href="${url?if_exists}" target="_blank" ><img alt="" src="${imgUrl?if_exists}"></a>
                                        <span class="icon_post"><img alt="" src="http://pic.lvmama.com/img/zt/dxb/tt_icon.png"></span>                               
                        ...
                        <@s.iterator value="map.get('${station}_bjshanxi')" status="st">
                            <h3 class="tits mt10">${title?if_exists} </h3>
                            <ul class="thr_list ciyt_list mt5">
                                <@s.iterator value="map.get('${station}_bjshanxi_${st.index + 1}')" >
                                    <li>
                                        <span class="prod_info"><a href="${url?if_exists}" target="_blank"  title="${title?if_exists}">${title?if_exists}<#if bakWord1?exists && bakWord1!=""><span class="${bakWord1}"></span></#if></a></span>
                                        <p class="prod_text"> <@s.if test="null != remark && '' != remark">★ ${remark?if_exists}</@s.if></p>
                                        <span class="prod_price prod_price_city01"><em>¥</em>${memberPrice?if_exists?replace(".0","")}<em>起</em></span>
            ...
            <div class="pic_show_aside fl">
                <div class="pic_show_list">
                    ...
                    <a href="http://www.lvmama.com/info/chinagonglue/2012-0528-89759.html " target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/shanxi1.jpg"></a>
                    <p>
                        1.面条竟然像腰带？细数陕西十大怪
                        <br/>
                    ...
                    <a href="http://www.lvmama.com/guide/2011/0111/122347.html" target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/shanxi2.jpg"></a>
                    <p>
                        2.骑单车逛西安-书院门 历史博物馆
                        <br/>
                    ...
                    <a href="http://www.lvmama.com/info/chinagonglue/2011-0412-91.html" target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/shanxi3.jpg"></a>
                    <p>
                        3.西安美食全介绍 泡馍里的西北风情
                        <br/>
                    ...
                    <a href="http://www.lvmama.com/guide/2009/1230-132534.html" target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/shanxi4.jpg"></a>
                    <p>
                        4.陕西汉中：兼南北之美的风水宝地
                        <br/>
                    ...
                    <a href="http://www.lvmama.com/info/chinagonglue/2011-0622-6880.html " target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/shanxi5.jpg"></a>
                    <p>
                    ...
                    <li>
                        <div class="pic fl">
                            <a href="http://www.lvmama.com/guide/place/shannxi_xian/" target="_blank">
                                <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/shanxi_115x162.jpg"></a>
                        </div>
                        <div class="lianjie">
        ...
        <div class="prod_nums">
            <div class="city_prod_main fl">
                <ul class="city_prod_tujian mt5">
                            <@s.iterator value="map.get('${station}_bjsanxiazt')">
                                <li>
                                    <div class="pic_list fl">
                                        <a href="${url?if_exists}" target="_blank" ><img alt="" src="${imgUrl?if_exists}"></a>
                                        <span class="icon_post"><img alt="" src="http://pic.lvmama.com/img/zt/dxb/tt_icon.png"></span>                               
                        ...
                        <@s.iterator value="map.get('${station}_bjsanxia')" status="st">
                            <h3 class="tits mt10">${title?if_exists} </h3>
                            <ul class="thr_list ciyt_list mt5">
                                <@s.iterator value="map.get('${station}_bjsanxia_${st.index + 1}')" >
                                    <li>
                                        <span class="prod_info"><a href="${url?if_exists}" target="_blank"  title="${title?if_exists}">${title?if_exists}<#if bakWord1?exists && bakWord1!=""><span class="${bakWord1}"></span></#if></a></span>
                                        <p class="prod_text"> <@s.if test="null != remark && '' != remark">★ ${remark?if_exists}</@s.if></p>
                                        <span class="prod_price prod_price_city01"><em>¥</em>${memberPrice?if_exists?replace(".0","")}<em>起</em></span>
            ...
            <div class="pic_show_aside fl">
                <div class="pic_show_list">
                    ...
                    <a href="http://www.lvmama.com/info/city/2011-1122-37176.html" target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/sanxia1.jpg"></a>
                    <p>
                        1.逆流而上游三峡 看长江最深处的美
                        <br/>
                    ...
                    <a href="http://www.lvmama.com/info/chinagonglue/2011-0921-22390.html" target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/sanxia2.jpg"></a>
                    <p>
                        2.乘游轮赏三峡美景 秋高气爽正当时
                        <br/>
                    ...
                    <a href="http://www.lvmama.com/info/chinalife/2012-0516-81303.html" target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/sanxia3.jpg"></a>
                    <p>
                        3.秀丽神奇文艺 游三峡不可错过的景点
                        <br/>
                    ...
                    <a href="http://www.lvmama.com/info/chinagonglue/2011-0608-6399.html" target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/sanxia4.jpg"></a>
                    <p>
                    ...
                    <a href="http://www.lvmama.com/info/chinalife/2012-0503-77596.html" target="_blank">
                        <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/sanxia5.jpg"></a>
                    <p>
                        5.巫山小三峡观六奇之美
                        <br/>
    ...
    <div class="prod_nums">
        <div class="city_prod_main fl">
            <ul class="city_prod_tujian mt5">
                            <@s.iterator value="map.get('${station}_bjguizhouzt')">
                                <li>
                                    <div class="pic_list fl">
                                        <a href="${url?if_exists}" target="_blank" ><img alt="" src="${imgUrl?if_exists}"></a>
                                        <span class="icon_post"><img alt="" src="http://pic.lvmama.com/img/zt/dxb/tt_icon.png"></span>                               
                        ...
                        <@s.iterator value="map.get('${station}_bjguizhou')" status="st">
                            <h3 class="tits mt10">${title?if_exists} </h3>
                            <ul class="thr_list ciyt_list mt5">
                                <@s.iterator value="map.get('${station}_bjguizhou_${st.index + 1}')" >
                                    <li>
                                        <span class="prod_info"><a href="${url?if_exists}" target="_blank"  title="${title?if_exists}">${title?if_exists}<#if bakWord1?exists && bakWord1!=""><span class="${bakWord1}"></span></#if></a></span>
                                        <p class="prod_text"> <@s.if test="null != remark && '' != remark">★ ${remark?if_exists}</@s.if></p>
                                        <span class="prod_price prod_price_city01"><em>¥</em>${memberPrice?if_exists?replace(".0","")}<em>起</em></span>
        ...
        <div class="pic_show_aside fl">
            <div class="pic_show_list">
                ...
                <a href="http://www.lvmama.com/info/chinagonglue/2011-0622-6878.html " target="_blank">
                    <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/guizhou1.jpg"></a>
                <p>
                    1.贵州红色旅游 访遵义会议旧址
                    <br/>
                ...
                <a href="http://www.lvmama.com/guide/2012/0328-162047.html" target="_blank">
                    <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/guizhou2.jpg"></a>
                <p>
                    2.多彩贵州 印象趣玩黄果树
                    <br/>
                ...
                <a href="http://www.lvmama.com/guide/2012/0306-161740.html" target="_blank">
                    <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/guizhou3.jpg"></a>
                <p>
                    3.吃喝苗家，收藏苗家
                    <br/>
                ...
                <a href="http://www.lvmama.com/guide/2012/0307-161767.html" target="_blank">
                    <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/guizhou4.jpg"></a>
                <p>
                    4.镇远-此生不能错过的宁静古镇
                    <br/>
                ...
                <a href="http://www.lvmama.com/guide/2011/0118-126623-1.html" target="_blank">
                    <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/guizhou5.jpg"></a>
                <p>
                    5.黔东南11天最新实用攻略
                    <br/>
                ...
                <li>
                    <div class="pic fl">
                        <a href="http://www.lvmama.com/guide/place/guizhou_qiandongnanmiaozudongz/" target="_blank">
                            <img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/guizhou_115x162.jpg"></a>
                    </div>
                    <div class="lianjie">
...
<div class="hot_pic">
    <a href="http://www.lvmama.com/zt/shoot/" target="_blank">
        <img alt="" src="http://pic.lvmama.com/opi/shoot.jpg 
"></a>
    <a href="http://www.lvmama.com/zt/lvyou/yunnan 
" target="_blank">
        <img alt="" src="http://pic.lvmama.com/opi/823284135.jpg
"></a>
    <a href="http://www.lvmama.com/zt/lvyou/zjy 

" target="_blank">
        <img alt="" src="http://pic.lvmama.com/opi/zijia284_135.jpg 
"></a>
</li>
</ul>
</div>
...
<img alt="" src="http://pic.lvmama.com/img/zt/bjdxb/bottom_pic.jpg"></div>
<!--pop-->
