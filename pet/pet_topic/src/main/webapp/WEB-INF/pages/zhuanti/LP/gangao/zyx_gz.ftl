...
<head>
<meta charset="utf-8" />
<title>广州到港澳自由行_广州到港澳自由行线路-驴妈妈旅游网</title>
<meta name="keywords" content="广州到港澳旅游,港澳旅游路线"/>
<meta name="description" content="驴妈妈旅游网提供港澳旅游线路,广州到港澳自由行,带你游遍港澳主要特色景点,我们的旅游产品,广州到港澳自由行线路报价优惠,省心,安心."/>
...
<div class="main_all">
    <dl class="main_cfd">
        ...
        <dd class="main_cfd_dd"><a target="_self" href="zyx_gz.html">广州/深圳/香港</a></dd>
    </dl>
    
<!--页面左侧-->
    <div class="main_left">
		<div class="ga-free-pro">
			<@s.iterator value="map.get('${station}_zyx_gz')" status="st">
				<h3>${title?if_exists}</h3>
				<ul class="ga-free-list">
					<@s.iterator value="map.get('${station}_zyx_gz_${st.index + 1}')" status="sts">
						<li>
