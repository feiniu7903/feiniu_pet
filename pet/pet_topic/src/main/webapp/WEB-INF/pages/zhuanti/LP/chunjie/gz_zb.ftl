...
<head>
<meta charset="utf-8" />
<title>春节广州周边旅游景点推荐_春节广州周边旅游线路推荐,价格-驴妈妈旅游网</title>
<meta name="keywords" content="春节，广州,广州周边,旅游" />
<meta name="description" content="驴妈妈推出专题向驴友推出春节广州周边旅游景
点推荐，以及春节广州周边游线路推荐价格，这些驴妈妈专题为您收罗和创新出广州周
边旅游线路的美丽景色，大家一起来旅游吧！" />
...
<div class="main_all">
	...
	<ul class="nav">
        <li class="nav_li1 nav_li"><a class="nav_1" href="gz_zb.html" target="_self">周边</a></li>
        <li><a class="nav_2" href="gz_cx.html" target="_self">长线</a></li>
        <li><a class="nav_3" href="gz_cj.html" target="_self">出境</a></li>
    </ul>
    <div class="yc_box">
    	<h2 class="yc_title">迎春节正在热销•••</h2>
        <ul class="rx_list">
        <@s.iterator value="map.get('${station}_zbgz_tm')" status="st">
            <li>
    ...
    <div class="diqu_box">
<!--东南亚模块-->
 	<@s.iterator value="map.get('${station}_zbgz')" status="st">
        <h3 class="maodian"><span>${title?if_exists}</span></h3>
        <ul class="cp_list">
        <@s.iterator value="map.get('${station}_zbgz_${st.index + 1}')" status="sts">
        	<li>
...
<div class="main_b ">
    ...
    <ul class="hd_list">
    	<@s.iterator value="map.get('${station}_tp_gz')" status="st">
...
<div class="cfd_box">
	<dl>
        ...
        <dd class="cfd_box_dd"><a href="gz_zb.html" target="_self">广州</a></dd>
