...
<head>
<meta charset="utf-8" />
<title>2014广州五一旅游_广州及周边五一线路,价格,推荐-驴妈妈旅游网</title> 
<meta name="keywords" content="广州五一,广州五一旅游,广州周边,线路"> 
<meta name="description" content="2014五一劳动节：驴妈妈旅游网推荐广州五一旅游线路,广州五一劳动节旅游去哪里玩，五一劳动节广州周边旅游线路;以优质的服务提供您一个愉快五一旅游度假！"> 
...
<div class="wrap">
	<div class="main">
        ...
        <div class="nav" id="nav">
            ...
            <a class="nav4 navLi" href="http://www.lvmama.com/zt/lvyou/wuyi_1/gz.html" target="_self"><span></span></a>
        </div>
        ...
        <div class="areaList">
        	<div class="section" id="md1">
                ...
                <div class="pro">
            		<ul class="proList">
            		<@s.iterator value="map.get('${station}_gz_place')" status="st">
                        <li>
            ...
            <div class="section" id="md2">
                ...
                <div class="pro2">
            		...
            		<@s.iterator value="map.get('${station}_gz_ambitus_free')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
                    ...
                    <ul class="proList">
                    	<@s.iterator value="map.get('${station}_gz_ambitus_group')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
            ...
            <div class="section" id="md3">
                ...
                <div class="pro2">
            		...
            		<ul class="proList" style="display:block;">
            		<@s.iterator value="map.get('${station}_gz_home_free')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
                    ...
                    <ul class="proList">
                    	<@s.iterator value="map.get('${station}_gz_home_group')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="#" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
                                <p>
                                    <span>￥<b>${memberPrice?if_exists?replace(".0","")}</b>起</span>
                                    <del>原价：￥${marketPrice?if_exists?replace(".0","")}</del>
            ...
            <div class="section" id="md4">
                ...
                <div class="pro2">
                	<ul class="pro-nav">
            		  ...
            		  <!--东南亚-->
            		<ul class="proList" style="display:block;">
            			<@s.iterator value="map.get('${station}_gz_southeast_asia')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
                    ...
                    <!--海岛 sh_island -->
                    <ul class="proList">
                   	 <@s.iterator value="map.get('${station}_gz_island')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
                    ...
                    <!--港澳日韩-->
                    <ul class="proList">
                    <@s.iterator value="map.get('${station}_gz_garh')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
                    ...
                    <!--欧美澳非-->
                    <ul class="proList">
                    <@s.iterator value="map.get('${station}_gz_omaf')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
                    ...
                    <!--油轮-->
                    <ul class="proList">
                   	 <@s.iterator value="map.get('${station}_gz_youlun')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
