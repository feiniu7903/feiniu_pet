...
<head>
<meta charset="utf-8" />
<title>上海春节出境游线路_上海出发春节出境游线路价格，哪里好-驴妈妈旅游网</title>
<meta name="keywords" content="出境，旅游,上海" />
<meta name="description" content="驴妈妈推出专题向驴友推出上海春节出境游线路，有些人会问上海出发春节出境游线路价格?以及上海出境游哪里好?驴妈妈为您收罗了上海出境游美丽景色，一起来旅游吧！" />
...
<div class="main_all">
	...
	<ul class="nav">
    	<li class="nav_li1 nav_li"><a class="nav_3" href="sh_cj.html" target="_self">出境</a></li>
        
        <li><a class="nav_2" href="sh_cx.html" target="_self">长线</a></li>
        <li><a class="nav_1" href="index.html" target="_self">周边</a></li>
    </ul>
    <div class="yc_box">
    	<h2 class="yc_title">迎春节正在热销•••</h2>
        <ul class="rx_list">
        <@s.iterator value="map.get('${station}_cj_tm')" status="st">
            <li>
...
<div class="main_b ">
    ...
    <ul class="hd_list">
		<@s.iterator value="map.get('${station}_tp2_sh')" status="st">
