...
<div class="wrap">	
    ...
    <div class="main" id="main">
    	<div class="ticket" id="ticket">
        	<h3>
        	<@s.iterator value="map.get('${station}_js_ticket_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
             <@s.iterator value="map.get('${station}_js_ticket')"  var="var" status="st">
            	<li>
                	<div class="intro">
        ...
        <div class="ticket freetour" id="freetour">
            <h3>
        	<@s.iterator value="map.get('${station}_js_freetour_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
              <@s.iterator value="map.get('${station}_js_freetour')"  var="var" status="st">
            	<li>
                	<div class="intro">
                    	<img src="${imgUrl?if_exists}" width="210" height="140" alt="">
                        <h4><a href="${url?if_exists}">${title?if_exists}</a></h4>
        ...
        <div class="ticket group" id="group">
        	 <h3>
        	<@s.iterator value="map.get('${station}_js_group_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
            	 <@s.iterator value="map.get('${station}_js_group')"  var="var" status="st">
            	<li>
                	<div class="intro">
                    	<img src="${imgUrl?if_exists}" width="210" height="140" alt="">
                        <h4><a href="${url?if_exists}">${title?if_exists}</a></h4>
        ...
        <div class="ticket freetour abroad" id="abroad">
        	 <h3>
        	<@s.iterator value="map.get('${station}_js_abroad_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
            	 <@s.iterator value="map.get('${station}_js_abroad')"  var="var" status="st">
            	<li>
                	<div class="intro">
                    	<img src="${imgUrl?if_exists}" width="210" height="140" alt="">
                        <h4><a href="${url?if_exists}">${title?if_exists}</a></h4>
        ...
        <div class="ticket tuangou" id="tuangou">
        	 <h3>
        	<@s.iterator value="map.get('${station}_js_tuangou_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
            	 <@s.iterator value="map.get('${station}_js_tuangou')"  var="var" status="st">
            	<li>
                	<div class="intro">
                    	<img src="${imgUrl?if_exists}" width="210" height="140" alt="">
                        <h4><a href="${url?if_exists}">${title?if_exists}</a></h4>
...
<div class="nav">
    ...
    <ul class="navList">
        ...
        <li  class="navLi"><a href="http://www.lvmama.com/zt/lvyou/foolsday/js.html#main" target="_self">江苏</a></li>
