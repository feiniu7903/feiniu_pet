...
<div id="wrap">
     <div class="banner">
          ...
          <img src="http://pic.lvmama.com/img/zt/xiamen/banner12.jpg" width="980" height="125"  alt="厦门哪里好玩"/>
          <!--<ul class="nav">
          ...
          <ul class="nav_new">
          	<li class="fisrtLi nav_li"><a href="http://www.lvmama.com/zt/lvyou/xiamen/">上　海</a></li>
            ...
            <li><a href="http://www.lvmama.com/zt/lvyou/xiamen/cd.html">成　都</a></li>
          </ul>
      </div><!--banner end-->
	<div class="top_img">
            <div class="slide_bg">
            	<div class="slide_contain">
                	<ul id="slide" class="slide">
                		<@s.iterator value="map.get('${station}_sh_img')"  var="var" status="st">
	                		<li>	
	  ...
	  <!--周末游玩线路推荐-->    <div class="weekend_recom cpFjJsBox">
           ...
           <h3 id="t4"><em>厦门游玩线路推荐</em><span></span><a href="http://www.lvmama.com/search/route/上海-厦门.html" class="more_btn">更多&gt;&gt;</a></h3> 
	             <div class="cpJsBox" style="display:block;">
	                 <dl class="cpBox">
		               <@s.iterator value="map.get('${station}_sh_freeLine1')"  var="var" status="st">
	                ...
	                <dl class="cpBox">
	                   <@s.iterator value="map.get('${station}_sh_freeLine2')"  var="var" status="st">
	                      <@s.if test="#st.first"> <dt><a href="${url?if_exists}"><img src="${imgUrl?if_exists}" width="190" height="140" alt="鼓浪屿" /></a></dt></@s.if>
	                   </@s.iterator> 
	                    <dd>
	                    <@s.iterator value="map.get('${station}_sh_freeLine2')"  var="var" status="st">
            ...
            <div class="cpJsBox">
                 <dl class="cpBox">
                       <@s.iterator value="map.get('${station}_sh_group1')"  var="var" status="st">
	                       <@s.if test="#st.first"> <dt><a href="${url?if_exists}"><img src="${imgUrl?if_exists}" width="190" height="140" alt="鼓浪屿" /></a></dt></@s.if>
	                   </@s.iterator> 
	                    <dd>
	                    <@s.iterator value="map.get('${station}_sh_group1')"  var="var" status="st">
                ...
                <dl class="cpBox">
                      <@s.iterator value="map.get('${station}_sh_group2')"  var="var" status="st">
	                       <@s.if test="#st.first"> <dt><a href="${url?if_exists}"><img src="${imgUrl?if_exists}" width="190" height="140" alt="鼓浪屿" /></a></dt></@s.if>
	                   </@s.iterator> 
	                    <dd>
	                    <@s.iterator value="map.get('${station}_sh_group2')"  var="var" status="st">
            ...
            <div class="cpJsBox">
                 <dl class="cpBox">
                      <@s.iterator value="map.get('${station}_sh_ticket1')"  var="var" status="st">
	                       <@s.if test="#st.first"> <dt><a href="${url?if_exists}"><img src="${imgUrl?if_exists}" width="190" height="140" alt="鼓浪屿" /></a></dt></@s.if>
	                   </@s.iterator> 
	                    <dd>
	                    <@s.iterator value="map.get('${station}_sh_ticket1')"  var="var" status="st">
                ...
                <dl class="cpBox">
                       <@s.iterator value="map.get('${station}_sh_ticket2')"  var="var" status="st">
	                       <@s.if test="#st.first"> <dt><a href="${url?if_exists}"><img src="${imgUrl?if_exists}" width="190" height="140" alt="鼓浪屿" /></a></dt></@s.if>
	                   </@s.iterator> 
	                    <dd>
	                    <@s.iterator value="map.get('${station}_sh_ticket2')"  var="var" status="st">
            ...
            <div class="cpJsBox">
                 <dl class="cpBox">
                      <@s.iterator value="map.get('${station}_sh_hotel1')"  var="var" status="st">
	                       <@s.if test="#st.first"> <dt><a href="${url?if_exists}"><img src="${imgUrl?if_exists}" width="190" height="140" alt="鼓浪屿" /></a></dt></@s.if>
	                   </@s.iterator> 
	                      <dd>
	                    <@s.iterator value="map.get('${station}_sh_hotel1')"  var="var" status="st">
                ...
                <dl class="cpBox">
                     <@s.iterator value="map.get('${station}_sh_hotel2')"  var="var" status="st">
	                       <@s.if test="#st.first"> <dt><a href="${url?if_exists}"><img src="${imgUrl?if_exists}" width="190" height="140" alt="鼓浪屿" /></a></dt></@s.if>
	                   </@s.iterator> 
	                      <dd>
	                    <@s.iterator value="map.get('${station}_sh_hotel2')"  var="var" status="st">
            ...
            <div class="city_main">
            		<div class="info fl">
                            ...
                            <dl>
                                ...
                                <@s.iterator value="map.get('${station}_sh_xiaoyuan1')"  var="var" status="st">
                    ...
                    <div class="info info2">
                            ...
                            <dl>
                                ...
                                <@s.iterator value="map.get('${station}_sh_xiaoyuan2')"  var="var" status="st">
                                <dd><a href="${url?if_exists}">
                            		推荐产品：${title?if_exists}</a></dd>
								</@s.iterator>
...
<dl>
                ...
                <dd class="wid_630 fl">
                        ...
                        <@s.iterator value="map.get('${station}_sh_xinwanfa1')"  var="var" status="st">
							 <p class="czx_link"><a href="${url?if_exists}">产品推荐：${title?if_exists}</a></p> 
                        </@s.iterator>                          
...
<div class="city_main">
            		<div class="info fl">
                            ...
                            <dl>
                                ...
                                <dd><strong>推荐理由：</strong>厦门日月谷温泉渡假村座落于厦门天竺山麓，这里是闽南旅游圈中心地带，山峦环抱、景色绮丽，连时光也在此乍然驻足，等待您的，是全身心的放松与平静......</a></dd>
                               	<@s.iterator value="map.get('${station}_sh_xinwanfa2')"  var="var" status="st">
                    ...
                    <div class="info info2">
                            ...
                            <dl>
                               ...
                               <@s.iterator value="map.get('${station}_sh_xinwanfa3')"  var="var" status="st">
                               	 <dd><a href="${url?if_exists}">推荐产品：${title?if_exists}</a></dd>
                                 </@s.iterator>
                            </dl>
              </div><!--info2 end-->
