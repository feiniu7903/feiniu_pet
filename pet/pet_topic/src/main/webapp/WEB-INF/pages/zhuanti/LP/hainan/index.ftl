...
<title>上海出发到海南旅游_上海去海南旅游线路价格,多少钱-驴妈妈旅游网</title>
<meta name="keywords" content="海南旅游，上海 " />
<meta name="description" content="独立发团上海出发到海南旅游，上海去海南旅游线路价格,不用问上海去海南旅游线路多少钱,驴妈妈给您一个非凡的海南国际旅游岛体验。" />
...
<div class="wrap">
	<div class="banner">
    	<div class="nav">
            ...
            <span class="navc"><a href="#" target="_self" class="cur">上海</a><a href="hz.html" target="_self">杭州</a><a href="nj.html" target="_self">南京</a><a href="bj.html" target="_self">北京</a></span>
            <span class="navr"></span>
        </div>
    </div>
    <div class="main">
    <@s.iterator value="map.get('${station}_db')" status="st">
    	<div class="topPro">
        	...
        	<div class="mainL">
            	<div class="tabs">
                    ...
                    <div class="tabmain jsList tabList_this">
                    	<@s.iterator value="map.get('${station}_lx')" status="st">
                    	...
                    	<ul class="tabList2">
			<@s.iterator value="map.get('${station}_gt')" status="st">
            		...
            		<@s.else>
                        ...
                        <@s.iterator value="map.get('${station}_gt_${st.index + 1}')" status="sts">
                        	<dl>
                    ...
                    <div class="tabmain jsList">
                    	...
                    	<ul class="tabList2">
                        <@s.iterator value="map.get('${station}_zyx')" status="st">
			<@s.if test="#st.isFirst()">
                        <li class="tabList_this">${title?if_exists}</li>
                        </@s.if>
            		<@s.else>
                        ...
                        <@s.iterator value="map.get('${station}_zyx')" status="st"> 
                        <div class="tabmain2 jsList tabList_this">
                        <@s.iterator value="map.get('${station}_zyx_${st.index + 1}')" status="sts">
                        	<dl>
                            <dt><b><i>&yen;</i><span>${memberPrice?if_exists?replace(".0","")}</span>起</b><a href="${url?if_exists}">${title?if_exists}</a></dt>
                            <dd>${bakWord1?if_exists}</dd>
                            </dl>
