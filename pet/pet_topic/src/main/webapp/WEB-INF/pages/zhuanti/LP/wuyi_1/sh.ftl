...
<head>
<meta charset="utf-8" />
<title>2014上海五一旅游_上海及周边五一线路,价格,推荐-驴妈妈旅游网</title> 
<meta name="keywords" content="上海五一,上海五一旅游,上海周边,线路"> 
<meta name="description" content="2014五一劳动节：驴妈妈旅游网推荐上海五一旅游线路,上海五一劳动节旅游去哪里玩，五一劳动节上海周边旅游线路;以优质的服务提供您一个愉快五一旅游度假！"> 
...
<div class="wrap">
	<div class="main">
        ...
        <div class="nav" id="nav">
        	<a class="nav1 navLi" href="http://www.lvmama.com/zt/lvyou/wuyi_1/" target="_self"><span></span></a>
            <a class="nav2" href="http://www.lvmama.com/zt/lvyou/wuyi_1/cd.html" target="_self"><span></span></a>
        ...
        <div class="areaList">
        	...
        	<div class="section" id="md1">
                ...
                <div class="pro">
            		<ul class="proList">
            			<@s.iterator value="map.get('${station}_sh_place')" status="st">
                        <li>
            ...
            <div class="section" id="md2">
                ...
                <div class="pro2">
            		...
            		<!--自由行-->
            		<@s.iterator value="map.get('${station}_sh_ambitus_free')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
                    ...
                    <!--跟团游-->
                    <ul class="proList">
                   	 <@s.iterator value="map.get('${station}_sh_ambitus_group')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
            ...
            <div class="section" id="md3">
                ...
                <div class="pro2">
            		...
            		<ul class="proList" style="display:block;">
            			<@s.iterator value="map.get('${station}_sh_home_free')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
                    ...
                    <ul class="proList">
                   		<@s.iterator value="map.get('${station}_sh_home_group')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
            ...
            <div class="section" id="md4">
                ...
                <div class="pro2">
                    ...
                    <!--东南亚-->
            		<ul class="proList" style="display:block;">
            			<@s.iterator value="map.get('${station}_sh_southeast_asia')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
                    ...
                    <!--海岛 sh_island -->
                    <ul class="proList">
                   	 <@s.iterator value="map.get('${station}_sh_island')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
                    ...
                    <!--港澳日韩-->
                    <ul class="proList">
                    <@s.iterator value="map.get('${station}_sh_garh')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
                    ...
                    <!--欧美澳非-->
                    <ul class="proList">
                    <@s.iterator value="map.get('${station}_sh_omaf')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
                    ...
                    <!--油轮-->
                    <ul class="proList">
                   	 <@s.iterator value="map.get('${station}_sh_youlun')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
...
<div class="sideBg">
	...
	<img src="http://pic.lvmama.com/img/zt/wuyi/fdc.jpg" width="150" height="220" border="0" usemap="#Map" style="margin-top:20px"/>
	<map name="Map">
	  <area shape="rect" coords="24,191,128,212" href="http://www.lvmama.com/search/freetour/79-赠意大利馆门票.html" target="_blank">
	</map>
</div>
