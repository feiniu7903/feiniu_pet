...
<div id="wrap">
     <div class="banner">
          ...
          <ul class="nav_new">
            ...
            <li class="nav_li"><a href="http://www.lvmama.com/zt/lvyou/xiamen/gz.html">广　州</a></li>
	...
	<div class="top_img">
            <div class="slide_bg">
            	<div class="slide_contain">
                	<ul id="slide" class="slide">
                        <@s.iterator value="map.get('${station}_gz_img')"  var="var" status="st">
	                		<li>	
	  ...
	  <!--周末游玩线路推荐-->    <div class="weekend_recom cpFjJsBox">
           ...
           <h3 id="t4"><em>厦门游玩线路推荐</em><span></span><a href="http://www.lvmama.com/search/freetour/广州-厦门.html" class="more_btn">更多&gt;&gt;</a></h3> 
             <div class="cpJsBox" style="display:block;">
                 <dl class="cpBox">
                   <@s.iterator value="map.get('${station}_gz_freeLine1')"  var="var" status="st">
	                ...
	                <dl class="cpBox">
	                   <@s.iterator value="map.get('${station}_gz_freeLine2')"  var="var" status="st">
	                      <@s.if test="#st.first"> <dt><a href="${url?if_exists}"><img src="${imgUrl?if_exists}" width="190" height="140" alt="鼓浪屿" /></a></dt></@s.if>
	                   </@s.iterator> 
	                    <dd>
	                    <@s.iterator value="map.get('${station}_gz_freeLine2')"  var="var" status="st">
            ...
            <div class="cpJsBox">
                 <dl class="cpBox">
                    <@s.iterator value="map.get('${station}_gz_group1')"  var="var" status="st">
	                       <@s.if test="#st.first"> <dt><a href="${url?if_exists}"><img src="${imgUrl?if_exists}" width="190" height="140" alt="鼓浪屿" /></a></dt></@s.if>
	                   </@s.iterator> 
	                    <dd>
	                    <@s.iterator value="map.get('${station}_gz_group1')"  var="var" status="st">
                ...
                <dl class="cpBox">
                      <@s.iterator value="map.get('${station}_gz_group2')"  var="var" status="st">
	                       <@s.if test="#st.first"> <dt><a href="${url?if_exists}"><img src="${imgUrl?if_exists}" width="190" height="140" alt="鼓浪屿" /></a></dt></@s.if>
	                   </@s.iterator> 
	                    <dd>
	                    <@s.iterator value="map.get('${station}_gz_group2')"  var="var" status="st">
            ...
            <div class="cpJsBox">
                 <dl class="cpBox">
                   <@s.iterator value="map.get('${station}_gz_ticket1')"  var="var" status="st">
	                       <@s.if test="#st.first"> <dt><a href="${url?if_exists}"><img src="${imgUrl?if_exists}" width="190" height="140" alt="鼓浪屿" /></a></dt></@s.if>
	                   </@s.iterator> 
	                    <dd>
	                    <@s.iterator value="map.get('${station}_gz_ticket1')"  var="var" status="st">
                ...
                <dl class="cpBox">
                       <@s.iterator value="map.get('${station}_gz_ticket2')"  var="var" status="st">
	                       <@s.if test="#st.first"> <dt><a href="${url?if_exists}"><img src="${imgUrl?if_exists}" width="190" height="140" alt="鼓浪屿" /></a></dt></@s.if>
	                   </@s.iterator> 
	                    <dd>
	                    <@s.iterator value="map.get('${station}_gz_ticket2')"  var="var" status="st">
            ...
            <div class="cpJsBox">
                 <dl class="cpBox">
                     <@s.iterator value="map.get('${station}_gz_hotel1')"  var="var" status="st">
	                       <@s.if test="#st.first"> <dt><a href="${url?if_exists}"><img src="${imgUrl?if_exists}" width="190" height="140" alt="鼓浪屿" /></a></dt></@s.if>
	                   </@s.iterator> 
	                      <dd>
	                    <@s.iterator value="map.get('${station}_gz_hotel1')"  var="var" status="st">
                ...
                <dl class="cpBox">
                     <@s.iterator value="map.get('${station}_gz_hotel2')"  var="var" status="st">
	                       <@s.if test="#st.first"> <dt><a href="${url?if_exists}"><img src="${imgUrl?if_exists}" width="190" height="140" alt="鼓浪屿" /></a></dt></@s.if>
	                   </@s.iterator> 
	                      <dd>
	                    <@s.iterator value="map.get('${station}_gz_hotel2')"  var="var" status="st">
            		...
            		<div class="info fl">
                            ...
                            <dl>
                                ...
                                <dd><strong>推荐理由：</strong>北大清华作为高校的"学术骨干"，一直给人严肃、且高高在上难以接近的感觉，就好像一位老学者。而厦门大学似乎对此并不屑，依山傍海、椰林树影的厦大，却好似一位多情的少女，有着自己的一片浪漫……</dd>
                                   <@s.iterator value="map.get('${station}_gz_xiaoyuan1')"  var="var" status="st">
                    ...
                    <div class="info info2">
                            ...
                            <dl>
                                ...
                                <dd><strong>推荐理由：</strong>厦门是一个文艺和灵气的地方，除了"最美校园"厦大之外，集美学村也是一个充满文艺范儿的地方，值得一去。说起集美学村，不得不提起陈嘉庚，陈嘉庚是抗日战争、解放战争时期的爱国领袖、企业家、教育家……</dd>
                                 <@s.iterator value="map.get('${station}_gz_xiaoyuan2')"  var="var" status="st">
                                <dd><a href="${url?if_exists}">
                            		推荐产品：${title?if_exists}</a></dd>
								</@s.iterator>
...
厦门美食风味独特，充满浓郁的闽南特色，蚵仔煎、鱼丸汤、烧仙草等美食早已闻名全国。那么在厦门，有没有一个地方可以一次性吃到所有厦门美食呢？就在厦门的"台湾小吃街"！</p>
 <@s.iterator value="map.get('${station}_gz_meishi1')"  var="var" status="st">
	                        <p class="czx_link">
...
<dl>
 ...
 <@s.iterator value="map.get('${station}_gz_xinwanfa1')"  var="var" status="st">
            		...
            		<div class="info fl">
                            ...
                            <dl>
                                ...
                                <dd><strong>推荐理由：</strong>厦门日月谷温泉渡假村座落于厦门天竺山麓，这里是闽南旅游圈中心地带，山峦环抱、景色绮丽，连时光也在此乍然驻足，等待您的，是全身心的放松与平静......</a></dd>
                             	<@s.iterator value="map.get('${station}_gz_xinwanfa2')"  var="var" status="st">
                    ...
                    <div class="info info2">
                            ...
                            <dl>
                                ...
                                <dd><strong>推荐理由：</strong>厦门翠丰温泉度假酒店位于闽南金三角枢纽地带、景色优美的同安汀溪水库风景区，是新加坡诚毅度假酒店集团首家五星级温泉度假酒店……</a></dd>
                                  <@s.iterator value="map.get('${station}_gz_xinwanfa3')"  var="var" status="st">
                               	 <dd><a href="${url?if_exists}">推荐产品：${title?if_exists}</a></dd>
                                 </@s.iterator>
                            </dl>
              </div><!--info2 end-->
