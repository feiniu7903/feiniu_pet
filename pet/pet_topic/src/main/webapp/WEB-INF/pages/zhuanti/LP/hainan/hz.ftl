...
<title>杭州出发到海南旅游_杭州去海南旅游线路价格,多少钱-驴妈妈旅游网</title>
<meta name="keywords" content="海南旅游，杭州 " />
<meta name="description" content="独立发团杭州出发到海南旅游，杭州去海南旅游线路价格,不用问杭州去海南旅游线路多少钱,驴妈妈给您一个非凡的海南旅游体验。" />
...
<div class="wrap">
	<div class="banner">
    	<div class="nav">
            ...
            <span class="navc"><a href="index.html" target="_self">上海</a><a href="#" target="_self" class="cur">杭州</a><a href="nj.html" target="_self">南京</a><a href="bj.html" target="_self">北京</a></span>
            <span class="navr"></span>
        </div>
    </div>
    <div class="main">
    <@s.iterator value="map.get('${station}_hzdb')" status="st">
    	<div class="topPro">
        	...
        	<div class="mainL">
            	<div class="tabs">
                    ...
                    <div class="tabmain jsList tabList_this">
                    	<@s.iterator value="map.get('${station}_hzlx')" status="st">
                    	...
                    	<ul class="tabList2">
			<@s.iterator value="map.get('${station}_hzgt')" status="st"> 
                        ...
                        <@s.iterator value="map.get('${station}_hzgt_${st.index + 1}')" status="sts">
                        	<dl>
                    ...
                    <div class="tabmain jsList">
                    	...
                    	<ul class="tabList2">
			<@s.iterator value="map.get('${station}_hzzyx')" status="st"> 
                        <@s.if test="#st.isFirst()">
                        <li class="tabList_this">${title?if_exists}</li>
                        </@s.if>
            		<@s.else>
                        ...
                        <@s.iterator value="map.get('${station}_hzzyx')" status="st"> 
                        <div class="tabmain2 jsList tabList_this">
                        <@s.iterator value="map.get('${station}_hzzyx_${st.index + 1}')" status="sts">
                        	<dl>
                            <dt><b><i>&yen;</i><span>${memberPrice?if_exists?replace(".0","")}</span>起</b><a href="${url?if_exists}">${title?if_exists}</a></dt>
                            <dd>${bakWord1?if_exists}</dd>
                            </dl>
                ...
                <@s.iterator value="map.get('${station}_hzdd')" status="st">
				...
				<ul>
                <@s.iterator value="map.get('${station}_hzmp')" status="st">
