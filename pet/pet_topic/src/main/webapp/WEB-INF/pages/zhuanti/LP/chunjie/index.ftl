...
<head>
<meta charset="utf-8" />
<title>春节上海周边旅游景点推荐_春节上海周边旅游线路推荐,价格-驴妈妈旅游网</title>
<meta name="keywords" content="春节，上海,上海周边,旅游" />
<meta name="description" content="驴妈妈推出专题向驴友推出春节上海周边旅游景点推荐，以及春节上海周边游线路推荐价格，这些驴妈妈专题为您收罗和创新出上海周边旅游线路的美丽景色，大家一起来旅游吧！" />
...
<div class="main_all">
	...
	<ul class="nav">
        <li class="nav_li1 nav_li"><a class="nav_1" href="index.html" target="_self">周边</a></li>
        <li><a class="nav_2" href="sh_cx.html" target="_self">长线</a></li>
        <li><a class="nav_3" href="sh_cj.html" target="_self">出境</a></li>
    </ul>
    <div class="yc_box">
    	<h2 class="yc_title">迎春节正在热销•••</h2>
        <ul class="rx_list">
        <@s.iterator value="map.get('${station}_zb_tm')" status="st">
            <li>
...
<!--东南亚模块-->
 	<@s.iterator value="map.get('${station}_zb')" status="st">
        ...
        <@s.iterator value="map.get('${station}_zb_${st.index + 1}')" status="sts">
        	<li>
            	<a href="${bakWord2?if_exists}"><img src="${imgUrl?if_exists}" width="230" height="190" alt=""></a>
                <h4><a href="${url?if_exists}">${title?if_exists}</a></h4>
...
<div class="main_b ">
    ...
    <ul class="hd_list">
    	<@s.iterator value="map.get('${station}_tp_sh')" status="st">
