...
<head>
<meta charset="utf-8" />
<title>成都春节旅游线路_成都出发春节旅游线路推荐,价格-驴妈妈旅游网</title>
<meta name="keywords" content="春节，成都,线路,旅游" />
<meta name="description" content="驴妈妈推出专题向驴友推出成都春节旅游线路，
有些人会问成都春节旅游线路哪个好?以及成都出发春节旅游线路推荐哪里好?为您收罗
了春节的美丽景色，一起来旅游吧！" /><link rel="stylesheet" href="http://pic.lvmama.com/styles/zt/chunjie/index.css">
...
<div class="main_all">
	...
	<ul class="nav">
        ...
        <li class="nav_li"><a class="nav_2" href="cd_cx.html" target="_self">长线</a></li>
        <li><a class="nav_3" href="cd_cj.html" target="_self">出境</a></li>
    </ul>
    <div class="yc_box">
    	<h2 class="yc_title">迎春节正在热销•••</h2>
        <ul class="rx_list">
        <@s.iterator value="map.get('${station}_cxcd_tm')" status="st">
            <li>
    ...
    <div class="diqu_box">
<!--东南亚模块-->
 	<@s.iterator value="map.get('${station}_cxcd')" status="st">
        <h3 class="maodian"><span>${title?if_exists}</span></h3>
        <ul class="cp_list">
        <@s.iterator value="map.get('${station}_cxcd_${st.index + 1}')" status="sts">
        	<li>
