...
<head>
<meta charset="utf-8" />
<title>广州春节旅游线路_广州出发春节旅游线路推荐,价格-驴妈妈旅游网</title>
<meta name="keywords" content="春节，广州,线路,旅游" />
<meta name="description" content="驴妈妈推出专题向驴友推出广州春节旅游线路，
有些人会问上海春节旅游线路哪个好?以及广州出发春节旅游线路推荐哪里好?为您收罗
了春节的美丽景色，一起来旅游吧！" />
...
<div class="main_all">
	...
	<ul class="nav">
        <li class="nav_li1"><a class="nav_1" href="gz_zb.html" target="_self">周边</a></li>
        <li class="nav_li"><a class="nav_2" href="gz_cx.html" target="_self">长线</a></li>
        <li><a class="nav_3" href="gz_cj.html" target="_self">出境</a></li>
    </ul>
    <div class="yc_box">
    	<h2 class="yc_title">迎春节正在热销•••</h2>
        <ul class="rx_list">
        <@s.iterator value="map.get('${station}_cxgz_tm')" status="st">
            <li>
    ...
    <div class="diqu_box">
<!--东南亚模块-->
 	<@s.iterator value="map.get('${station}_cxgz')" status="st">
        <h3 class="maodian"><span>${title?if_exists}</span></h3>
        <ul class="cp_list">
        <@s.iterator value="map.get('${station}_cxgz_${st.index + 1}')" status="sts">
        	<li>
