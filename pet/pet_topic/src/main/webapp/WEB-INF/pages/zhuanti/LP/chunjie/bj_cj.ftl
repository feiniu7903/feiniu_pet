...
<head>
<meta charset="utf-8" />
<title>北京春节出境游线路_北京出发春节出境游线路价格，哪里好-驴妈妈旅游网</title>
<meta name="keywords" content="出境，旅游,北京" />
<meta name="description" content="驴妈妈推出专题向驴友推出北京春节出境游线
路，有些人会问北京出发春节出境游线路价格?以及北京出境游哪里好?驴妈妈为您收罗
了北京出境游美丽景色，一起来旅游吧！" />
...
<div class="main_all">
	...
	<ul class="nav">
        ...
        <li class="nav_li"><a class="nav_3" href="bj_cj.html" target="_self">出境</a></li>
    </ul>
    <div class="yc_box">
    	<h2 class="yc_title">迎春节正在热销•••</h2>
        <ul class="rx_list">
        <@s.iterator value="map.get('${station}_cjbj_tm')" status="st">
            <li>
    ...
    <div class="diqu_box">
<!--东南亚模块-->
 	<@s.iterator value="map.get('${station}_cjbj')" status="st">
        <h3 class="maodian"><span>${title?if_exists}</span></h3>
        <ul class="cp_list">
        <@s.iterator value="map.get('${station}_cjbj_${st.index + 1}')" status="sts">
        	<li>
