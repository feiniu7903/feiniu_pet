...
<head>
    <meta charset="utf-8" />
    <title>上海到美国游玩推荐_上海到美国怎么玩,去哪玩-驴妈妈旅游网</title>
    <meta name="keywords" content="上海到美国,美国旅游" />
    <meta name="description" content="驴妈妈美国旅游专题:选择聪明的旅行!我们为您提供上海到美国去哪玩好,怎么玩,上海到美国游玩推荐及实时比价服务，是您预订旅游产品跟团游及自由行的最佳选择!" />
...
<body>
    ...
    <div class="sh_main_all">
        ...
        <ul class="main_nav">
            ...
            <li class="nav_list2 nav_list2_a">
        ...
        <div class="sh_chanpin">
            <ul class="sh_chanpin_l sh_chanpin_qn">
                <@s.iterator value="map.get('${station}_sh_wsm')" status="st">
                    <li>
                        <dl class="sh_chanpin_list sh_qn_list">
                            <dt>
                                <img src="${imgUrl?if_exists}" width="433" height="191" alt=""></dt>
                            <@s.iterator value="map.get('${station}_sh_wsm_${st.index+1}')" status="st2">
    ...
    <div class="main_cfd">
        <dl>
            ...
            <dd class="main_cfd_dd">
                <a target="_self" href="index.html">上海</a>
            </dd>
            <dd>
