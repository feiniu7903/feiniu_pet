...
<head>
<meta charset="utf-8" />
<title>北京暑期主题旅游_北京娱乐/科普/自然景点好去处-驴妈妈旅游网 </title> 
<meta name="keywords" content="北京暑期,北京主题旅游"> 
<meta name="description" content="炎热的暑期别赖在空调下啦!跟着驴妈妈玩乐大课堂,踏足北京娱乐,科普,自然的旅游景点,寻找童年大乐趣!还有幸运大奖等您来抽取,同时我们将和您一起进行一公斤公益旅行!让世界因旅行而更美好!"> 
...
<div class="wrap classStyle1">
    ...
    <div class="cpBox" style="display:block">
    	<div class="cpBoxBg">
        	<@s.iterator value="map.get('${station}_bj_ylk_recommend')" status="st">
        	<div class="itemBox">
            	<div class="leftBox">
            ...
            <ul class="cpList">
				<@s.iterator value="map.get('${station}_bj_ylk')" status="st">
            	<li>
                    ...
                    <div class="priceBox">
                        ...
                        <a href="${url?if_exists}" target="_blank" class="orderBtn2"></a>
                    </div>
                </li>
                </@s.iterator>                
            </ul>
    ...
    <div class="cpBox">
    	<div class="cpBoxBg">
        	 <@s.iterator value="map.get('${station}_bj_kpk_recommend')" status="st">
        	<div class="itemBox">
            	<div class="leftBox">
                	<h3><a href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a></h3>
                    <#if remark?exists && remark!=""> <p><span>推荐理由</span>${remark?if_exists}</p></#if>
            ...
            <ul class="cpList">
            	<@s.iterator value="map.get('${station}_bj_kpk')" status="st">
            	<li>
                	 <#if bakWord4?exists && bakWord4=="买小送大"> <span class="tips1"></span></#if>
                	 <#if bakWord4?exists && bakWord4=="买大送小"> <span class="tips2"></span></#if>
                	 <#if bakWord4?exists && bakWord4=="大小同价"> <span class="tips3"></span></#if>
	...
	<div class="cpBox">
    	<div class="cpBoxBg">
        	<@s.iterator value="map.get('${station}_bj_zrk_recommend')" status="st">
        	<div class="itemBox">
            	<div class="leftBox">
                	<h3><a href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a></h3>
                    <#if remark?exists && remark!=""> <p><span>推荐理由</span>${remark?if_exists}</p></#if>
            ...
            <ul class="cpList">
	        	 <@s.iterator value="map.get('${station}_bj_zrk')" status="st">
	        	<li>
	            	 <#if bakWord4?exists && bakWord4=="买小送大"> <span class="tips1"></span></#if>
                	 <#if bakWord4?exists && bakWord4=="买大送小"> <span class="tips2"></span></#if>
                	 <#if bakWord4?exists && bakWord4=="大小同价"> <span class="tips3"></span></#if>
  	...
  	<div class="sp_pop" style="background:none;height:320px;width:65px;top:50%;margin-top:-160px;">
        <ul class="fdcList"> 
            ...
            <li class="nav_li"><a href="http://www.lvmama.com/zt/lvyou/shuqi1/beijing.html" target="_self">北京</a></li>
