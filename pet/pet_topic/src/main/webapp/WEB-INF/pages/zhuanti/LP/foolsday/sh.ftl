...
<div class="wrap">	
    ...
    <div class="main" id="main">
    	<div class="ticket" id="ticket">
        	<h3>
        	<@s.iterator value="map.get('${station}_sh_ticket_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
             <@s.iterator value="map.get('${station}_sh_ticket')"  var="var" status="st">
            	<li>
                	<div class="intro">
        ...
        <div class="ticket freetour" id="freetour">
            <h3>
        	<@s.iterator value="map.get('${station}_sh_freetour_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
              <@s.iterator value="map.get('${station}_sh_freetour')"  var="var" status="st">
            	<li>
                	<div class="intro">
                    	<img src="${imgUrl?if_exists}" width="210" height="140" alt="">
                        <h4><a href="${url?if_exists}">${title?if_exists}</a></h4>
        ...
        <div class="ticket group" id="group">
        	 <h3>
        	<@s.iterator value="map.get('${station}_sh_group_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
            	 <@s.iterator value="map.get('${station}_sh_group')"  var="var" status="st">
            	<li>
                	<div class="intro">
                    	<img src="${imgUrl?if_exists}" width="210" height="140" alt="">
                        <h4><a href="${url?if_exists}">${title?if_exists}</a></h4>
        ...
        <div class="ticket freetour abroad" id="abroad">
        	 <h3>
        	<@s.iterator value="map.get('${station}_sh_abroad_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
            	 <@s.iterator value="map.get('${station}_sh_abroad')"  var="var" status="st">
            	<li>
                	<div class="intro">
                    	<img src="${imgUrl?if_exists}" width="210" height="140" alt="">
                        <h4><a href="${url?if_exists}">${title?if_exists}</a></h4>
        ...
        <div class="ticket tuangou" id="tuangou">
        	 <h3>
        	<@s.iterator value="map.get('${station}_sh_tuangou_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
            	 <@s.iterator value="map.get('${station}_sh_tuangou')"  var="var" status="st">
            	<li>
                	<div class="intro">
                    	<img src="${imgUrl?if_exists}" width="210" height="140" alt="">
                        <h4><a href="${url?if_exists}">${title?if_exists}</a></h4>
