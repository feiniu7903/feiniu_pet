...
<head>
<meta charset="utf-8" />
<title>春节成都周边旅游景点推荐_春节成都周边旅游线路推荐,价格-驴妈妈旅游网</title>
<meta name="keywords" content="春节，成都,成都周边,旅游" />
<meta name="description" content="驴妈妈推出专题向驴友推出春节成都周边旅游景
点推荐，以及春节成都周边游线路推荐价格，这些驴妈妈为您收罗和创新出成都周边旅
游线路的美丽景色，大家一起来旅游吧！" />
...
<div class="main_all">
	...
	<ul class="nav">
        <li class="nav_li1 nav_li"><a class="nav_1" href="cd_zb.html" target="_self">周边</a></li>
    ...
    <div class="yc_box">
        ...
        <ul class="rx_list">
        <@s.iterator value="map.get('${station}_zbcd_tm')" status="st">
            <li>
    ...
    <div class="diqu_box">
<!--东南亚模块-->
 	<@s.iterator value="map.get('${station}_zbcd')" status="st">
        <h3 class="maodian"><span>${title?if_exists}</span></h3>
        <ul class="cp_list">
        <@s.iterator value="map.get('${station}_zbcd_${st.index + 1}')" status="sts">
        	<li>
