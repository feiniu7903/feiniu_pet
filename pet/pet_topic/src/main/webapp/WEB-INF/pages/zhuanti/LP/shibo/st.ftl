...
<head>
<meta charset="utf-8" />
<title>世博沙特馆_沙特馆开放时间_沙特馆有什么好玩-驴妈妈旅游网</title>
...
<base target="_blank">
<style>
body{ background:url(http://www.lvmama.com/zt/promo/shibohui/images/st_bg.jpg) no-repeat center 51px #a06200;}
</style>
</head>
...
<div class="main_all">
    ...
    <div class="st_xiuchang">
    	<img src="http://www.lvmama.com/zt/promo/shibohui/images/st_xiu1.jpg" width="1002" height="704" alt="">
    </div>
    <div class="jp_box">
    	<h3 class="st_jp_title">意大利馆精推产品</h3>
       	<ul class="jp_list">
        	<@s.iterator value="map.get('${station}_stcp')" status="st">
        	<li>
            	<img class="jp_list_l" src="${imgUrl?if_exists}" width="234" height="126" alt="">
                <div class="jp_list_r">
    ...
    <div class="jp_box">
    	<h3 class="st_qy_title">意大利馆精推产品</h3>
       	<div class="qy_box">
        	<div class="qy_l">
            	 <@s.iterator value="map.get('${station}_sttt')" status="st">
            	<div class="qy_first">
                    ...
                    <ul class="qy_list">
                        <@s.iterator value="map.get('${station}_stjt')" status="st">
                        <li>
                        ...
                        <@s.iterator value="map.get('${station}_stqt')" status="st">
                        <li class="more"> <a href="${url?if_exists}" target="_blank">更多&gt;&gt;</a></li>
                     </@s.iterator>
                    </ul>
            </div>
            <@s.iterator value="map.get('${station}_stgl')" status="st">
            <div class="qy_r">
...
<div class="xs_box">
    	<h3 class="st_xs_title">意大利馆精推产品</h3>
        <div class="st_xs">
        	<ul class="china_xs_list">
                    <@s.iterator value="map.get('${station}_sttp')" status="st">
