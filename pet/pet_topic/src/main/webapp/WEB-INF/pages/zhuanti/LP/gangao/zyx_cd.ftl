...
<head>
<meta charset="utf-8" />
<title>成都到港澳自由行_成都到港澳自由行线路推荐-驴妈妈旅游网</title>
<meta name="keywords" content="成都到港澳旅游,港澳旅游路线"/>
<meta name="description" content="驴妈妈旅游网提供港澳旅游线路,成都到港澳自由行,带你游遍港澳主要特色景点,我们的旅游产品,成都到港澳自由行线路报价优惠,省心,安心."/>
...
<div class="main_all">
    <dl class="main_cfd">
        ...
        <dd class="main_cfd_dd"><a target="_self" href="zyx_cd.html">成都/重庆</a></dd>
        <dd><a target="_self" href="zyx_bj.html">北京</a></dd>
...
<!--页面左侧-->
    <div class="main_left">
		<div class="ga-free-pro">
			<@s.iterator value="map.get('${station}_zyx_cd')" status="st">
				<h3>${title?if_exists}</h3>
				<ul class="ga-free-list">
					<@s.iterator value="map.get('${station}_zyx_cd_${st.index + 1}')" status="sts">
						<li>
