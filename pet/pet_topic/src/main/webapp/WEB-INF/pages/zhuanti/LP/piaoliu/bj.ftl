...
<div class="top_bg">
    ...
    <div class="mod_ban ban2">
    	<ul class="navList">
        	<li><a href="">上海</a></li>
            <li class="nav_li"><a href="">北京</a></li>
            <li><a href="">广州</a></li>
            <li><a href="">重庆</a></li>
        </ul>
    </div>
...
<div class="wrap_bg">
	<@s.iterator value="map.get('${station}_zero_money_bj')" status="st">
    ...
    <div class="mod_Box ms1_mod">
        ...
        <div class="itemBox">
        	<ul class="ms1_list">
               ...
               <!--秒杀推荐-->
                <@s.iterator value="map.get('${station}_seckill_bj')" status="st">
                <li>
    ...
    <div class="mod_Box m1s1_mod">
        ...
        <div class="itemBox">
        	<ul class="ms1_list">
               <@s.iterator value="map.get('${station}_buy_one_show_bj')" status="st">
	            <li>
