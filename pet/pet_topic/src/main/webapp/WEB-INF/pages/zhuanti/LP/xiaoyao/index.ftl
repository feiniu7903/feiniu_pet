...
<head>
<meta charset="utf-8" />
<title>【逍遥驴行】自助旅游线路,价格_自由行旅游怎么样-驴妈妈自发班</title>
<meta name="keywords" content="逍遥驴行" />
...
<div class="wrap">
	<div class="main">
    <!--我们的理念--><a name="a01"></a><img src="http://www.lvmama.com/zt/promo/kxlx/images/item3.gif" width="1002" height="117" alt="开心驴行" />
    <div class="siftbox">
    <!--当季超值--><a name="a02"></a>
    <img src="http://www.lvmama.com/zt/promo/kxlx/images/proboxtit01_1.gif" class="siftboxtit1" />	
    <div class="proboxwrap">
   	  <@s.iterator value="map.get('${station}_rmcx')" status="st">
   	  <div class="probox">
            	<a href="${url?if_exists}" target="_blank"><img src="${imgUrl?if_exists}" class="pro1"/></a>
            	<div class="protxt">
            		<a href="${url?if_exists}" target="_blank">${title?if_exists}</a>
                	<span class="prospan">${bakWord1?if_exists}</span>
                	<p class="prop"><em>&yen;</em><span>${memberPrice?if_exists?replace(".0","")}</span>起<a href="${url?if_exists}" target="_blank"><img src="http://www.lvmama.com/zt/promo/kxlx/images/btn2.gif" /></a></p>
    ...
    <img src="http://www.lvmama.com/zt/promo/kxlx/images/kxlx_12_1.gif" class="siftboxtit" />
    ...
    <div class="proboxwrap">
      <@s.iterator value="map.get('${station}_cpcx_${st.index + 1}')" status="sts">
   	  <div class="probox1">
       	<a href="${url?if_exists}" target="_blank"><img src="${imgUrl?if_exists}" width="231" height="193" /></a>
    ...
    <!--QA--><a name="a06"></a>
    <div class="qa">       
    <img src="http://www.lvmama.com/zt/promo/kxlx/images/kxlx_14_1.gif" width="970" height="24" class="siftboxtit4">
...
<!--微博分享-->
	<div class="weiboBox">
    	<div class="weiboL">
        	<iframe width="700" height="320"  frameborder="0" scrolling="no" src="http://widget.weibo.com/livestream/listlive.php?language=zh_cn&width=700&height=320&uid=3273046782&skin=1&refer=1&appkey=&pic=0&titlebar=1&border=1&publish=1&atalk=1&recomm=0&at=0&atopic=%E9%80%8D%E9%81%A5%E9%A9%B4%E8%A1%8C&ptopic=%E9%80%8D%E9%81%A5%E9%A9%B4%E8%A1%8C&dpc=1"></iframe>
        </div>
...
<!--pop-->
<div class="sp_pop" ><img src="http://www.lvmama.com/zt/promo/kxlx/images/frimg_1.png" width="136" height="322" border="0" usemap="#Map2">
  <map name="Map2">
    <area shape="rect" coords="3,71,155,107" href="#a01">
    <area shape="rect" coords="-1,113,152,144" href="#a02">
    <area shape="rect" coords="-6,149,141,183" href="#a03">
    <area shape="rect" coords="-6,189,140,221" href="#a06">
    <area shape="rect" coords="3,226,155,261" href="#a07">
    <area shape="rect" coords="3,265,155,298" href="#a08">
  </map>
</div>
<!--pop-->
<!--营销点代码:驴妈妈旅游网_到达--> 
<script type="text/javascript" src="http://aw.kejet.net/t?p=gq&c=im"></script>
<script src="http://s14.cnzz.com/stat.php?id=5369893&web_id=5369893&show=pic1" language="JavaScript">
