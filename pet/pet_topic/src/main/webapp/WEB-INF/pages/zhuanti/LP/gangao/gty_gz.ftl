...
<head>
<meta charset="utf-8" />
<title>广州到港澳旅游_广州到港澳旅游报价,多少钱-驴妈妈旅游网</title>
<meta name="keywords" content="广州到港澳旅游,港澳旅游报价"/>
<meta name="description" content="驴妈妈旅游网提供港澳旅游线路,广州到港澳旅游,带你游遍港澳主要特色景点,我们的旅游产品,广州到港澳旅游报价优惠,省心,安心."/>
...
<div class="main_all">
    <dl class="main_cfd">
        ...
        <dd><a target="_self" href="gty_sh.html">上海/南京/杭州</a></dd>
        <dd><a target="_self" href="gty_cd.html">成都/重庆</a></dd>
        <dd><a target="_self" href="gty_bj.html">北京</a></dd>
        <dd class="main_cfd_dd"><a target="_self" href="gty_gz.html">广州/深圳/香港</a></dd>
    </dl>
    
<!--页面左侧-->
    <div class="main_left">
		<div class="ga-free-pro">
			<@s.iterator value="map.get('${station}_gt_gz')" status="st">
				<h3>${title?if_exists}</h3>
				<ul class="ga-tuan-list">
					<@s.iterator value="map.get('${station}_gt_gz_${st.index + 1}')" status="sts">
						<li>
