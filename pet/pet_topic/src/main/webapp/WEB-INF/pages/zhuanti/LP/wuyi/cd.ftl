...
<title>成都五一旅游_成都五一出境游线路推荐_2013成都五一去哪里玩-驴妈妈旅游网</title>
<meta name="keywords" content="五一成都旅游,五一成都出境游" />
<meta name="description" content="2013成都五一旅游，偷闲去旅行！驴妈妈提供成都五一出境游线路推荐，告诉您成都五一去哪里玩，为您精心打造行程安排。《自助游天下,就找驴妈妈》" />
...
<!--专题公共头部END-->
<div class="top_bg1">
	<div class="top_bg2"><h1>成都五一旅游</h1></div>
...
<!--出发地导航-->
	<div class="main_cfd">
        ...
        <a class="cfd_dq" href="http://www.lvmama.com/zt/lvyou/wuyi/cd.html">成都出发</a>
    </div>
	<div class="main_xc">
<!--左侧图片-->
		<div class="main_left">
...
<!--右边-->
		<div class="main_right">
        	<div class="main_right_top">
        		<ul>
					<@s.iterator value="map.get('${station}_cd_title')" status="st">
            ...
            <ul class="right_ul">
				<@s.iterator value="map.get('${station}_cd_title')" status="st">
					<li>
						<@s.if test="null != map.get('${station}_cd_${bakWord1}_tb') && !map.get('${station}_cd_${bakWord1}_tb').isEmpty()">
							<dl class="right_dl">
								<dt><h3>特别行程安排</h3></dt>
								<@s.iterator value="map.get('${station}_cd_${bakWord1}_tb')" status="st">
									<dd>
						...
						<@s.if test="null != map.get('${station}_cd_${bakWord1}_qt') && !map.get('${station}_cd_${bakWord1}_qt').isEmpty()">
							<dl class="right_dl2">
								<dt><h3>其他行程安排</h3></dt>
								<@s.iterator value="map.get('${station}_cd_${bakWord1}_qt')" status="st">
									<dd class="noborder">
										<span class="dd_spanl">${bakWord1?if_exists}</span>
										<div class="dd_cp">
										<h6><a target="_blank" href="${url?if_exists}">${title?if_exists}</a> <#if bakWord3?exists && bakWord3!=""><span class="${bakWord3}"></span></#if></h6>
