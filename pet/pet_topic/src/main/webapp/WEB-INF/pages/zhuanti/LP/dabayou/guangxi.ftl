...
<head>
    <meta charset="utf-8">
    <title>广西大巴旅游_广西大巴跟团游-广西大巴自由行-驴妈妈旅游网</title>
    <meta name="keywords" content="大巴旅游,广西旅游,自由行" />
    <meta name="description" content="驴妈妈旅游网重磅推出广西大巴旅游产品,让您轻松省事,免去旅途的交通麻烦.广西大巴跟团游,广西大巴自由行,是您预订旅行产品,跟团游及自由行的最佳选择!" />
...
<body>
    ...
    <div class="banner">
        ...
        <ul>
            ...
            <li class="hain">
                <a href="hainan.html" target="_self"> <strong>海南游</strong>
                    <br>
                    <span>天涯海角、山盟海誓</span>
                </a>
            </li>
            <li class="fj">
                <a href="fujian.html" target="_self">
                    <strong>福建游</strong>
                    <br>
                    <span>海岛风情、浪漫之旅</span>
                </a>
            ...
            <li class="hun">
                <a href="hunan.html" target="_self">
                    <strong>神州游</strong>
                    <br>
                    <span>井冈红叶、湘西明珠</span>
                </a>
    ...
    <div class="content gxct">
        <div class="gx_cttopbg"></div>
        <div class="mainCon">
            <div class="main">
                <@s.iterator value="map.get('${station}_bus_guangxi')" status="st">
                    <dl class="prolist">
                        <dt>
