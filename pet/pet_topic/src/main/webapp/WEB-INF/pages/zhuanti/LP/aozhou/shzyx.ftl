...
<head>
<meta charset="utf-8" />
<title>上海到澳大利亚新西兰自由行线路_上海到澳大利亚自由行多少钱,费用-驴妈妈旅游网</title>
<meta name="keywords" content="澳大利亚，新西兰，上海，自由行" />
<meta name="description" content="驴妈妈旅游网推出精心策划上海到澳大利亚新西兰跟自由行路和上海到澳大利亚新西兰自由行多少钱,费用,澳新旅游新玩法。" />
...
<div class="main_all">
    ...
    <div class="miaosha">
	<@s.iterator value="map.get('${station}_ms_sh')" status="st">
    	<dl class="ms_dl">
...
<!--跟团游-->
    <div class="nav_list" style="display:block;">
    	<dl class="nav_cfd">
        	<dt>出发地选择</dt>
            <dd class="nav_cfd_dd"><a target="_self" href="http://www.lvmama.com/zt/lvyou/aozhou/">上海/南京/杭州</a></dd>
...
<!--自由行-->
    <div class="nav_list">
    	<dl class="nav_cfd">
        	<dt>出发地选择</dt>
            <dd class="nav_cfd_dd"><a target="_self" href="http://www.lvmama.com/zt/lvyou/aozhou/shzyx/">上海/南京/杭州</a></dd>
        ...
        <div class="cfd_list">
			<@s.iterator value="map.get('${station}_zy_sh')" status="st">
        	<dl class="cp_title">
            		<dt>${title?if_exists}</dt>
                	<dd>${bakWord1?if_exists}</dd>
            </dl>
           	 <ul class="cp_list cp_list_js3">
            	<@s.iterator value="map.get('${station}_zy_sh_${st.index + 1}')" status="sts">
				<li>
					<h5><a href="${url?if_exists}"><span class="gray">【${bakWord2?if_exists}】</span>${title?if_exists}</a></h5>
                    <span class="jiage">¥<b>${memberPrice?if_exists?replace(".0","")}</b><i>起</i></span>
                    <div class="hide_box" style="display:block;">
