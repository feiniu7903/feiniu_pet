...
<head>
<meta charset="utf-8" />
<title>2014北京五一旅游_北京及周边五一线路,价格,推荐-驴妈妈旅游网</title> 
<meta name="keywords" content="北京五一,北京五一旅游,北京周边,线路"> 
<meta name="description" content="2014五一劳动节：驴妈妈旅游网推荐北京五一旅游线路,北京五一劳动节旅游去哪里玩，五一劳动节北京周边旅游线路;以优质的服务提供您一个愉快五一旅游度假！"> 
...
<div class="wrap">
	<div class="main">
        ...
        <div class="nav" id="nav">
            ...
            <a class="nav3 navLi" href="http://www.lvmama.com/zt/lvyou/wuyi_1/bj.html" target="_self"><span></span></a>
        ...
        <div class="areaList">
        	<div class="section" id="md1">
                ...
                <div class="pro">
            		<ul class="proList">
            			<@s.iterator value="map.get('${station}_bj_place')" status="st">
                        <li>
            ...
            <div class="section" id="md2">
                ...
                <div class="pro2">
            		...
            		<ul class="proList" style="display:block;">
	                    <@s.iterator value="map.get('${station}_bj_ambitus_free')" status="st">
	                        <li>
	                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
	                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
	                            <div class="pricebox">
                    ...
                    <ul class="proList">
                        <@s.iterator value="map.get('${station}_bj_ambitus_group')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
            ...
            <div class="section" id="md3">
                ...
                <div class="pro2">
            		...
            		<ul class="proList" style="display:block;">
                      <@s.iterator value="map.get('${station}_bj_home_free')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
                    ...
                    <ul class="proList">
                       <@s.iterator value="map.get('${station}_bj_home_group')" status="st">
                        <li>
                            <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
                            <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
                            <div class="pricebox">
            ...
            <div class="section" id="md4">
                ...
                <div class="pro2">
                	<ul class="pro-nav">
	        		  ...
	        		  <!--东南亚-->
	        		<ul class="proList" style="display:block;">
	        			<@s.iterator value="map.get('${station}_bj_southeast_asia')" status="st">
	                    <li>
	                        <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
	                        <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
	                        <div class="pricebox">
	                ...
	                <!--海岛 sh_island -->
	                <ul class="proList">
	               	 <@s.iterator value="map.get('${station}_bj_island')" status="st">
	                    <li>
	                        <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
	                        <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
	                        <div class="pricebox">
	                ...
	                <!--港澳日韩-->
	                <ul class="proList">
	                <@s.iterator value="map.get('${station}_bj_garh')" status="st">
	                    <li>
	                        <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
	                        <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
	                        <div class="pricebox">
	                ...
	                <!--欧美澳非-->
	                <ul class="proList">
	                <@s.iterator value="map.get('${station}_bj_omaf')" status="st">
	                    <li>
	                        <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
	                        <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
	                        <div class="pricebox">
	                ...
	                <!--油轮-->
	                <ul class="proList">
	               	 <@s.iterator value="map.get('${station}_bj_youlun')" status="st">
	                    <li>
	                        <img src="${imgUrl?if_exists}" width="224" height="150" alt="${title?if_exists}">
	                        <a class="chanpin" href="${url?if_exists}" target="_blank" title="${title?if_exists}">${title?if_exists}</a>
	                        <div class="pricebox">
