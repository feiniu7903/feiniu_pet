...
<div id="fix_nav" class="png_bg">
	<div class="menu">
		<a href="#ertong" title="2大1小儿童半价">2大1小<br />儿童<em class="red">半价</em></a><a href="#xueyuan" title="边玩边学感受学院风">边玩边学<br /><em class="red">感受</em>学院风</a>
	</div>
...
<div class="wrap">
	...
	<div class="cont_wrap">
		...
		<div class="tabs">
			<ul>
				<li class="children cur">
					<p id="ertong" class="children_cont">2大1小 儿童<em>半价</em><br />
					2位成人+1名12周岁以下不占床儿童，儿童半价<br />（限6.15~8.25期间出发团队）</p>
				</li>
				<li class="edu">
		...
		<div id="summer_product">
			<!-- S 儿童 -->
			<div class="pro_cont children">
				<!-- S 产品区 -->
				<div class="clearfix p_rel model island">
					<div class="img_adorn">
						<h3>海岛度假系列<sup>Island</sup></h3>
					</div>
					<div class="png_bg cont_data">
						<div class="cont_data_wrap">
							<@s.iterator value="map.get('${station}_sh_etbj_hd')" status="st">
						    <@s.if test="#st.index == 0">
							<div class="cont_pro">
								<em class="gold_rec">金牌推荐</em>
								...
								<@s.if test="remark!=null"><p class="info">精彩看点：${remark?if_exists}</p></@s.if>
								<div class="sort_area rec_cont">
									<ul class="clearfix sort_data">
										<li class="cur">美食</li>
										<li>美景</li>
										<li>亲子</li>
									</ul>
									<div class="details_cont">
										<p class="details_cont_list">${bakWord1?if_exists}</p>
										<p class="dn details_cont_list">${bakWord2?if_exists}</p>
										<p class="dn details_cont_list">${bakWord3?if_exists}</p>
									</div>
								</div>
							</div>
							<ul class="cont_list">
							...
							<@s.if test="map.get('${station}_sh_etbj_hd')!=null && map.get('${station}_sh_etbj_hd').size>0">
								</ul>
								<@s.if test="map.get('${station}_sh_etbj_hd').size>3">
								<p class="t_r toggle">
									<span class="f14 fb red">部分特殊线路，儿童计价方式请详询</span>
									<span class="open">展开</span></p>		
								</@s.if>					
							</@s.if>
						</div>
					</div>
				...
				<!-- S 产品区 -->
				<div class="clearfix p_rel model culture">
					<div class="img_adorn">
						<h3>文化探密系列<sup>Culture</sup></h3>
					</div>
					<span class="dot"></span>
					<div class="png_bg cont_data">
						<div class="cont_data_wrap">
							<@s.iterator value="map.get('${station}_sh_etbj_wh')" status="st">
						    <@s.if test="#st.index == 0">
							<div class="cont_pro">
								<em class="gold_rec">金牌推荐</em>
								<h4><a target="_blank"  href="${url?if_exists}">${title?if_exists}</a></h4>
							...
							<@s.if test="map.get('${station}_sh_etbj_wh')!=null && map.get('${station}_sh_etbj_wh').size>0">
								</ul>
								<@s.if test="map.get('${station}_sh_etbj_wh').size>3">
								<p class="t_r toggle"><span class="open">展开</span></p>		
								</@s.if>					
							</@s.if>
						</div>
					</div>
				...
				<!-- S 产品区 -->
				<div class="clearfix p_rel model natural">
					<div class="img_adorn">
						<h3>自然风光系列<sup>Natural</sup></h3>
					</div>
					<span class="dot"></span>
					<div class="png_bg cont_data">
						<div class="cont_data_wrap">
							<@s.iterator value="map.get('${station}_sh_etbj_zr')" status="st">
						    <@s.if test="#st.index == 0">
							<div class="cont_pro">
								<em class="gold_rec">金牌推荐</em>
								<h4><a target="_blank"  href="${url?if_exists}">${title?if_exists}</a></h4>
							...
							<@s.if test="map.get('${station}_sh_etbj_zr')!=null && map.get('${station}_sh_etbj_zr').size>0">
								</ul>
								<@s.if test="map.get('${station}_sh_etbj_zr').size>3">
								<p class="t_r toggle"><span class="open">展开</span></p>		
								</@s.if>					
							</@s.if>
						</div>
				...
				<!-- S 产品区 -->
				<div class="clearfix p_rel model city">
					<div class="img_adorn">
						<h3>城市休闲系列<sup>City</sup></h3>
					</div>
					<span class="dot"></span>
					<div class="png_bg cont_data">
						<div class="cont_data_wrap">
							<@s.iterator value="map.get('${station}_sh_etbj_cs')" status="st">
						    <@s.if test="#st.index == 0">
							<div class="cont_pro">
								<em class="gold_rec">金牌推荐</em>
								<h4><a target="_blank"  href="${url?if_exists}">${title?if_exists}</a></h4>
							...
							<@s.if test="map.get('${station}_sh_etbj_cs')!=null && map.get('${station}_sh_etbj_cs').size>0">
								</ul>
								<@s.if test="map.get('${station}_sh_etbj_cs').size>3">
								<p class="t_r toggle"><span class="open">展开</span></p>		
								</@s.if>					
							</@s.if>
						</div>
			...
			<div class="pro_cont college dn">
				...
				<div class="col_pro_cont pr360 edutainment">
					...
					<div class="children_list">
						<ul>
							<@s.iterator value="map.get('${station}_sh_xyf_10yx')" status="st">
						...
						<@s.if test="map.get('${station}_sh_xyf_10yx')!=null && map.get('${station}_sh_xyf_10yx').size>3">
				...
				<div class="col_pro_cont pl360 wonderful">
					...
					<div class="children_list">
						<ul>
							<@s.iterator value="map.get('${station}_sh_xyf_10z15')" status="st">
							<li <@s.if test="#st.index == 0">class="cur"</@s.if>>
								<h4><a target="_blank"  href="${url?if_exists}">${title?if_exists}</a></h4>
								<div class="p_abs price">
									&yen;<em>${memberPrice?if_exists?replace(".0","")}</em>起<a target="_blank"  href="${url?if_exists}" class="btn_yd" title="立即预订">立即预订</a>
						...
						<@s.if test="map.get('${station}_sh_xyf_10z15')!=null && map.get('${station}_sh_xyf_10z15').size>3">
						<p class="t_r mt10 toggle"><span class="open">展开</span></p>
						</@s.if>
					</div>
				</div><!-- E 产品区 -->
				...
				<div class="col_pro_cont pr360 exotic">
					...
					<div class="children_list">
						<ul>
							<@s.iterator value="map.get('${station}_sh_xyf_15ys')" status="st">
							<li <@s.if test="#st.index == 0">class="cur"</@s.if>>
								<h4><a target="_blank"  href="${url?if_exists}">${title?if_exists}</a></h4>
								<div class="p_abs price">
									&yen;<em>${memberPrice?if_exists?replace(".0","")}</em>起<a target="_blank"  href="${url?if_exists}" class="btn_yd" title="立即预订">立即预订</a>
						...
						<@s.if test="map.get('${station}_sh_xyf_15ys')!=null && map.get('${station}_sh_xyf_15ys').size>3">
						<p class="t_r mt10 toggle"><span class="open">展开</span></p>
						</@s.if>
					</div>
				</div><!-- E 产品区 -->
