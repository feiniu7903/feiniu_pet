...
<div class="wrap">	
    ...
    <div class="main" id="main">
    	<div class="ticket" id="ticket">
        	<h3>
        	<@s.iterator value="map.get('${station}_cd_ticket_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
             <@s.iterator value="map.get('${station}_cd_ticket')"  var="var" status="st">
            	<li>
                	<div class="intro">
        ...
        <div class="ticket freetour" id="freetour">
            <h3>
        	<@s.iterator value="map.get('${station}_cd_freetour_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
              <@s.iterator value="map.get('${station}_cd_freetour')"  var="var" status="st">
            	<li>
                	<div class="intro">
                    	<img src="${imgUrl?if_exists}" width="210" height="140" alt="">
                        <h4><a href="${url?if_exists}">${title?if_exists}</a></h4>
        ...
        <div class="ticket group" id="group">
        	 <h3>
        	<@s.iterator value="map.get('${station}_cd_group_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
            	 <@s.iterator value="map.get('${station}_cd_group')"  var="var" status="st">
            	<li>
                	<div class="intro">
                    	<img src="${imgUrl?if_exists}" width="210" height="140" alt="">
                        <h4><a href="${url?if_exists}">${title?if_exists}</a></h4>
        ...
        <div class="ticket freetour abroad" id="abroad">
        	 <h3>
        	<@s.iterator value="map.get('${station}_cd_abroad_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
            	 <@s.iterator value="map.get('${station}_cd_abroad')"  var="var" status="st">
            	<li>
                	<div class="intro">
                    	<img src="${imgUrl?if_exists}" width="210" height="140" alt="">
                        <h4><a href="${url?if_exists}">${title?if_exists}</a></h4>
        ...
        <div class="ticket tuangou" id="tuangou">
        	 <h3>
        	<@s.iterator value="map.get('${station}_cd_tuangou_more')"  var="var" status="st">
        	  <@s.if test="#st.first"><a href="${url?if_exists}">>>更多推荐</a></@s.if>
        	</@s.iterator> 
        	</h3>
            <ul class="proList">
            	 <@s.iterator value="map.get('${station}_cd_tuangou')"  var="var" status="st">
            	<li>
                	<div class="intro">
                    	<img src="${imgUrl?if_exists}" width="210" height="140" alt="">
                        <h4><a href="${url?if_exists}">${title?if_exists}</a></h4>
...
<div class="nav">
    ...
    <ul class="navList">
        ...
        <li class="navLi"><a href="http://www.lvmama.com/zt/lvyou/foolsday/cd.html#main" target="_self">成都</a></li>
   </ul>
</div>
