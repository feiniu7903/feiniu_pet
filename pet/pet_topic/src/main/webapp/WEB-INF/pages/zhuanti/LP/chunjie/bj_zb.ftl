...
<head>
<meta charset="utf-8" />
<title>春节北京周边旅游景点推荐_春节北京周边游线路推荐，价格-驴妈妈旅游网</title>
<meta name="keywords" content="春节，北京,北京周边,旅游" />
<meta name="description" content="驴妈妈推出专题向驴友推出春节北京周边旅游景
点推荐，以及春节北京周边游线路推荐价格，这些驴妈妈专题为您收罗和创新出北京周
边旅游线路的美丽景色，大家一起来旅游吧！" />
...
<div class="main_all">
	...
	<ul class="nav">
        <li class="nav_li1 nav_li"><a class="nav_1" href="bj_zb.html" target="_self">周边</a></li>
        <li><a class="nav_2" href="bj_cx.html" target="_self">长线</a></li>
        <li><a class="nav_3" href="bj_cj.html" target="_self">出境</a></li>
    </ul>
    <div class="yc_box">
    	<h2 class="yc_title">迎春节正在热销•••</h2>
        <ul class="rx_list">
        <@s.iterator value="map.get('${station}_zbbj_tm')" status="st">
            <li>
    ...
    <div class="diqu_box">
<!--东南亚模块-->
 	<@s.iterator value="map.get('${station}_zbbj')" status="st">
        <h3 class="maodian"><span>${title?if_exists}</span></h3>
        <ul class="cp_list">
        <@s.iterator value="map.get('${station}_zbbj_${st.index + 1}')" status="sts">
        	<li>
