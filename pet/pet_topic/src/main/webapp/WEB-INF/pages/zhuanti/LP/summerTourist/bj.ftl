...
<div class="wrap">
	...
	<div class="cont_wrap">
		...
		<div id="summer_product">
			<!-- S 儿童 -->
			<div class="pro_cont children dn">
				<!-- S 产品区 -->
				<div class="clearfix p_rel model island">
					...
					<div class="png_bg cont_data">
						<div class="cont_data_wrap">
							<@s.iterator value="map.get('${station}_bj_etbj_hd')" status="st">
							...
							<@s.if test="map.get('${station}_bj_etbj_hd')!=null && map.get('${station}_bj_etbj_hd').size>0">
								</ul>
				...
				<div class="clearfix p_rel model culture">
					...
					<div class="png_bg cont_data">
						<div class="cont_data_wrap">
							<@s.iterator value="map.get('${station}_bj_etbj_wh')" status="st">
						    <@s.if test="#st.index == 0">
							<div class="cont_pro">
								<em class="gold_rec">金牌推荐</em>
							...
							<@s.if test="map.get('${station}_bj_etbj_wh')!=null && map.get('${station}_bj_etbj_wh').size>0">
								</ul>
								<@s.if test="map.get('${station}_bj_etbj_wh').size>3">
								<p class="t_r toggle"><span class="open">展开</span></p>		
								</@s.if>					
							</@s.if>
						</div>
				...
				<div class="clearfix p_rel model natural">
					...
					<div class="png_bg cont_data">
						<div class="cont_data_wrap">
							<@s.iterator value="map.get('${station}_bj_etbj_zr')" status="st">
						    <@s.if test="#st.index == 0">
							<div class="cont_pro">
								<em class="gold_rec">金牌推荐</em>
								<h4><a target="_blank"  href="${url?if_exists}">${title?if_exists}</a></h4>
							...
							<@s.if test="map.get('${station}_bj_etbj_zr')!=null && map.get('${station}_bj_etbj_zr').size>0">
								</ul>
								<@s.if test="map.get('${station}_bj_etbj_zr').size>3">
								<p class="t_r toggle"><span class="open">展开</span></p>		
								</@s.if>						
							</@s.if>
						</div>
				...
				<div class="clearfix p_rel model city">
					...
					<div class="png_bg cont_data">
						<div class="cont_data_wrap">
							<@s.iterator value="map.get('${station}_bj_etbj_cs')" status="st">
						    <@s.if test="#st.index == 0">
							<div class="cont_pro">
								<em class="gold_rec">金牌推荐</em>
								<h4><a target="_blank"  href="${url?if_exists}">${title?if_exists}</a></h4>
							...
							<@s.if test="map.get('${station}_bj_etbj_cs')!=null && map.get('${station}_bj_etbj_cs').size>0">
								</ul>
								<@s.if test="map.get('${station}_bj_etbj_cs').size>3">
								<p class="t_r toggle"><span class="open">展开</span></p>		
								</@s.if>					
							</@s.if>
						</div>
			...
			<div class="pro_cont college">
				...
				<div class="col_pro_cont pr360 edutainment">
					...
					<div class="children_list">
						<ul>
							<@s.iterator value="map.get('${station}_bj_xyf_10yx')" status="st">
						...
						<@s.if test="map.get('${station}_bj_xyf_10yx')!=null && map.get('${station}_bj_xyf_10yx').size>3">
				...
				<div class="col_pro_cont pl360 wonderful">
					...
					<div class="children_list">
						<ul>
							<@s.iterator value="map.get('${station}_bj_xyf_10z15')" status="st">
							<li <@s.if test="#st.index == 0">class="cur"</@s.if>>
								<h4><a target="_blank"  href="${url?if_exists}">${title?if_exists}</a></h4>
								<div class="p_abs price">
									&yen;<em>${memberPrice?if_exists?replace(".0","")}</em>起<a target="_blank"  href="${url?if_exists}" class="btn_yd" title="立即预订">立即预订</a>
				...
				<div class="col_pro_cont pr360 exotic">
					...
					<div class="children_list">
						<ul>
							<@s.iterator value="map.get('${station}_bj_xyf_15ys')" status="st">
							<li <@s.if test="#st.index == 0">class="cur"</@s.if>>
								<h4><a target="_blank"  href="${url?if_exists}">${title?if_exists}</a></h4>
								<div class="p_abs price">
									&yen;<em>${memberPrice?if_exists?replace(".0","")}</em>起<a target="_blank"  href="${url?if_exists}" class="btn_yd" title="立即预订">立即预订</a>
