...
<head>
<meta charset="utf-8" />
<title>上海春节旅游线路_上海出发春节旅游线路推荐,价格-驴妈妈旅游网</title>
<meta name="keywords" content="春节，上海,线路,旅游" />
<meta name="description" content="驴妈妈推出专题向驴友推出上海春节旅游线路，有些人会问上海春节旅游线路哪个好?以及上海出发春节旅游线路推荐哪里好?为您收罗了春节的美丽景色，一起来旅游吧！" />
...
<div class="main_all">
	...
	<ul class="nav">
        <li class="nav_li1"><a class="nav_1" href="index.html" target="_self">周边</a></li>
        <li class="nav_li"><a class="nav_2" href="sh_cx.html" target="_self">长线</a></li>
        <li><a class="nav_3" href="sh_cj.html" target="_self">出境</a></li>
    </ul>
    <div class="yc_box">
    	<h2 class="yc_title">迎春节正在热销•••</h2>
        <ul class="rx_list">
        <@s.iterator value="map.get('${station}_cx_tm')" status="st">
            <li>
    ...
    <div class="diqu_box">
<!--东南亚模块-->
   	<@s.iterator value="map.get('${station}_cx')" status="st">
        <h3 class="maodian"><span>${title?if_exists}</span></h3>
        <ul class="cp_list">
        <@s.iterator value="map.get('${station}_cx_${st.index + 1}')" status="sts">
        	<li>
...
<div class="main_b ">
    ...
    <ul class="hd_list">
		<@s.iterator value="map.get('${station}_tp3_sh')" status="st">
...
<div class="cfd_box">
	<dl>
    	<dt>出发地：</dt>
        <dd class="cfd_box_dd"><a href="index.html" target="_self">上海</a></dd>
