...
<iframe src='/edm/showUpdateSubscribeEmail.do?email=<@s.property value="email"/>' id="contractTemplateIframe" frameborder="no" style="align:center;border:0px solid #7F9DB9;padding-right:1px;height:500px;width:100%;z-index:0;"></iframe>
</div>
...
<iframe src='/edm/showUpdateSubscribeEmail.do?email=<@s.property value="#session.SESSION_USER_OBJECT.email"/>' id="contractTemplateIframe" frameborder="no" style="border:0px solid #7F9DB9;padding-right:1px;height:600px;width:750px;position:absolute;"></iframe>
</div>
</div>
