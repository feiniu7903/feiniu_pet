...
<title>新西兰个人旅游签证（学生及学龄前儿童）</title><link charset="utf-8" media="screen" type="text/css" rel="stylesheet" href="http://pic.lvmama.com/min/index.php?g=commonCss">
...
<iframe frameborder="1" scrolling="no" id="testframe" width="90%" src="http://pic.lvmama.com/opi/doc/visa/newzealand_visa_student.html"></iframe> 
