...
<title>埃及团队旅游签证（成都领区）-成年人</title><link charset="utf-8" media="screen" type="text/css" rel="stylesheet" href="http://pic.lvmama.com/min/index.php?g=commonCss">
...
<iframe frameborder="1" scrolling="no" id="testframe" width="90%"src="http://pic.lvmama.com/opi/doc/visa/egypt_visa_cd_geren.html"></iframe> 
