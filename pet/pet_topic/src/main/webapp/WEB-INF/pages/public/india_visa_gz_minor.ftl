...
<title>印度团队旅游签证（广州领区--学生）</title><link charset="utf-8" media="screen" type="text/css" rel="stylesheet" href="http://pic.lvmama.com/min/index.php?g=commonCss">
...
<iframe frameborder="1" scrolling="no" id="testframe" width="90%"src="http://pic.lvmama.com/opi/doc/visa/india_visa_gz_minor.html"></iframe> 
