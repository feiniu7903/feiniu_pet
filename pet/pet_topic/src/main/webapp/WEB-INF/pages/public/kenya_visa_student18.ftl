...
<title>肯尼亚团队旅游签证（学生18岁以上）</title><link charset="utf-8" media="screen" type="text/css" rel="stylesheet" href="http://pic.lvmama.com/min/index.php?g=commonCss">
...
<body>
 ...
 <iframe frameborder="1" scrolling="no" id="testframe" width="90%"src="http://pic.lvmama.com/opi/doc/visa/kenya_visa_student18.html"></iframe> 
