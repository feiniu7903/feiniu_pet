...
<title>韩国个人旅游签证（上海领区—学生和学龄前儿童）</title><link charset="utf-8" media="screen" type="text/css" rel="stylesheet" href="http://pic.lvmama.com/min/index.php?g=commonCss">
...
<iframe frameborder="1" scrolling="no" id="testframe" width="90%"src="http://pic.lvmama.com/opi/doc/visa/korea_gr_visa_student.html"></iframe> 
