		         		                 ...
		         		                 if(data.success == "true"){
		         		                	...
		         		                	{ 
		         		                	 ...
		         		                	 if(null!=data.message){
		         		                		...
		         		                		pandora.dialog({title: "",content: data.message});
	  		         		                 }
		         		                 }
		         	            }
	                	 });
		...
		$.ajax({
	 		...
	 		dataType : "jsonp",jsonp: "jsoncallback",
	   		...
	   		success : function(json) {
	   			...
	   			if(json.money==0){
	   				var html_juankuan = '';
	   				html_juankuan=html_juankuan+'<div class=shuzi>000000</div>'; 
	   				$(".tjYList").html(html_juankuan);
	   			}
	   			else if(json.money<10){
	   				var html_juankuan = '';
	   				html_juankuan=html_juankuan+'<div class=shuzi>00000'+json.money+'</div>'; 
	   				$(".tjYList").html(html_juankuan);
	   			}
	   			else if(json.money<100){
	   				var html_juankuan = '';
	   				html_juankuan=html_juankuan+'<div class=shuzi>0000'+json.money+'</div>'; 
	   				$(".tjYList").html(html_juankuan);
	   			}else if(son.money<1000){
	   				var html_juankuan = '';
	   				html_juankuan=html_juankuan+'<div class=shuzi>000'+json.money+'</div>'; 
	   				$(".tjYList").html(html_juankuan);
	   			}else if(son.money<10000){
	   				var html_juankuan = '';
	   				html_juankuan=html_juankuan+'<div class=shuzi>00'+json.money+'</div>'; 
	   				$(".tjYList").html(html_juankuan);
	   			}else if(son.money<100000){
	   				var html_juankuan = '';
