...
@Repository
public class FinAdvanceDepositDAO extends BaseIbatisDAO {
	...
	public Page<FinSupplierMoney> searchAdvanceDepositWarning(Map<String,Object> map) {
		return super.queryForPage("FIN_ADVANCE_DEPOSIT.searchAdvanceDepositWarning", map);
	}
	...
	public List<SetSettlementPayment> searchAdvanceDepositPayment(Long supplierId) {
		return super.queryForList("FIN_ADVANCE_DEPOSIT.searchAdvanceDepositPayment", supplierId);
	}
	...
	public List<FinAdvanceDeposit> searchFinAdvanceDeposit(Map<String,Object> map) {
		return super.queryForList("FIN_ADVANCE_DEPOSIT.searchFinAdvanceDeposit", map);
	}
	public Long searchFinAdvanceDepositCount(Map<String,Object> map) {
		return (Long)super.queryForObject("FIN_ADVANCE_DEPOSIT.searchFinAdvanceDepositCount", map);
	}
	...
	public void updateSupplierAdvanceDepositAmount(Long supplierId, Long amount) {
		...
		super.update("FIN_ADVANCE_DEPOSIT.updateSupplierAdvanceDepositAmount", map);
	}
	...
	public void insertFinadvanceDeposit(FinAdvanceDeposit fad) {
		super.insert("FIN_ADVANCE_DEPOSIT.insertFinadvanceDeposit", fad);
	}
	...
	public Double searchAmount(Long supplierId,String currency) {
		...
		return (Double) super.queryForObject("FIN_ADVANCE_DEPOSIT.searchAmount",map);
	}
	...
	public FinSupplierMoney searchSupplier(Long supplierId) {
		return (FinSupplierMoney)super.queryForObject("FIN_ADVANCE_DEPOSIT.searchSupplier",supplierId);
	}
