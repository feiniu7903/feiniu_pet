package com.lvmama.pet.prism.agent.web;
...
public class PrismAgentController {
	...
	@Autowired
	private HotelTrafficInfoDAO dao;

	@RequestMapping(value = "/pet/agent", method = RequestMethod.GET, headers = "Accept=application/xml, application/json")
