...
/**
 * 微信支付android手机支付PostData.
 * @author ZhangJie
 */
public class WeixinAndroidPostData implements PostData {
	 ...
	 * 接收财付通通知的URL
	 */
	private String notify_url=PaymentConstant.getInstance().getProperty("WEIXIN_ANDROID_NOTIFY_URL");
	...
	public WeixinAndroidPostData(PayPayment payment,Map<String,Object> paramMap){
	...
	public String getRequestData(){
        ...
        postData.put("timestamp", Long.valueOf(timestamp));
