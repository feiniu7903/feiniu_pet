 ...
 * @author ZHANG Jie
 */
public class BaidupayWapCallbackData implements CallbackData {
	...
	public BaidupayWapCallbackData(Map<String, String> map){
		LOG.info("Callback Data from baidupaywap :" + map.toString());
		this.paraMap = map;
		...
		this.bankNo=this.paraMap.get("bank_no");
		...
		if(PaymentConstant.getInstance().getProperty("BAIDUWAPPAY_ACTIVITIES_SP_NO").equalsIgnoreCase(this.spNo)){
