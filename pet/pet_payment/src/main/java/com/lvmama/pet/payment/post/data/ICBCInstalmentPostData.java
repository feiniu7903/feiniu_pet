 ...
 *
 */
public class ICBCInstalmentPostData implements PostData {
	/**
	 * LOG.
	 */
	private static final Log LOG = LogFactory.getLog(ICBCInstalmentPostData.class);
	 ...
	 * 返回商户URL
	 */
	private String merURL=PaymentConstant.getInstance().getProperty("ICBC_INSTALMENT_NOTIFY_URL");
	/**
	 * 返回商户变量
	 */
	...
	public ICBCInstalmentPostData(PayPayment payment,String instalmentNum) {
		LOG.info("ICBCInstalmentPostData,payment="+StringUtil.printParam(payment)+",instalmentNum="+instalmentNum);
		this.installmentTimes=instalmentNum;
