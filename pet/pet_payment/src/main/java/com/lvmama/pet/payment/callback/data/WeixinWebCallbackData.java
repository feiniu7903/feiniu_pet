 ...
 * @author heyuxing
 */
public class WeixinWebCallbackData implements CallbackData {
	 ...
	 * @param map
	 */
	public WeixinWebCallbackData(Map<String, String> map){
		LOG.info("Callback Data from WeixinWebCallbackData :" + map.toString());
		this.paraMap = map;
		Class<? extends WeixinWebCallbackData> dealClass = this.getClass();
