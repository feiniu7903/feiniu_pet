 ...
 *
 */
public class ICBCInstalmentCallbackData implements CallbackData {
	...
	public ICBCInstalmentCallbackData(Map<String, String> map) {
		try {
			LOG.info("ICBCInstalmentCallbackData Map:"+map.toString());
			...
			LOG.info("ICBCInstalmentCallbackData paramMap:"+paramMap.toString());
	...
	public boolean checkSignature() {
		try {
			...
			LOG.info("ICBCInstalmentCallbackData.checkSignature,result="+result);
			if(result == 0) {
				return true;
			}
		} catch (Exception e) {
