 ...
 *
 */
public class UnionpayPrePostData implements PostData {
	...
	private UnionpayPrePostData() {
		...
		transType = pc.getProperty("CHINAPAY_PRE_TRANSTYPE_PAY");
		...
		backEndUrl = pc.getProperty("CHINAPAY_PRE_BACKENDURL");
		frontEndUrl = pc.getProperty("CHINAPAY_PRE_FRONTENDURL");
	 ...
	 * @param ordPayment
	 */
	public UnionpayPrePostData(final PayPayment payPayment,final String userIp) {
		this();
		/** 日期格式转换. */
