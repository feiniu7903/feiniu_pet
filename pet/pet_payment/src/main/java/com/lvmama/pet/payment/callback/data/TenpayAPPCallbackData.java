 ...
 * @author ZHANG Jie
 */
public class TenpayAPPCallbackData implements CallbackData {
	...
	public TenpayAPPCallbackData(Map<String, String> map){
		LOG.info("Callback Data from tenpayApp :" + map.toString());
		this.paraMap = map;
	...
	public Date getCallBackTime() {
		return DateUtil.getDateByStr(time_end, "yymmddhhmmss");
	}
