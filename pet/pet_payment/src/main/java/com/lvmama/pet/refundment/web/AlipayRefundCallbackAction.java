...
import com.lvmama.pet.refundment.data.AlipayRefundCallbackData;
...
public class AlipayRefundCallbackAction extends RefundCallbackBaseAction {
	...
	@Action("/refund/alipayRefundCallback")
	...
	protected RefundCallbackData getRefundCallbackData() {
		return new AlipayRefundCallbackData(getPureParaPair());
	}
}
