	        ...
	        <table class="p_table J_additem_box">
	            <tbody>
	                <tr>
						...
						<td>
							<div id="filename"></div>
							<input type="button" value="上传快递单扫描件" id="uploadChangeFile" serverType="SUP_SUPPLIER_CONTRACT"/>
						</td>
	                </tr>
	                <tr>
	...
	<script type="text/javascript">
	 $(function(){
		 ...
		 $("#saveSendLog").click(function(){
			 ...
			 $.ajax({
	    	 		url: "<%=basePath%>/visa/approval/batchSaveSendLog.do",
					type:"post",
	    	 		data: {
