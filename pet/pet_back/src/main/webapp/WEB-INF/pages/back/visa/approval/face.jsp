...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        <p class="lead">游玩人<span class="req">${visaApproval.name}</span>的文件:</p>
        <div class="box_content">
	        <table class="p_table J_additem_box" style="width:100%">
	            ...
	            <tfoot>
	                <tr>
	                    <td colspan="2"><p class="tc mt20"><button id="saveFaceLog" class="btn btn-small w3" type="button">保存</button></p></td>
	                </tr>
	            </tfoot>
	        </table>
	        <br/>
	        <table class="p_table J_additem_box">
	            <tbody>
	            	<s:iterator value="logs" id="log">
						<tr>
							<td width="90">${log.operatorName }添加了文件：${log.content }</td>
						</tr>		                   
	            	</s:iterator>
	            </tbody>
	        </table>
	...
	<script type="text/javascript">
	 $(function(){
		 ...
		 $("#saveFaceLog").click(function(){
			 ...
			 $.ajax({
	    	 		url: "<%=basePath%>/visa/approval/saveFaceLog.do",
					type:"post",
	    	 		data: {
