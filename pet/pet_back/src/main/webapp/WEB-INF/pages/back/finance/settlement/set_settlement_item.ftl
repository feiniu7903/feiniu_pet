...
<script type="text/javascript" src="${basePath}js/finance/settlement/set_settlement_item.js"></script>
</head>
		...
		<div class="wapper_list wapper_listadd_26">
			...
			<div class="order_top order_top_26_add current01">
				<form id="search_settlement_item_form" action="searchList.do" method="post">
					<table border="0">
						<tr>
							<td height="30" align="right"><label>结算名称：</label>
							</td>
							<td height="30">
						...
						<tr>
							<td height="30" align="right"><label>产品名称：</label>
							</td>
							<td height="30">
						...
						<tr>
								...
								<td height="30" align="right"><label> 产品类型：</label>
								</td>
								<td height="30">
