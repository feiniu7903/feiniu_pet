...
<html>
	...
	<body>
 		<form id="form1" method="post" action="/pet_back/tableEditorFromPlace.do" onsubmit="return check();">
				...
				<tr>
					...
					<td>
						<select class="containerCodeSel" disabled="disabled">
							 <option value="">请选择</option>
							 <option value="LVHOME_RECOMMEND">新版首页频道</option>
                             <option value="HOME_RECOMMEND">首页频道</option> 
                             <option value="CHANNEL_TICKET_RECOMMEND">门票频道</option> 
                             <option value="CHANNEL_AROUND_RECOMMEND">周边游频道</option> 
                             <option value="CHANNEL_DESTROUTE_RECOMMEND">国内游频道</option> 
                             <option value="CHANNEL_ABROAD_RECOMMEND">出境游频道</option> 
                            <option value="TUANGOU_RECOMMEND">团购推荐</option>
						</select>
					</td>
		...
		$(document).ready(function(){
			...
			$(".add").live('click', function(){
				...
				row += '<option value="">请选择</option>';
				row += '<option value="LVHOME_RECOMMEND">新版首页频道</option>';
				row += '<option value="HOME_RECOMMEND">首页频道</option>';
				row += '<option value="CHANNEL_TICKET_RECOMMEND">门票频道</option>';
				row += '<option value="CHANNEL_AROUND_RECOMMEND">周边游频道</option>';
				row += '<option value="CHANNEL_DESTROUTE_RECOMMEND">国内游频道</option>';
				row += '<option value="CHANNEL_ABROAD_RECOMMEND">出境游频道</option>';
				row +='<option value="TUANGOU_RECOMMEND">团购推荐</option>'
				row += '</select>';
				row += '</td>';
