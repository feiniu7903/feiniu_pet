...
$(function() {
	...
	$("#targetId").combox("/pet_back/sup/target/settlementSearch.do");
	$("#metaProductId").combox({
									source:"/super_back/meta/searchMetaList.do",
	...
	$("#search_button").click(function(){
		...
		$("#result_table").grid({
			...
			colModel : [ 
			             ...
			             {name:'productId',index:'PRODUCT_ID', sorttype: "int", width:120},
			             {name:'productName',index:'PRODUCT_NAME', sorttype: "string",width:200},
			             ...
			             {name:'metaFilialeNameCn', index: "META_FILIALE_NAME", sorttype: "string", width:200},
			             {name:'metaBranchName', index: "META_BRANCH_NAME", sorttype: "string", width:120},
			             {name:'supplierId',index:'A.SUPPLIER_ID',sorttype: "int", width:100},
			             {name:'supplierName',index:'C.SUPPLIER_NAME',sorttype: "string", width:130},
			             {name:'productQuantity',index:'PRODUCT_QUANTITY', sorttype: "int", width:100},
			             {name:'targetName',index:'B.NAME', sorttype: "string",  width:200},
			             ...
			             {name:'performStatusCn',index:'PERFORM_STATUS', sortable:true,width:100},
			             {name:'companyName',index:'C.COMPANY_ID', sorttype: "string", width:160},
			             ...
			             {name:'suggestionPayTimeStr',index:'B.ADVANCED_DAYS', sortable:false, width:140},
