...
function searchPaymentHistoryHandler(){
	...
	$("#result_table").grid({
		...
		colModel : [ 
		             {name:'travelGroupCode',align:"center",sortable:false, width:150},
		             {name:'settlementIdStr',align:"center", index:'set_settlement_Id',sortable:false, width:40},
		             ...
		             {name:'zhCurrency',align:"center",sortable:false, width:60},
		             {name:'operatetimeStr',align:"center",index:'operate_time', sortable:false, width:90},
		             {name:'createtimeStr',align:"center",index:'create_time', sortable:false, width:90},
