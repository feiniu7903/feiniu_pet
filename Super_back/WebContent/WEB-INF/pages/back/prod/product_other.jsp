        ...
        <input type="hidden" name="productId" value="${productId}"/>
         ...
         <input type="hidden" name="dataStr" id="dataStr" value=""/>
           ...
           <table cellspacing="0" cellpadding="0" border="0" width="100%" class="proLabel">
              <tbody>
              <tr>
                 <td colspan="4"><h4 class="pro_tit">产品属性1&nbsp;<span class="txt_grey">产品属性:(提示：产品属性主要用于搜索，请准确填写)</span></h4></td>
              </tr>
              <tr>
                <td><b>线路分类：[*]</b></td>
                <td colspan="3">
             ...
             <s:iterator value="productTypeVOList" id="vo" status="index">
              <tr>   
                <td><b><s:property value="modelType.modelName" />：[*]</b></td>
...
<div>
  ...
  <div id="div3">
  <h3>&nbsp;&nbsp;上车地点</h3>
  <form action="<%=basePath%>prod/addAssembly.do?productId=${productId}" method="post">
  <table class="table_list">

<tr><td>上车地点:<span class="require">[*]</span></td>
<td><input name="assemblyPoint" id="assemblyPoint" class="input_style"/></td>
...
<tr><td colspan="2" style="text-align: center"><s:property value="assemblyPoint"/></td><td style="text-align: center"><a href="<%=basePath%>prod/delAssembly.do?productId=${productId}&assemblyPointId=<s:property value="assemblyPointId"/>">删除</a></td></tr>
</s:iterator>
  </table>
  </form>
  </div>
