		...
		<table class="newTableProductDetail" width="100%" border="0" cellspacing="0" cellpadding="0" >
          ...
          <tr>
 		  	...
 		  	<td colspan="2"><b>重要提示</b><span class="require">[*]</span></td>
		          ...
		          <tr>
	               ...
	               <font color="red">自由行产品</font><br/>
	                ...
	                <s:elseif test='product.productType=="TICKET"'>
			               ★预订须知（DEST页面景点销售信息中的预订须知参照以下模板）<br/>
 		  ...
 		  <tr>
			...
			<dl>
        	<dt><b>产品经理推荐</b>(单行不能超过30个字)</dt>
            <dd><textarea name="MANAGERRECOMMEND" cols="text2" rows="text2" class="text2"><s:property value='viewPage.contents.get("MANAGERRECOMMEND").content'/></textarea></dd>         
        	<dt><b>公告</b><span>(建议文字简略，不超过3条)</span></dt>
            <dd><textarea name="ANNOUNCEMENT" cols="text2" rows="text2" class="text2" ><s:property value='viewPage.contents.get("ANNOUNCEMENT").content'/></textarea></dd>
        	<dt><b>费用说明</b><span class="require">[*]</span></dt>
            <dd>
            	<p>费用包含</p>
                <p><textarea id="cost" name="COSTCONTAIN" cols="text2" rows="text2" class="text2"><s:property value='viewPage.contents.get("COSTCONTAIN").content'/></textarea>
                <s:if test='product.productType=="HOTEL"'>
                </s:if>
                <s:elseif test='product.productType=="ROUTE"'>
                </s:elseif>
                <s:elseif test='product.productType=="OTHER"'>
                ...
                <p>推荐项目</p>
                <p><textarea id="cost" name="RECOMMENDPROJECT" cols="text2" rows="text2" class="text2"><s:property value='viewPage.contents.get("RECOMMENDPROJECT").content'/></textarea></p>
            	<p>费用不包含</p>
                <p><textarea name="NOCOSTCONTAIN" cols="text2" rows="text2" class="text2"><s:property value='viewPage.contents.get("NOCOSTCONTAIN").content'/></textarea>
                <s:if test='product.productType=="HOTEL"'>
                </s:if>
                <s:elseif test='product.productType=="ROUTE"'>
                </s:elseif>
            	...
            	<p>购物说明</p>
                <p><textarea name="SHOPPINGEXPLAIN" cols="text2" rows="text2" class="text2"><s:property value='viewPage.contents.get("SHOPPINGEXPLAIN").content'/></textarea></p>
                <p>退款说明</p>
                <p><textarea name="REFUNDSEXPLANATION" cols="text2" rows="text2" class="text2"><s:property value='viewPage.contents.get("REFUNDSEXPLANATION").content'/></textarea></p>
            </dd>
            <dt><b>重要提示</b><span class="require">[*]</span></dt>
            <dd>
            	<p>预订须知（原预订须知）</p>
                <p><textarea name="ORDERTOKNOWN" cols="text2" rows="text2" class="text2"><s:property value='viewPage.contents.get("ORDERTOKNOWN").content'/></textarea>
                <s:if test='product.productType=="HOTEL"'>
                </s:if>
                <s:elseif test='product.productType=="ROUTE"'>
                </s:elseif>
                ...
                <s:elseif test='product.productType=="TICKET"'>
                1. 优惠人群说明：优惠人群要求（儿童身高、年龄，老人年龄等）若有优惠人群价格，也请注明
                 2. 订单张数限制：（如遇产品对单订单（单手机）预订有限制，请注明，如无请删除此项）
                  3. 预订限制(人群,地域,年龄等)：（如遇景区对预订人群,地域,年龄等，请注明，如无请删除此项）
                </s:elseif>
                </p>
            	<p>行前须知（原产品特别提示）</p>
                <p><textarea name="ACITONTOKNOW" cols="text2" rows="text2" class="text2"><s:property value='viewPage.contents.get("ACITONTOKNOW").content'/></textarea></p>
            	
                <p>旅游服务保障</p>
                <p><textarea name="SERVICEGUARANTEE" cols="text2" rows="text2" class="text2"><s:property value='viewPage.contents.get("SERVICEGUARANTEE").content'/></textarea></p>
                <p>游玩提示</p>
                <p><textarea name="PLAYPOINTOUT" cols="text2" rows="text2" class="text2"><s:property value='viewPage.contents.get("PLAYPOINTOUT").content'/></textarea></p>
            </dd>
            <dt><b>交通信息</b><!--<span>(用于出境游的产品)</span></dt>-->
            <dd><textarea name="TRAFFICINFO" cols="text2" rows="text2" class="text2"><s:property value='viewPage.contents.get("TRAFFICINFO").content'/></textarea></dd>
        	<dt><b>签证/签注</b><span>(用于出境游的产品)</span><em>保持现状</em></dt>
            <dd><textarea name="VISA" cols="text2" rows="text2" class="text2"><s:property value='viewPage.contents.get("VISA").content'/></textarea></dd>
          	<dt><b>产品特色</b></dt>
            <dd><textarea name="FEATURES" id="features" cols="text2" rows="text2" class="text2"><s:property value='viewPage.contents.get("FEATURES").content'/></textarea></dd>		
      		<dt><b>内部提示（前台页面不显示，仅能客服在后台下单中查看）</b></dt>
            <dd><textarea name="INTERIOR" cols="text2" rows="text2" class="text2"><s:property value='viewPage.contents.get("INTERIOR").content'/></textarea></dd>		
      </dl> 
      --%>
   </div><!--row2 end-->
   <div class="row3">
        <p><input type="submit" value="保存" class="button" id="save" style="display: inline;"/>
        <a href="#log" class="showLogDialog" param="{'parentType':'PROD_PRODUCT','objectType':'VIEW_PAGE','parentId':${productId}}">查看操作日志</a>
        </p>      
   </div><!--row3 end-->
   </form>
