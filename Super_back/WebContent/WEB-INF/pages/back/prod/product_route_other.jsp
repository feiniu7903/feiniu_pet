           ...
           <table cellspacing="0" cellpadding="0" border="0" width="100%" class="proLabel">
             ...
             <s:iterator value="productTypeVOList" id="vo" status="index">
              ...
              <tr>   
                ...
                <tr>
                 <td colspan="2">
                     <input type="submit" id="other_save" class="button" name="" value="保存">
                 </td>
              </tr>  
            </tbody>
          </table>
...
<div>
  ...
  <div id="div3">
  <h3>&nbsp;&nbsp;上车地点</h3>
  <form action="<%=basePath%>prod/addAssembly.do" method="post" onsubmit="return beforeAddAssembly();" class="mySensitiveForm">
  	<input type="hidden" name="productId" value="${productId }" />
  <table class="table_list">

<tr><td>上车地点:<span class="require">[*]</span></td>
<td><input name="assemblyPoint" id="assemblyPoint" class="input_style sensitiveVad"/></td>
<td><input type="submit" class="button" value="新增" style="display: inline;"/>
<a href="#log" class="showLogDialog" param="{'parentType':'PROD_PRODUCT','objectType':'PROD_ASSEMBLY_POINT','parentId':${productId}}">查看操作日志</a>
</td>

</tr>
<!-- 
<tr><td colspan="3" style="text-align: center"><strong>新建上车地点</strong></td></tr> --> 
<tr>
<td  colspan="2" style="text-align: center"><strong>上车地点</strong></td><td style="text-align: center"><strong>操作</strong></td>

</tr>
<s:iterator value="assemblyList" var="assembly">
<tr><td colspan="2" style="text-align: center"><s:property value="assemblyPoint"/><input type="hidden" name="assemblyPoint${productId}" value="<s:property value='assemblyPoint'/>" class="sensitiveVad" /></td><td style="text-align: center"><a href="<%=basePath%>prod/delAssembly.do?productId=${productId}&assemblyPointId=<s:property value="assemblyPointId"/>">删除</a></td></tr>
</s:iterator>
  </table>
  </form>
  </div>
