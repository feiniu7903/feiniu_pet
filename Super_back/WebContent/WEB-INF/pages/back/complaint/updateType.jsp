...
<body>
	<div class="p_box">
		<form id="updateType_form" action="complaintType/update_type.do" method="post">
			<table class="p_table form-inline" width="100%">
				<tr>
					<td class="p_label">*类型名称:</td>
					<td>
						<input type="text" id="typeName" name="typeName" style="width: 200px;" value="${type.typeName }" maxlength="20" />
				...
				<tr>
					...
					<td>
						<textarea rows="4" maxlength="100" style="width: 300px;" id="typeDescription" name="typeDescription">${type.typeDescription }</textarea>
						<span  style="font-size: 12px;color: red;">
				...
				<tr>
					...
					<td>
						<input type="text" id="sort" name="sort" value="${type.sort }" />
					</td>
				</tr>
			</table>
		...
		<p class="tc mt20">
			<button class="btn btn-small w5" type="button" onclick="editType();">提交</button>
		</p>
	</div>
</body>
</html>
