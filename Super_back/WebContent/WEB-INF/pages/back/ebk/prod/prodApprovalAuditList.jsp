...
<body>
	...
	<ul class="gl_top">
	<form id="prodApprovalAuditForm" action="${basePath}/ebooking/prod/prodApprovalAuditList.do" method="post" >
	...
	<table border="0"   cellpadding="0" class="gl_table">
		...
		<s:iterator value="ebkProdProductPage.items">
			<tr>
				...
				<td>
				<s:property value="prodProductId" />
				</td>
				<td>
				...
				<td><a href="javascript:prodAuditDetail('<s:property value="ebkProdProductId" />','<s:property value="status" />');">审核</a></td>
			</tr>
		</s:iterator>
		<tr>
