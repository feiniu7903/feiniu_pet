	...
	<table border="0"   cellpadding="0" class="gl_table">
		...
		<s:iterator value="ebkProdProductPage.items">
			<tr>
				...
				<td>
				<a href="javascript:prodAuditDetail('<s:property value="ebkProdProductId" />','<s:property value="status" />');">
					<s:if test="status=='PENDING_AUDIT'">审核</s:if><s:else>查看</s:else>
				</a>
				</td>
			</tr>
		</s:iterator>
