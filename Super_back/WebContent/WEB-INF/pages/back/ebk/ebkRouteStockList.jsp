...
<head>
<meta charset="utf-8" />
<title>Super后台-EBooking线路库存已审核页</title>
<!-- css -->
...
$(function(){
	...
	function suggestDetail(housePriceId) {
		$("#suggestDetailDiv").load(
			"${basePath}/ebooking/routestock/ebkRouteStockApplyDetail.do?ebkHousePrice.housePriceId="
...
<body>
	<!--订单处理开始-->
 <ul class="gl_top">
	<form id="ebkHousePriceApplyForm" action="${basePath}/ebooking/routestock/ebkRouteStockList.do" method="post">
