...
<head>
<meta charset="utf-8" />
<title>super后台-EBooking待审核线路变价</title>
<!-- css -->
...
<body>
	<!--订单处理开始-->
 <ul class="gl_top">
	<form id="ebkHousePriceApplyForm" action="${basePath}/ebooking/roomprice/ebkRoutePriceApplyList.do" method="post"  onsubmit="return beforeSubmit();">
