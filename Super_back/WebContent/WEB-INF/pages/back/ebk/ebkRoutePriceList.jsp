...
<head>
<meta charset="utf-8" />
<title>super后台-EBooking已审核线路变价</title>
...
<body>
	<!--订单处理开始-->
	<ul class="gl_top">
	<form id="ebkHousePriceApplyForm" action="${basePath}/ebooking/roomprice/ebkRoutePriceList.do" method="post" onsubmit="return beforeSubmit();">
	<table class="newfont06" border="0"  cellpadding="0"  >
		<tr height="30">
			...
			<td>采购产品名称：</td>
			<td>
				<input type="text" name="ebkHousePrice.productName" />
			</td>
			<td>审核状态：</td>
			<td>
	...
	<table border="0"   cellpadding="0" class="gl_table">
		...
		<tr>
			...
			<td colspan="9" align="right">${ebkHousePricePage.pagination }</td>
		</tr>
	</table>
