...
<s:if test="pagination!=null">
	...
	<div class="page_div">
	     <span>
	                                         总共
					<s:property value="pagination.totalRecords" />
					条记录 每页
					<s:property value="pagination.perPageRecord" />
					条记录
		</span>
		<span>
	    ...
	    <span>
	          		当前第
					<s:property value="pagination.page" />
					页 总共
					<s:property value="pagination.totalPages" />
					页
	    </span>
	    
	    <span>
	      		 跳转到
				<input type="text" name="page" id="fpages" size="3" />
				<a href="#"
					onClick="goPage(<s:property value="pagination.totalPages"/>,'<s:property value="pagination.actionUrl"/>')">GO!</a>

				&nbsp;&nbsp;&nbsp;&nbsp;显示
				<select size="1" name="pagRecord" id="pagRecord"
...
function do_goPage(page,actionUrl){	
		var pgForm=document.getElementById("pgForm");
