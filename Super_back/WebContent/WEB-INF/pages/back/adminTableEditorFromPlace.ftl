...
<html>
	...
	<body>
		<a href="/super_back/adminTableEditor.do">Switch to Toplace Editor</a>
		<form id="form1" method="post" action="/super_back/adminTableEditorFromPlace.do">
		...
		function del(id) {
			if (confirm("Are you sure?")) {
				window.location.href="/super_back/adminTableEditorFromPlace/del.do?delId=" + id;
			}
		}
		</script>
	</body>
