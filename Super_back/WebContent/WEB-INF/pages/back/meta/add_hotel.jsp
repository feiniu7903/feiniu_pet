...
<div class="main main04">
  ...
  <form action="<%=basePath%>meta/saveHotel.do" name="metaProductForm" method="post" onsubmit="return false">
  ...
  <div class="row2">    
        	...
        	<table border="0" cellspacing="0" cellpadding="0" class="newInput newInputY" style="width:600px">
			  	<tr>
			  		...
			  		<td><s:radio list="subProductTypeList" name="metaProduct.subProductType" listKey="code" listValue="name"/><s:textfield name="metaProduct.nights" cssStyle="display:none"/></td>
			  	</tr>
		  	</table>    
