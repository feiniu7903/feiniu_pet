$(function(){
	$('.clickShow,.qupiaoren,.clickShow02,.userChoose,.button').click(function(){
   ...
   $('.clickShow03').click(function(){
	     var invoiceInformationText = $('.invoiceInformationText').css('display');	
