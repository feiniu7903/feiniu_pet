...
public class ReportEditingServiceLocator extends org.apache.axis.client.Service implements ReportEditingService {
    ...
    private java.lang.String ReportEditingServiceSoap_address = "http://192.168.0.26:7001/analytics-ws/saw.dll?SoapImpl=reportService";
    ...
    public ReportEditingServiceSoap_PortType getReportEditingServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public ReportEditingServiceSoap_PortType getReportEditingServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ReportEditingServiceStub _stub = new ReportEditingServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ReportEditingServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                ReportEditingServiceStub _stub = new ReportEditingServiceStub(new java.net.URL(ReportEditingServiceSoap_address), this);
                _stub.setPortName(getReportEditingServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn://oracle.bi.webservices/v7", "ReportEditingService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v7", "ReportEditingServiceSoap"));
        }
