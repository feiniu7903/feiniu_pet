...
public class DescribeSubjectAreaResult  implements java.io.Serializable {
    private SASubjectArea subjectArea;

    public DescribeSubjectAreaResult() {
    }

    public DescribeSubjectAreaResult(
           SASubjectArea subjectArea) {
     ...
     * @param subjectArea
     */
    public void setSubjectArea(SASubjectArea subjectArea) {
        this.subjectArea = subjectArea;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v7", ">describeSubjectAreaResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("subjectArea");
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v7", "subjectArea"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v7", "SASubjectArea"));
