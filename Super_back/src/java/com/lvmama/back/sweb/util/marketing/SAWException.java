...
public class SAWException  implements java.io.Serializable {
    ...
    public SAWException getException(int i) {
        return this.exception[i];
    }

    public void setException(int i, SAWException _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v7", "SAWException"));
