...
public class GetSessionEnvironmentResult  implements java.io.Serializable {
    private SessionEnvironment _return;

    public GetSessionEnvironmentResult() {
    }

    public GetSessionEnvironmentResult(
           SessionEnvironment _return) {
     ...
     * @return _return
     */
    public SessionEnvironment get_return() {
        return _return;
    }
     ...
     * @param _return
     */
    public void set_return(SessionEnvironment _return) {
        this._return = _return;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v7", ">getSessionEnvironmentResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("_return");
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v7", "return"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v7", "SessionEnvironment"));
