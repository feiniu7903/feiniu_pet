...
public class ACL  implements java.io.Serializable {
    ...
    private AccessControlToken[] accessControlTokens;
     ...
     */
    public AccessControlToken[] getAccessControlTokens() {
        return accessControlTokens;
    }
     ...
     */
    public void setAccessControlTokens(AccessControlToken[] accessControlTokens) {
        this.accessControlTokens = accessControlTokens;
    }

    public AccessControlToken getAccessControlTokens(int i) {
        return this.accessControlTokens[i];
    }

    public void setAccessControlTokens(int i, AccessControlToken _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v7", "ACL"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v7", "accessControlTokens"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn://oracle.bi.webservices/v7", "AccessControlToken"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
