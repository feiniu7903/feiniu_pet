package com.lvmama.back.sweb.upload;
...
@Results({
	@Result(name = "success", location = "/WEB-INF/pages/back/knowledge/imageUploadSuccess.jsp")
...
public class ImgUploadAction extends BaseAction {
	...
	public void uploadImgFile() throws IOException{
		...
		if (this.imgFileFileName != null && !"".equals(this.imgFileFileName)) {
			...
			String url = getConstant().getPrefixPic();
