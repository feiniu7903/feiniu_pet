...
public class FinanceDepositDAO extends BaseIbatisDAO {
	...
	public List<FinDeposit> searchDepositRecord(Map<String,Object> map) {
		return super.queryForList("FINANCE_DEPOSIT.searchDepositRecord", map);
	}
	
	public Long searchDepositRecordCount(Map<String,Object> map) {
		return (Long)super.queryForObject("FINANCE_DEPOSIT.searchDepositRecordCount", map);
	}
	...
	public void updateSupplierDepositAmount(Long supplierId, Long amount) {
		...
		super.update("FINANCE_DEPOSIT.updateSupplierDepositAmount", map);
	}
	...
	public void updateSupplierGuaranteeLimit(Long supplierId, Long amount) {
		...
		map.put("amount", amount);
		map.put("supplierId", supplierId);
		super.update("FINANCE_DEPOSIT.updateSupplierGuaranteeLimit", map);
	}
	...
	public void insertFincDeposit(FinDeposit fincDeposit) {
		super.insert("FINANCE_DEPOSIT.insertFincDeposit", fincDeposit);
	}
	...
	public Double searchAmount(String type, Long supplierId) {
		...
		map.put("type", type);
		map.put("supplierId", supplierId);
		return (Double) super.queryForObject("FINANCE_DEPOSIT.searchAmount",map);
	}
	/**
	 * 查询供应商押金预警
	 * 
	...
	public Page<FinSupplierMoney> searchDepositWarning(Map<String,Object> map) {
		return super.queryForPage("FINANCE_DEPOSIT.searchDepositWarning", map);
	}
	...
	public FinSupplierMoney searchSupplier(Long supplierId) {
		return (FinSupplierMoney)super.queryForObject("FINANCE_DEPOSIT.searchSupplierCash",supplierId);
	}
	/**
	 * 更新供应商押金币种
	 * 
