...
public class FinSupplierMoneyDAO extends BaseIbatisDAO {
	...
	public Page<FinSupplierMoney> searchDeduction(Map<String, Object> map) {
		...
		return super.queryForPage("FIN_SUPPLIER_MONEY.searchSupplierMoney", map);
	}
	/**
	 * 查询押金分页信息
	 * @param map
	...
	public Page<FinSupplierMoney> searchAdvanceDeposit(Map<String,Object> map) {
		return super.queryForPage("FIN_SUPPLIER_MONEY.searchAdvanceDeposit", map);
	}
	/**
	 * 查询预存款分页信息
	 * @param map
	...
	public int addDeduction(Long amount, Long supplierId) {
		...
		return super.update("FIN_SUPPLIER_MONEY.addDeduction", map);
	}
	/**
	 * 添加抵扣款
	 * 
	...
	public void insertSupplierMoney(FinSupplierMoney finSupplierMoney) {
		super.insert("FIN_SUPPLIER_MONEY.insertSupplierMoney",finSupplierMoney);
	}
	/**
	 * 新增抵扣款
	 * 
	...
	public void insertDeduction(Long amount, Long supplierId) {
		...
		super.update("FIN_SUPPLIER_MONEY.insertSupplierMoney", supplierMoney);
	}
	...
	public FinSupplierMoney searchBySupplierId(Long supplierId) {
		return (FinSupplierMoney) super.queryForObject("FIN_SUPPLIER_MONEY.searchBySupplierId", supplierId);
	}
	...
	public void minusSupplierMoney(Long supplierId, Long deductionAmount, Long advanceDepositAmount, Long depositAmount) {
		...
		map.put("supplierId", supplierId);
		super.update("FIN_SUPPLIER_MONEY.minusSupplierMoney", map);
	}
	
	public void updateSupplierMoney(FinSupplierMoney finSupplierMoney){
		super.update("FIN_SUPPLIER_MONEY.updateSupplierMoney", finSupplierMoney);
	}
