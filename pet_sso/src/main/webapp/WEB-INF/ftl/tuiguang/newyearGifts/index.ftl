...
<head>
        ...
        DD_belatedPNG.fix('#tips_tan,.img_posi'); 
        </script> 
        <![endif]--> 
        
        <script type="text/javascript">
            <!--活动已过期，跳转到404-->
            window.location = "http://www.lvmama.com/404.jsp";
        </script>
</head>
<body>
<#assign imagesPath="http://pic.lvmama.com/img/zt/newyeargifts">
...
<div id="wrap">
	<div class="page">
    	<div class="content">
        	<div class="top">
            	<ul>
                	<li><img src="${imagesPath}/banner1.jpg" height="158" width="898" /></li>
                    <li><img src="${imagesPath}/banner2.jpg" height="159" width="898" /></li>
                    <li><img src="${imagesPath}/banner3.jpg" height="158" width="898" /></li>
                </ul>
                <h1>千元红包 免费旅游赶紧抢</h1>
                <h2>1重好礼:800元优惠券<br />2重好礼:有机会免费获得驴妈妈送出的景点门票<br />3重好礼:有机会获得驴妈妈超值回馈：豪华全家游<br /></h2>
                <h3 class="time">2012年2月9日<span>~</span>2012年3月31日</h3>                
            </div><!--top end-->
            <div class="main">
            	<div class="main_top">
                    <div id="log_div" class="log_reg">
                   		<h3>老会员登录免费索取800元大礼包</h3>
                         	<ul>
                            	<li>
                				<p><label for="acc_num"><strong>账号：</strong></label>
                                  <input type="text" name="mobileOrEMail" id="mobileAndEmail" value="" size="24" />
                                </p>
                                <p class="error"></p>    
                                </li>
                                <li>
                                 <p><label for="password"><strong>密码：</strong></label>
                                    <input name="password" id="password" type="password" size="24" />
                                </p>
                                 <p class="error" id="loinTextErrorTip"></p>                              
                               </li>
                           </ul>
                            <a class="submit" id="submit" onclick="login()">立即登录</a>
                    </div><!--log_reg end-->
                    <div id="log_succ" class="log_succ">
                   		<h3>老会员登录免费索取800元大礼包</h3>
                        <p>亲爱的<#if user!=null>${user.userName}</#if>，您好！</p> 
						<p>系统已成功检测到您已登录驴妈妈账户， 请您直接点击马上领取按钮，获得800元 的大礼包。</p>
						<form action="/nsso/bind/application.do" method="post" id="logForm">
                        <input name="pagePath" type="hidden" value="newyearGifts"/>
                        <input name="bindSuccURL" type="hidden" value="/newyeargift/bindsucc.do"/>
                        <input class="get_gift" id="get_gift" type="button" value=""/>
                        </form>
                    </div><!--log_reg end-->
                    <div class="register">
                     <h3>立即注册免费索取800元大礼包</h3>
                         <form action="/nsso/tuiguang/verification.do" id="regForm" method="post">
                            ...
                            <input name="pagePath" type="hidden" value="newyearGifts"/>
                         	<ul class="reg">
                            	<li>
                    				<p><label for="email_tel"><strong>手机号码：</strong></label>
                                        <input name="mobile" id="sso_mobile" type="text" value="" size="24" />
                                    </p>
                                    <p class="error">
                                        <span id="sso_mobile_pic" style="display:none;"><em class="sR"></em></span>
                                        <span id="sso_mobile_errorText" class="zhuci_tips"></span>
                                    </p>
                                </li>
                                <li>
                    				<p><label for="username"><strong>用户名：</strong></label>
                                        <input name="userName" id="sso_username" type="text" value="" size="24" />
                                    </p>
                                    <p class="error">
                                        <span id="sso_username_pic" style="display:none;"><em class="sR"></em></span>
                                        <span id="sso_username_errorText" class="zhuci_tips"></span> 
                                    </p>
                                </li>
                                <li>
                                     <p><label for="password"><strong>设置密码：</strong></label>
                                        <input name="password" id="sso_password" type="password" value="" size="24" />
                                     </p>
                                     <p class="error">
                                        <span id="sso_password_pic" style="display:none;"><em class="sR"></em></span>
                                        <span id="sso_password_errorText" class="zhuci_tips"></span>
                                     </p>                              
                                </li>
                                <li>
                                     <p><label for="password"><strong>确认密码：</strong></label>
                                        <input name="password2" id="sso_againPassword" type="password" value="" size="24" />
                                     </p>
                                     <p class="error">
                                        <span id="sso_againPassword_pic" style="display:none;"><em class="sR"></em></span>
                                        <span id="sso_againPassword_errorText" class="zhuci_tips"></span>
                                     </p>                              
                               </li>
                                <li>
                                 <p class="last"><label><strong>所属地区：</strong></label>
                            ...
                            <input class="reg_sub" type="button" name="registBtn" id="registBtn"/>
                        </form>
                    </div><!--register end-->
                </div><!--main_top end-->
                <div class="main_bot">
                	<h4>活动详情</h4>
                    <P>活动对象为驴妈妈旅游网新老会员；</P>
					<p>- 新用户成功注册后即赠送总价值800元优惠券；</p>
					<p>- 老会员参与活动即可获取总价值800元优惠券；</p>
					<p class="last_p">-凡参加活动，均有机会获得双重重礼：免费体验驴妈妈提供的景点门票产品；赢取节日全家游！
                    <a href="http://bbs.lvmama.com/thread-703567-1-1.html" target="_blank">&gt;&gt;详细规则</a></p>
                </div><!--main_bot end-->
            </div><!--main end-->
           <img class="img_posi" src="${imagesPath}/gift.png" width="126" height="96"  />
        </div><!--content end-->
	</div><!--page end-->
<div class="bg_container">
	  <div class="wrapbg01"></div>
      <div class="wrapbg02"></div>
      <div class="wrapbg03"></div>
</div>
<div class="footer_hz"><script src="http://www.lvmama.com/zt/000global/js/ztFooter.js" type="text/javascript"></script></div>
</div><!--wrap end-->
<div id="tips">
	<iframe style="position:absolute;top:0;width:600px;height:178px;filter:alpha(opacity=0);-moz-opacity:0;opacity:0;" scrolling="no" ></iframe>
      <div id="tips_tan">
            <h5>已获取大礼包<a class="close">关闭</a></h5>
            <p>您之前已成功获取总价值800元的优惠券一份。</p>
            <P>请注意查收您的账户【我的驴妈妈】【我的优惠券】，关注优惠券发放情况。</p>
            <a class="sure"><img src="${imagesPath}/sure.jpg" height="30" width="90" /></a>
      </div>
</div>
<div id="bgtan"></div>
<script type="text/javascript" src="/nsso/js/common/closeF5MouseRight.js"></script>
<script type="text/javascript" src="/nsso/js/common/jquery.selectboxes.js"></script><script type="text/javascript" src="/nsso/js/form.js"></script>

<script type="text/javascript">
$(function(){
    var jsonUrl = "http://www.lvmama.com/others/commonSubject/common.php?state=check&channel=newyeargifts&userid=<#if user!=null>${user.getUserId()}</#if>&callback=?";    
    $("#get_gift").click(function(){        
        $.getJSON(jsonUrl,function(json){ 
            var result = json.result; //true：已领取, false:没领取
            if (!result) {
                $("#logForm").submit();
            }else {
                $("#tips,#bgtan").show();
...
<script type="text/javascript">
      ...
      **/
      function login() {
        var mobileOrEMail=$('#mobileAndEmail').val();       
        if(mobileOrEMail==''){
            $("#loinTextErrorTip").html("<font color='red'>账号不能为空</font>");
            $('#mobileAndEmail').focus();   
            return false;
        };
        
        var password = $('#password').val(); 
        if(password==''){
            $("#loinTextErrorTip").html("<font color='red'>密码不能为空</font>");
            $('#password').focus(); 
            return false;
        };
        ...
        $.getJSON(
            ...
            function(data) {       
                if (data.success) {
                    ...
                    $("#loinTextErrorTip").html("<font color='red'>请确认账号，密码是否正确!</font>"); 
                }
            }
        );                              
      }
