...
<!--绑定手机　s-->
  <div class="bound_cont">
    <div><img src=${imagesPath + "/bound_pic.gif"} width="669" height="25" /></div>
    <div class="bound_info">
      <p>为了保证您能顺利的申请驴妈妈会员卡，需要将您的账号绑定手机和邮箱，确保参与活动的每个用户的真实身份。</p>
      ...
      <div>
        ...
        <p class="bound_tips">如果您不想进行相应的绑定手机&邮箱，请 <a href="http://www.lvmama.com/">点击这里</a> 直接查看可以预订的旅游产品。</p>
      </div>
    </div>
  </div>
